...
public class CMSHttpApplication : HttpApplication
{
    ...
    private void InitHandlers()
    {
        ...
        lock (mLock)
        {
            ...
            CMSApplicationModule.PostMapRequestHandler += CMSAppBase.CMSPostMapRequestHandler;
            ...
            CMSApplicationModule.PreSendRequestHeaders += CMSAppBase.CMSPreSendRequestHeaders;
