...
public static class SharePointFunctions
{
    ...
    public static ICredentials GetSharePointCredetials()
    {
        ...
        bool useDefaultCred = SettingsKeyProvider.GetBoolValue(siteName + ".CMSSharePointDefaultCredentials");
        ...
        else
        {
            ...
            string username = SettingsKeyProvider.GetStringValue(siteName + ".CMSSharePointUserName");
            string pass = EncryptionHelper.DecryptData(SettingsKeyProvider.GetStringValue(siteName + ".CMSSharePointPassword"));
