...
public partial class CMSAdminControls_Basic_ThreeStateCheckBox : FormEngineUserControl
{
    ...
    /// </summary>
    public LocalizedRadioButton PositiveChoice
    {
        get
        {
            return rbPositive;
    ...
    /// </summary>
    public LocalizedRadioButton NegativeChoice
    {
        get
        {
            return rbNegative;
    ...
    /// </summary>
    public LocalizedRadioButton NotSetChoice
    {
        get
        {
            return rbNotSet;
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        NotSetChoice.Text = GetString("general.sitesettings") + (string.IsNullOrEmpty(SettingKeyName) ? null : " (" + DEFAULT_KEY + ")");
        PositiveChoice.Text = GetString("general.yes");
        NegativeChoice.Text = GetString("general.no");

        if (!string.IsNullOrEmpty(SettingKeyName))
        {
            SetDefaultValue(SettingsKeyProvider.GetBoolValue(CMSContext.CurrentSiteName + "." + SettingKeyName));
        }
