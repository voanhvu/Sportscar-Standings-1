...
public partial class CMSFormControls_Basic_SelectConnectionString : FormEngineUserControl
{
    ...
    public String DefaultConnectionString
    {
        get
        {
            ...
            {
                mDefaultConnectionString = (Scope == PredefinedObjectType.REPORT) ? ModuleCommands.GetDefaultReportConnectionString() : SqlHelper.DEFAULT_CONNECTIONSTRING_NAME;
            }
    ...
    private void CreateList()
    {
        ...
        drpConnString.Items.Add(new ListItem(GetString("general.defaultchoice"), SqlHelper.DEFAULT_CONNECTIONSTRING_NAME));
        ...
        foreach (ConnectionStringSettings sett in ConfigurationManager.ConnectionStrings)
        {
            ...
            if (!drpConnString.Items.Contains(new ListItem(sett.Name, sett.Name)) && (sett.Name != SqlHelper.DEFAULT_CONNECTIONSTRING_NAME) && IsConnectionStringValid(sett.ConnectionString))
            {
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        if (DisplayInherit)
        {
            ...
            pnlMain.CssClass = "ConnectionStringBox";
        }
