...
<table class="CaptchaTable">
    <tr>
        <td>
            <cms:CMSTextBox ID="txtAnswer" runat="server" CssClass="CaptchaTextBox" />
            <cms:LocalizedRadioButton ID="rdAnswerNo" runat="server" GroupName="Answer" EnableViewState="false"
                Visible="false" ResourceString="general.false" />
            <cms:LocalizedRadioButton ID="rdAnswerYes" runat="server" GroupName="Answer" EnableViewState="false"
