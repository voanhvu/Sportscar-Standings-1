...
public partial class CMSFormControls_Classes_SelectAlternativeForm : FormEngineUserControl, ICallbackEventHandler
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        btnClear.OnClientClick = string.Format("SetVal('{0}', ''); return false;", txtName.ClientID);
    }
    ...
    protected void Page_PreRender(object sender, System.EventArgs e)
    {
        ...
        javaScript = "function  SelectAltFormDialog_" + ClientID + "(){modalDialog('" + ResolveUrl(url) + "','AltFormSelection', 400, 500); return false;}";
