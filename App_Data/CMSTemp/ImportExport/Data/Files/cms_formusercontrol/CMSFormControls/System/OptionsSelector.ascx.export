...
<cms:LocalizedRadioButton ID="radNone" runat="server" Checked="true" GroupName="optionsquery" ResourceString="general.none"
    CssClass="FieldBlockLabel" EnableViewState="false" />
<cms:LocalizedRadioButton ID="radOptions" runat="server" GroupName="optionsquery"
