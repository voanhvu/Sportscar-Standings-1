...
<div class="CheckoutProcess">
            ...
            <asp:GridView ID="gridSteps" runat="server" AutoGenerateColumns="false" CellPadding="3"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemStyle />
                        <ItemTemplate>
                            <%#GetColoredBooleanString(Eval("LiveSite"))%></ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <HeaderStyle Wrap="false" />
                        <HeaderTemplate>
                        ...
                        <ItemStyle />
                        <ItemTemplate>
                            <%#GetColoredBooleanString(Eval("CMSDeskCustomer"))%></ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <HeaderStyle Wrap="false" />
                        <HeaderTemplate>
                        ...
                        <ItemStyle />
                        <ItemTemplate>
                            <%#GetColoredBooleanString(Eval("CMSDeskOrder"))%></ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <HeaderStyle Wrap="false" />
                        <HeaderTemplate>
                        ...
                        <ItemStyle />
                        <ItemTemplate>
                            <%#GetColoredBooleanString(Eval("CMSDeskOrderItems"))%></ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
    ...
    <asp:PlaceHolder ID="plcEdit" runat="server">
        ...
        <div class="CMSEditMenu">
            <cms:HeaderActions ID="headerActions" runat="server" HelpName="helpTopic" HelpTopicName="new_edit_step" />
        </div>
