...
public partial class CMSWebParts_Chat_ChatMessageSend : CMSAbstractWebPart
{
    ...
    {
        ChatHelper.MakeWebpartEnvelope("ChatWebpartEnvelope ChatWebpartEnvelopeMessageSend", this, InnerContainerTitle, InnerContainerName);
        if (IsSupport)
        {
    ...
    /// </summary>
    /// <param name="clientID">Webcontrol</param>
