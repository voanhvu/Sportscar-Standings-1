...
<div class="ChatWebpartFilterPaging">
    <asp:Panel ID="pnlChatRoomsFiltering" runat="server" Visible="false">
        <table cellpadding="0" cellspacing="0">
            <tr>
                <td>
                    <asp:TextBox ID="txtChatRoomsFilter" runat="server" Width="100" EnableViewState="false" CssClass="ChatFilterTextbox"></asp:TextBox>
                </td>
                <td>
                    <cms:LocalizedButton ID="btnChatRoomsFilter" runat="server" ResourceString="chat.rooms.filterbtn" CssClass="ContentButton"></cms:LocalizedButton>
                </td>
            </tr>
        </table>
...
<asp:Panel runat="server" ID="pnlChatRoomsCreateRoom">
    <cms:LocalizedButton runat="server" ID="btnChatRoomsCreateRoom" CssClass="SubmitButton LongButton ChatSubmitButton" style="display: none;" EnableViewState="false" ResourceString="chat.rooms.createroom" />
</asp:Panel>
...
<asp:Panel runat="server" ID="pnlChatRoomsPrompt" CssClass="ChatDialogBody ChatPassDialogBody">
        ...
        <div class="ChatDialogContent ChatPassDialogContent">
            ...
            <asp:TextBox runat="server" ID="txtChatRoomsPromptInput" CssClass="TextBoxFieldSmall" TextMode="Password" MaxLength="100" AutoPostBack="false"></asp:TextBox><br />
        ...
        <div class="ChatDialogFooter">
            <div class="ChatDialogFooterButtons">
                <cms:LocalizedButton runat="server" ID="btnChatRoomsPromptSubmit" UseSubmitBehavior="true"
                    CssClass="SubmitButton" ResourceString="chat.ok" />
    ...
    <div class="ChatDialogContent ChatDialogContentCreateRoom">
        ...
        <table>
            <tr>
                ...
                <td><asp:TextBox runat="server" ID="txtChatRoomsCreateName" CssClass="ChatDialogContentWide" MaxLength="100" onkeydown = "return (event.keyCode!=13);" /></td>
            </tr>
            <tr>
                ...
                <td><asp:TextBox runat="server" ID="txtChatRoomsCreateDescription" TextMode="MultiLine" Columns="20" Rows="5" CssClass="ChatDialogContentWide" /></td>
            </tr>
            <tr>
                ...
                <td><asp:CheckBox runat="server" ID="chkChatRoomsCreateAllowAnonym" EnableViewState="false" /></td>
            </tr>
            <tr>
                ...
                <td><asp:CheckBox runat="server" ID="chkChatRoomsCreateIsPrivate" EnableViewState="false"/></td>
            </tr>
            <tr>
                ...
                <td><asp:TextBox runat="server" ID="txtChatRoomsCreatePassword" TextMode="Password" CssClass="ChatDialogContentWide" MaxLength="100" onkeydown = "return (event.keyCode!=13);" /></td>
            </tr>
            <tr>
                ...
                <td><asp:TextBox runat="server" ID="txtChatRoomsCreatePasswordConfirm" TextMode="Password" CssClass="ChatDialogContentWide" MaxLength="100" onkeydown = "return (event.keyCode!=13);" /></td>
            </tr>
    ...
    <div class="ChatDialogContent ChatDialogContentEditRoom">
        ...
        <table>
            <tr>
                ...
                <td><asp:TextBox runat="server" ID="txtChatRoomsEditName" CssClass="ChatDialogContentWide" MaxLength="100" onkeydown = "return (event.keyCode!=13);" /></td>
            </tr>
            <tr>
                ...
                <td><asp:TextBox runat="server" ID="txtChatRoomsEditDescription" TextMode="MultiLine" Columns="20" Rows="5" CssClass="ChatDialogContentWide" /></td>
            </tr>
            <tr>
                ...
                <td><asp:CheckBox runat="server" ID="chkChatRoomsEditAllowAnonym" EnableViewState="false" /></td>
            </tr>
            <tr>
                ...
                <td><asp:CheckBox runat="server" ID="chkChatRoomsEditIsPrivate" EnableViewState="false"/></td>
            </tr>
            <tr>
                ...
                <td><asp:CheckBox runat="server" ID="chkChatRoomsHasPassword" EnableViewState="false" /></td>
            </tr>
            <tr>
                <td><cms:LocalizedLabel runat="server" ID="lblChatRoomsEditPasswordNew"  ResourceString="chat.passwordnew" DisplayColon="true" /> </td>
                <td><asp:TextBox runat="server" ID="txtChatRoomsEditPassword" TextMode="Password" CssClass="ChatDialogContentWide" MaxLength="100" onkeydown = "return (event.keyCode!=13);" /></td>
            </tr>
            <tr>
                ...
                <td><asp:TextBox runat="server" ID="txtChatRoomsEditPasswordConfirm" TextMode="Password" CssClass="ChatDialogContentWide" MaxLength="100" onkeydown = "return (event.keyCode!=13);" /></td>
            </tr>
