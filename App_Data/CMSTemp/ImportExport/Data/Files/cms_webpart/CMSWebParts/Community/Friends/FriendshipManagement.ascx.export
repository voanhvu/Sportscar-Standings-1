<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="CMSWebParts_Community_Friends_FriendshipManagement" CodeFile="~/CMSWebParts/Community/Friends/FriendshipManagement.ascx.cs" %>
<div class="FriendsManagement">
    <asp:PlaceHolder ID="plcConfirm" runat="server" Visible="false">
        ...
        <cms:CMSButton ID="btnApprove" runat="server" CssClass="ContentButton" />&nbsp;<cms:CMSButton
            ID="btnReject" runat="server" CssClass="ContentButton" />
    </asp:PlaceHolder>
