...
public partial class CMSWebParts_CommunityServices_Pinterest_PinterestPinItButton : CMSAbstractWebPart
{
    #region "Properties"
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            ltlPluginCode.Text = String.Format(output, src, PinCount);
        }
    }
