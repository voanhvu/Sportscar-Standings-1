...
public partial class CMSWebParts_CommunityServices_YahooWebMessenger : CMSAbstractWebPart
{
    ...
    public string YahooMessengerID
    {
        get
        {
            return ValidationHelper.GetString(GetValue("YahooMessengerID"), string.Empty);
        }
        set
        {
    ...
    protected void SetupControl()
    {
        ...
        {
            if (((CMSContext.ViewMode == ViewModeEnum.LiveSite) || (CMSContext.ViewMode == ViewModeEnum.Preview)) && (YahooMessengerID != string.Empty))
            {
