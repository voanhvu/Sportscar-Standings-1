...
public partial class CMSWebParts_Ecommerce_Products_TopNNewestProducts : CMSAbstractWebPart
{
    ...
    public string OrderBy
    {
        get
        {
            return DataHelper.GetNotEmpty(GetValue("OrderBy"), "");
        }
        set
        {
    ...
    {
        string where = "(SKUOptionCategoryID IS NULL AND SKUEnabled = 1)";
    ...
    private string GetOrderByExpression(string customOrderBy)
    {
        ...
        string orderBy = "SKUCreated DESC";
