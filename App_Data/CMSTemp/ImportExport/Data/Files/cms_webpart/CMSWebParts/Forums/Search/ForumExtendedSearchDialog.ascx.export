...
<asp:Panel ID="pnlForumExtendedSearch" runat="server" DefaultButton="btnSearch">
    ...
    <table class="ForumExtendedSearch">
        <tr>
            ...
            <td>
                <cms:CMSTextBox ID="txtSearchText" CssClass="TextBox" runat="server" EnableViewState="false" />
            </td>
            <td>
        ...
        <tr>
            ...
            <td colspan="2">
                <cms:CMSTextBox ID="txtUserName" CssClass="TextBox" runat="server" EnableViewState="false" />
            </td>
        </tr>
        <asp:PlaceHolder runat="server" ID="plcForums" Visible="false">
            <tr>
                ...
                <td colspan="2">
                    <asp:ListBox Rows="8" CssClass="DropDownList" runat="server" ID="listForums" SelectionMode="Multiple" />
                </td>
            </tr>
        </asp:PlaceHolder>
        <tr>
            ...
            <td colspan="2">
                <asp:DropDownList ID="drpSearchIn" CssClass="DropDownList" runat="server" />
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <asp:DropDownList ID="drpSearchOrderBy" CssClass="DropDownList" runat="server" />
            </td>
            <td>
                <asp:RadioButtonList ID="rblSearchOrder" runat="server" RepeatDirection="Horizontal" />
            </td>
        </tr>
        <tr>
            <td></td>
            <td colspan="2">
                <cms:CMSButton ID="btnSearch" CssClass="ContentButton" runat="server" EnableViewState="false"
