...
public partial class CMSWebParts_General_CssStyleSelector : CMSAbstractWebPart
{
    ...
    public string CookieName
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("CookieName"), ""), CMS.GlobalHelper.CookieName.BodyClass);
        }
        set
        {
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        {
            CMSContext.CurrentBodyClass += " " + cookieValue;
        }
