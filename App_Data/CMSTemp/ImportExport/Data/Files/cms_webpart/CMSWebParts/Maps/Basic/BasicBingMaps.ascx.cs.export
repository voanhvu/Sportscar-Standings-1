...
public partial class CMSWebParts_Maps_Basic_BasicBingMaps : CMSAbstractWebPart
{
        ...
        if (!StopProcessing)
        {
            ...
            if (DataSourceControl != null && EnableServerProcessing)
            {
                ...
                if (DataSourceControl.CacheMinutes <= 0)
                {
                    ...
                    BasicBingMaps.CacheMinutes = SettingsKeyProvider.GetIntValue(CurrentSiteName + ".CMSCacheMinutes");
                }
                else
                {
    ...
    protected void EnsureFilterControl()
    {
        if (!mFilterControlAdded)
        {
            ...
            CMSControlsHelper.SetFilter(ValidationHelper.GetString(GetValue("WebPartControlID"), ClientID), BasicBingMaps);
    ...
    protected void LoadTransformations()
    {
        ...
        {
            BasicBingMaps.ItemTemplate = CMSDataProperties.LoadTransformation(this, TransformationName, false);
        }
    }
