...
public partial class CMSWebParts_Newsletters_CustomSubscriptionForm : CMSAbstractWebPart
{
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        if ((formElem != null) && (formElem.BasicForm != null))
        {
    ...
    protected void SetupControl()
    {
        ...
        {
            isAuthenticated = (CurrentUser != null) && CurrentUser.IsAuthenticated();
            ...
            else
            {
                ...
                if (afi != null)
                {
                    ...
                    if (AllowUserSubscribers && isAuthenticated)
                    {
                        ...
                        sb = SubscriberInfoProvider.GetSubscriberInfo(SiteObjectType.USER, CurrentUser.UserID, CMSContext.CurrentSiteID);
                        if (sb == null)
                        {
                            ...
                            sb = new SubscriberInfo()
                            {
                                ...
                                SubscriberType = SiteObjectType.USER,
            ...
            if (formElem.BasicForm != null)
            {
                // Set the live site context
                formElem.BasicForm.ControlContext.ContextName = CMS.SiteProvider.ControlContext.LIVE_SITE;
            }
    ...
    protected void InitNewsletterSelector()
    {
        ...
        if (plcNwsList.Visible)
        {
            ...
            if ((!ExternalUse || !RequestHelper.IsPostBack()) && (chklNewsletters.Items.Count == 0))
            {
                ...
                using (CachedSection<DataSet> cs = new CachedSection<DataSet>(ref ds, CacheMinutes, true, CacheItemName, "newslettersubscription", CMSContext.CurrentSiteName))
                {
                    if (cs.LoadData)
                    {
                        // Get the data
                        ds = NewsletterInfoProvider.GetAllNewslettersForSite(CMSContext.CurrentSiteID, "NewsletterDisplayName", 0, "NewsletterDisplayName,NewsletterName");
    ...
    private bool Save(string newsletterName, SubscriberInfo sb)
    {
        ...
        if (news != null)
        {
            ...
            ContextResolver resolver = ContextResolver;
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (string.IsNullOrEmpty(MessageForAlreadySubscribed))
                    {
                        ...
                        {
                            message = string.Format("{0} {1}.<br />", GetString("NewsletterSubscription.SubscriberIsAlreadySubscribedXY"), HTMLHelper.HTMLEncode(news.NewsletterDisplayName));
                        }
                    }
                    else
                    {
