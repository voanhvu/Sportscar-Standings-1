...
public partial class CMSWebParts_OnlineMarketing_Activities : CMSAbstractWebPart
{
    ...
    public override void OnContentLoaded()
    {
        ...
        if (CMSContext.CurrentUser.IsAuthorizedPerResource(ModuleEntry.CONTACTMANAGEMENT, "ReadActivities"))
        {
            SetupControl();
        }
        else
    ...
    protected void SetupControl()
    {
        ...
        {
            where = SqlHelperClass.AddWhereCondition(where, "ActivityType='" + SqlHelperClass.GetSafeQueryString(ActivityType, true) + "'");
        }
