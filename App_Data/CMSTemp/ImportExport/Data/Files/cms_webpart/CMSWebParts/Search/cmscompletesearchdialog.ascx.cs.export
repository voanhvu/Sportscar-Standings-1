...
public partial class CMSWebParts_Search_cmscompletesearchdialog : CMSAbstractWebPart
{
    ...
    public SearchModeEnum SearchMode
    {
        get
        {
            return CMSSearchDialog.GetSearchMode(DataHelper.GetNotEmpty(GetValue("SearchMode"), SearchHelper.GetSearchModeString(srchDialog.SearchMode)));
        }
        set
        {
            SetValue("SearchMode", SearchHelper.GetSearchModeString(value));
    ...
    public string Path
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("Path"), srchResults.Path), srchResults.Path);
        }
        set
        {
            SetValue("Path", value);
