...
public partial class CMSWebParts_SmartSearch_SearchDialog : CMSAbstractWebPart
{
    ...
    public SearchModeEnum SearchMode
    {
        get
        {
            return SearchHelper.GetSearchModeEnum(DataHelper.GetNotEmpty(GetValue("SearchMode"), SearchHelper.GetSearchModeString(srchDialog.SearchMode)));
        }
        set
        {
    ...
    {
        srchDialog.FilterID = ValidationHelper.GetString(GetValue("WebPartControlID"), ClientID);
        srchDialog.LoadData();
    }
