...
public partial class CMSWebParts_Navigation_cmstabcontrol : CMSAbstractWebPart
{
    ...
    public bool UseItemImagesForHiglightedItem
    {
        get
        {
            return ValidationHelper.GetBoolean(GetValue("UseItemImagesForHiglightedItem"), tabElem.UseItemImagesForHiglightedItem);
        }
        set
        {
    ...
    public string Path
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("Path"), tabElem.Path), tabElem.Path);
        }
        set
        {
            SetValue("Path", value);
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            tabElem.UseItemImagesForHiglightedItem = UseItemImagesForHiglightedItem;
