...
public partial class CMSWebParts_Navigation_cmstreeview : CMSAbstractWebPart
{
    ...
    public string Path
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("Path"), treeView.Path), treeView.Path);
        }
        set
        {
            SetValue("Path", value);
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            if (((treeView.CollapseImageUrl != null) && (treeView.CollapseImageUrl != "")) ||
                ((treeView.ExpandImageUrl != null) && (treeView.ExpandImageUrl != "")))
            {
