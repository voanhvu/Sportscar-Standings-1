...
INSERT INTO [CMS_EmailTemplate] ([EmailTemplateID], [EmailTemplateName], [EmailTemplateDisplayName], [EmailTemplateText], [EmailTemplateSiteID], [EmailTemplateGUID], [EmailTemplateLastModified], [EmailTemplatePlainText], [EmailTemplateSubject], [EmailTemplateFrom], [EmailTemplateCc], [EmailTemplateBcc], [EmailTemplateType]) VALUES (859, N'blogs.subscriptionrequest', N'Blogs - Subscription request', N'<html>
	...
	<p>
	  You have requested subscription to our <strong>Blog post</strong> {%BlogPostTitle%}. Please use the following link to confirm your subscription.<br />
          ...
          {%if(ToInt(OptInInterval,0)>0) {"NOTE: Confirmation link will be valid for next " + OptInInterval + " hours."} |(user)administrator|(hash)025ab283489dc5466e12491d6ca017dd8c39fe4c0998625fecb91135d4a37f65%}
	</p>
	</body>
...
{%if(ToInt(OptInInterval,0)>0) {"NOTE: Confirmation link will be valid for next " + OptInInterval + " hours."} |(user)administrator|(hash)025ab283489dc5466e12491d6ca017dd8c39fe4c0998625fecb91135d4a37f65%}', N'Subscription request', N'', N'', N'', N'blogsubscription')
...
INSERT INTO [CMS_EmailTemplate] ([EmailTemplateID], [EmailTemplateName], [EmailTemplateDisplayName], [EmailTemplateText], [EmailTemplateSiteID], [EmailTemplateGUID], [EmailTemplateLastModified], [EmailTemplatePlainText], [EmailTemplateSubject], [EmailTemplateFrom], [EmailTemplateCc], [EmailTemplateBcc], [EmailTemplateType]) VALUES (862, N'Boards.SubscribeConfirmation', N'Boards - Subscription confirmation', N'<html>
	...
	<p>
	  You have been successfully subscribed to		
	<strong>Message board</strong> {%Board.BoardDisplayName|(user)administrator|(hash)94620a287e488e8c35aaea38c5c0ef450c8dee2c7a2687631e61393c094cd2b3%}.		    
	<p/>
	<p>
...
</html>', NULL, '6422a9bd-95b0-41cc-9ef7-68e1e93be2a8', '20111124 22:39:44', N'You have been successfully subscribed to Message board {%Board.BoardDisplayName|(user)administrator|(hash)94620a287e488e8c35aaea38c5c0ef450c8dee2c7a2687631e61393c094cd2b3%}.
...
INSERT INTO [CMS_EmailTemplate] ([EmailTemplateID], [EmailTemplateName], [EmailTemplateDisplayName], [EmailTemplateText], [EmailTemplateSiteID], [EmailTemplateGUID], [EmailTemplateLastModified], [EmailTemplatePlainText], [EmailTemplateSubject], [EmailTemplateFrom], [EmailTemplateCc], [EmailTemplateBcc], [EmailTemplateType]) VALUES (863, N'Boards.subscriptionrequest', N'Boards - Subscription request', N'<html>
	...
	<body>
	<p>
	  You have requested subscription to our <strong>Message board</strong> {%Board.BoardDisplayName|(user)administrator|(hash)94620a287e488e8c35aaea38c5c0ef450c8dee2c7a2687631e61393c094cd2b3%}. Please use the following link to confirm your subscription.<br />
          <a href="{%SubscriptionLink%}">Click here to confirm the subscription</a><br /><br />
          {%if(ToInt(OptInInterval,0)>0) {"NOTE: Confirmation link will be valid for next " + OptInInterval + " hours."} |(user)administrator|(hash)025ab283489dc5466e12491d6ca017dd8c39fe4c0998625fecb91135d4a37f65%}
	</p>
	</body>
</html>', NULL, 'fe8ae59a-5f07-46f1-8856-c13a4412f360', '20120328 16:21:38', N'You have requested subscription to our Message board {%Board.BoardDisplayName|(user)administrator|(hash)94620a287e488e8c35aaea38c5c0ef450c8dee2c7a2687631e61393c094cd2b3%}. Please use the following link to confirm your subscription.
[url={%SubscriptionLink%}]Click here to confirm the subscription[/url].
{%if(ToInt(OptInInterval,0)>0) {"NOTE: Confirmation link will be valid for next " + OptInInterval + " hours."} |(user)administrator|(hash)025ab283489dc5466e12491d6ca017dd8c39fe4c0998625fecb91135d4a37f65%}', N'Subscription request', N'', N'', N'', N'boardssubscription')
...
</html>', NULL, 'e5b8609e-94c6-4096-8aa3-f37fa4b7d320', '20120328 16:22:08', N'You have been successfully unsubscribed from Message board {%Board.BoardDisplayName|(user)administrator|(hash)94620a287e488e8c35aaea38c5c0ef450c8dee2c7a2687631e61393c094cd2b3%}.', N'Message board unsubscription notification', N'', N'', N'', N'boardssubscription')
...
{%if(ToInt(OptInInterval,0)>0) {"NOTE: Confirmation link will be valid for next " + OptInInterval + " hours."} |(user)administrator|(hash)025ab283489dc5466e12491d6ca017dd8c39fe4c0998625fecb91135d4a37f65%}', N'Subscription request', N'', N'', N'', N'forumsubscribtion')
...
INSERT INTO [CMS_EmailTemplate] ([EmailTemplateID], [EmailTemplateName], [EmailTemplateDisplayName], [EmailTemplateText], [EmailTemplateSiteID], [EmailTemplateGUID], [EmailTemplateLastModified], [EmailTemplatePlainText], [EmailTemplateSubject], [EmailTemplateFrom], [EmailTemplateCc], [EmailTemplateBcc], [EmailTemplateType]) VALUES (719, N'messaging.messagenotification', N'Messaging  - Notification e-mail', N'<html>
	...
	<body style="font-size: 12px; font-family: arial">
<p>
Hello {%TrimSitePrefix(Recipient.UserName)|(user)administrator|(hash)8d1139354d983eff4edc2f404f33cd3f235a5903941d526af10524235e8d0285%},
<br />
you''ve just recieved new message from user <strong>''{%TrimSitePrefix(Sender.UserName)|(user)administrator|(hash)b3711945948e23ec802d74a3d47a36b8faabbb7b5f250a15bee74cf465aa15e1%}''</strong>.
<br />
Original message:
<br />
<hr />
{%Message.MessageBody|(resolvebbcode)|(user)administrator|(hash)0522cf401cabdcb603f09f72f87acf34ff842633f3f13f9f35596d592c52b07e%}
<hr/>
<br />
You can use following <a href="{%LogonUrl%}">link</a> to logon to site and check new message.
</p>
</body>
</html>', NULL, '3d863d80-a3ab-46d8-99c5-1bcd9c2bd570', '20120215 18:33:01', N'Hello {%TrimSitePrefix(Recipient.UserName)|(user)administrator|(hash)8d1139354d983eff4edc2f404f33cd3f235a5903941d526af10524235e8d0285%}, 
you''ve just recieved new message from user ''{%TrimSitePrefix(Sender.UserName)|(user)administrator|(hash)b3711945948e23ec802d74a3d47a36b8faabbb7b5f250a15bee74cf465aa15e1%}''. 
Original message: 
--------------------------------------------------------------------------------
{%Message.MessageBody|(resolvebbcode)|(user)administrator|(hash)0522cf401cabdcb603f09f72f87acf34ff842633f3f13f9f35596d592c52b07e%} 
--------------------------------------------------------------------------------
...
INSERT INTO [CMS_EmailTemplate] ([EmailTemplateID], [EmailTemplateName], [EmailTemplateDisplayName], [EmailTemplateText], [EmailTemplateSiteID], [EmailTemplateGUID], [EmailTemplateLastModified], [EmailTemplatePlainText], [EmailTemplateSubject], [EmailTemplateFrom], [EmailTemplateCc], [EmailTemplateBcc], [EmailTemplateType]) VALUES (874, N'Reporting_Subscription_information', N'Reporting - Subscription confirmation', N'<html>
	...
	<body>
      <h3>{%ReportSubscription.ReportSubscriptionSubject|(user)administrator|(hash)1eff5bdf08c289770ba82aade4e06327d981f9f87e2f99f7484381238920dcf2%}</h3>
	<p>
        You have been successfully subscribed to {%ItemName%}		
       report <strong> {%Report.ReportDisplayName |(user)administrator|(hash)5e7d8fa11aaf0843a2d386b101a8f5f13061940d5f3b4dbd520abc6c192fd7ab%} </strong>.
	<p/>
	<p>
      <a href="{%UnsubscriptionLink%}">Click here to unsubscribe</a>
	</p>
	</body>
</html>', NULL, '8a4938c3-ef94-4bec-b4c9-0a8ecbab8d79', '20120525 15:54:20', N'{%ReportSubscription.ReportSubscriptionSubject|(user)administrator|(hash)1eff5bdf08c289770ba82aade4e06327d981f9f87e2f99f7484381238920dcf2%}
You have been successfully subscribed to {%ItemName%} report {%Report.ReportDisplayName |(user)administrator|(hash)5e7d8fa11aaf0843a2d386b101a8f5f13061940d5f3b4dbd520abc6c192fd7ab%}.
Click here to unsubscribe:
...
</html>', NULL, 'd7386fb3-f98e-47bf-8833-5574e7945eb9', '20120514 17:40:00', N'{%ReportSubscription.ReportSubscriptionSubject|(user)administrator|(hash)1eff5bdf08c289770ba82aade4e06327d981f9f87e2f99f7484381238920dcf2%}
{%SubscriptionBody%}
Click here to unsubscribe:
...
INSERT INTO [CMS_EmailTemplate] ([EmailTemplateID], [EmailTemplateName], [EmailTemplateDisplayName], [EmailTemplateText], [EmailTemplateSiteID], [EmailTemplateGUID], [EmailTemplateLastModified], [EmailTemplatePlainText], [EmailTemplateSubject], [EmailTemplateFrom], [EmailTemplateCc], [EmailTemplateBcc], [EmailTemplateType]) VALUES (873, N'Reporting_Unsubscription_template', N'Reporting - Unsubscription confirmation', N'<html>
	...
	report <strong>{%Report.ReportDisplayName|(user)administrator|(hash)27f736b579015e8ed79a16637213d1442dc06d178fad1f7607d3087b87ce6c67%}</strong>.
	<p/>	
	</body>
</html>', NULL, '5422657c-2602-4f80-a12f-858012baf4b9', '20120504 10:56:48', N'{%ReportSubscription.ReportSubscriptionSubject|(user)administrator|(hash)1eff5bdf08c289770ba82aade4e06327d981f9f87e2f99f7484381238920dcf2%}
You have been successfully unsubscribed from {%ItemName%} report {%Report.ReportDisplayName|(user)administrator|(hash)27f736b579015e8ed79a16637213d1442dc06d178fad1f7607d3087b87ce6c67%}.', N'Report unsubscription', N'', N'', N'', N'reporting')
...
INSERT INTO [CMS_EmailTemplate] ([EmailTemplateID], [EmailTemplateName], [EmailTemplateDisplayName], [EmailTemplateText], [EmailTemplateSiteID], [EmailTemplateGUID], [EmailTemplateLastModified], [EmailTemplatePlainText], [EmailTemplateSubject], [EmailTemplateFrom], [EmailTemplateCc], [EmailTemplateBcc], [EmailTemplateType]) VALUES (870, N'translationservice.submittranslation', N'Translation services - Submit translation', N'<html>
  ...
  <body style="font-size: 12px; font-family: arial">
    ...
    <p>
    This submission was created with priority {% GetTranslationPriority(Submission.SubmissionPriority) |(user)administrator|(hash)122b5fd8edd454f58597ebc53d003f7d8acf3d930248f39415409eab355a2f9f%} and is due by {% Submission.SubmissionDeadline |(user)administrator|(hash)8d826900b7b46e55f756c768409af30a0617ab3bb33041b1d07f1bb278c5afb7%}.
    </p>
    <p>
...
Document: [url={%DocumentEditUrl%}]{%documentname%}[/url] {% ifEmpty(DocumentPreviewUrl, "", "([url=" + DocumentPreviewUrl + "]preview[/url])")|(user)administrator|(hash)0576fb12a293cda42ea82202a0f14dbe921fdef80b814d62de81e805300fe916%}
...
INSERT INTO [CMS_EmailTemplate] ([EmailTemplateID], [EmailTemplateName], [EmailTemplateDisplayName], [EmailTemplateText], [EmailTemplateSiteID], [EmailTemplateGUID], [EmailTemplateLastModified], [EmailTemplatePlainText], [EmailTemplateSubject], [EmailTemplateFrom], [EmailTemplateCc], [EmailTemplateBcc], [EmailTemplateType]) VALUES (868, N'Workflow.Notification', N'Workflow - Notification', N'<html>
  ...
  <body style="font-size: 12px; font-family: arial">
    ...
    <br />
    <strong>Modified by:</strong> {%User.Email|(user)administrator|(hash)c42462ec5d6d3ee5a1a01d5147b694153efa11e6134b080a636a5026a3064c00%}
    <br />
...
Document: [url={%DocumentEditUrl%}]{%documentname%}[/url] {% ifEmpty(DocumentPreviewUrl, "", "([url=" + DocumentPreviewUrl + "]preview[/url])")|(user)administrator|(hash)0576fb12a293cda42ea82202a0f14dbe921fdef80b814d62de81e805300fe916%}
Action: {%ActionName%} 
Modified by: {%User.Email|(user)administrator|(hash)c42462ec5d6d3ee5a1a01d5147b694153efa11e6134b080a636a5026a3064c00%} 
