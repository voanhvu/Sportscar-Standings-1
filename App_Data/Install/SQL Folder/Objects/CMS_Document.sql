...
CREATE NONCLUSTERED INDEX [IX_CMS_Document_DocumentCulture_DocumentForeignKeyValue_Workflow]
	ON [CMS_Document] ([DocumentCulture])
	INCLUDE ([DocumentForeignKeyValue], [DocumentCheckedOutVersionHistoryID], [DocumentPublishedVersionHistoryID], [DocumentPublishFrom], [DocumentPublishTo], [DocumentNodeID], [DocumentIsArchived])
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_CMS_Document_DocumentNodeID_DocumentID_DocumentCulture]
	ON [CMS_Document] ([DocumentNodeID], [DocumentID], [DocumentCulture])
