...
ALTER TABLE [CMS_PageTemplate]
	ADD
	CONSTRAINT [DEFAULT_CMS_PageTemplate_PageTemplateCloneAsAdHoc]
	DEFAULT ((0)) FOR [PageTemplateCloneAsAdHoc]
ALTER TABLE [CMS_PageTemplate]
	ADD
	CONSTRAINT [DEFAULT_CMS_PageTemplate_PageTemplateCodeName]
	DEFAULT ('') FOR [PageTemplateCodeName]
ALTER TABLE [CMS_PageTemplate]
	ADD
