...
ALTER TABLE [CMS_Site]
	ADD
	CONSTRAINT [DEFAULT_CMS_Site_SiteDisplayName]
	DEFAULT ('') FOR [SiteDisplayName]
ALTER TABLE [CMS_Site]
	ADD
	CONSTRAINT [DEFAULT_CMS_Site_SiteDomainName]
	DEFAULT ('') FOR [SiteDomainName]
ALTER TABLE [CMS_Site]
	ADD
	CONSTRAINT [DEFAULT_CMS_Site_SiteName]
	DEFAULT ('') FOR [SiteName]
ALTER TABLE [CMS_Site]
	ADD
	CONSTRAINT [DEFAULT_CMS_Site_SiteStatus]
	DEFAULT ('') FOR [SiteStatus]
