CREATE TABLE [CMS_UserSettings] (
		...
		[UserWebPartToolbarEnabled]          [bit] NULL,
		[UserWebPartToolbarPosition]         [nvarchar](10) NULL,
		...
		[UserPasswordLastChanged]            [datetime] NULL
)  
...
ALTER TABLE [CMS_UserSettings]
	ADD
	CONSTRAINT [DEFAULT_CMS_UserSettings_UserAccountLockReason]
	DEFAULT ((0)) FOR [UserAccountLockReason]
ALTER TABLE [CMS_UserSettings]
	ADD
	CONSTRAINT [DEFAULT_CMS_UserSettings_UserInvalidLogOnAttempts]
	DEFAULT ((0)) FOR [UserInvalidLogOnAttempts]
ALTER TABLE [CMS_UserSettings]
	ADD
...
ALTER TABLE [CMS_UserSettings]
	ADD
	CONSTRAINT [DEFAULT_CMS_UserSettings_UserWebPartToolbarEnabled]
	DEFAULT ((1)) FOR [UserWebPartToolbarEnabled]
ALTER TABLE [CMS_UserSettings]
	ADD
	CONSTRAINT [DEFAULT_CMS_UserSettings_UserWebPartToolbarPosition]
	DEFAULT ('right') FOR [UserWebPartToolbarPosition]
...
CREATE NONCLUSTERED INDEX [IX_CMS_UserSettings_UserNickName]
	ON [CMS_UserSettings] ([UserNickName])
	
CREATE NONCLUSTERED INDEX [IX_CMS_UserSettings_UserPasswordRequestHash]
	ON [CMS_UserSettings] ([UserPasswordRequestHash])
