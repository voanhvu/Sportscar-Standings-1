...
ALTER TABLE [CMS_Widget]
	WITH CHECK
	ADD CONSTRAINT [FK_CMS_Widget_WidgetLayoutID_CMS_WebPartLayout]
	FOREIGN KEY ([WidgetLayoutID]) REFERENCES [CMS_WebPartLayout] ([WebPartLayoutID])
ALTER TABLE [CMS_Widget]
	CHECK CONSTRAINT [FK_CMS_Widget_WidgetLayoutID_CMS_WebPartLayout]
ALTER TABLE [CMS_Widget]
	WITH CHECK
