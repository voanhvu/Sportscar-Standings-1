...
ALTER TABLE [COM_SKU]
	ADD
	CONSTRAINT [DEFAULT_COM_SKU_SKUEnabled]
	DEFAULT ((1)) FOR [SKUEnabled]
ALTER TABLE [COM_SKU]
	ADD
...
ALTER TABLE [COM_SKU]
	ADD
	CONSTRAINT [DEFAULT_COM_SKU_SKUPrice]
	DEFAULT ((0)) FOR [SKUPrice]
ALTER TABLE [COM_SKU]
	ADD
...
ALTER TABLE [COM_SKU]
	WITH CHECK
	ADD CONSTRAINT [FK_COM_SKU_SKUParentSKUID_COM_SKU]
	FOREIGN KEY ([SKUParentSKUID]) REFERENCES [COM_SKU] ([SKUID])
ALTER TABLE [COM_SKU]
	CHECK CONSTRAINT [FK_COM_SKU_SKUParentSKUID_COM_SKU]
ALTER TABLE [COM_SKU]
	WITH CHECK
