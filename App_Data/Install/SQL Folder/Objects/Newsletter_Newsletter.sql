...
ALTER TABLE [Newsletter_Newsletter]
	ADD
	CONSTRAINT [DEFAULT_Newsletter_Newsletter_NewsletterEnableResending]
	DEFAULT ((1)) FOR [NewsletterEnableResending]
ALTER TABLE [Newsletter_Newsletter]
	ADD
...
CREATE NONCLUSTERED INDEX [IX_Newsletter_Newsletter_NewsletterOptInTemplateID]
	ON [Newsletter_Newsletter] ([NewsletterOptInTemplateID])
