...
ALTER TABLE [Newsletter_NewsletterIssue]
	WITH CHECK
	ADD CONSTRAINT [FK_Newsletter_NewsletterIssue_IssueVariantOfIssue_NewsletterIssue]
	FOREIGN KEY ([IssueVariantOfIssueID]) REFERENCES [Newsletter_NewsletterIssue] ([IssueID])
ALTER TABLE [Newsletter_NewsletterIssue]
	CHECK CONSTRAINT [FK_Newsletter_NewsletterIssue_IssueVariantOfIssue_NewsletterIssue]
ALTER TABLE [Newsletter_NewsletterIssue]
	WITH CHECK
	ADD CONSTRAINT [FK_Newsletter_NewsletterIssue_Newsletter_NewsletterIssue]
	FOREIGN KEY ([IssueID]) REFERENCES [Newsletter_NewsletterIssue] ([IssueID])
ALTER TABLE [Newsletter_NewsletterIssue]
	CHECK CONSTRAINT [FK_Newsletter_NewsletterIssue_Newsletter_NewsletterIssue]
