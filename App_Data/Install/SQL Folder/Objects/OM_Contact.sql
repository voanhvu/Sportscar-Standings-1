CREATE TABLE [OM_Contact] (
		...
		[ContactSalesForceLeadReplicationDateTime]               [datetime] NULL,
		[ContactSalesForceLeadReplicationSuspensionDateTime]     [datetime] NULL,
...
ALTER TABLE [OM_Contact]
	ADD
	CONSTRAINT [DEFAULT_OM_Contact_ContactLastName]
	DEFAULT ('') FOR [ContactLastName]
ALTER TABLE [OM_Contact]
	ADD
	CONSTRAINT [DEFAULT_OM_Contact_ContactMonitored]
	DEFAULT ((0)) FOR [ContactMonitored]
ALTER TABLE [OM_Contact]
	ADD
	CONSTRAINT [DEFAULT_OM_Contact_ContactSalesForceLeadReplicationDisabled]
	DEFAULT ((0)) FOR [ContactSalesForceLeadReplicationDisabled]
ALTER TABLE [OM_Contact]
	ADD
	CONSTRAINT [DEFAULT_OM_Contact_ContactSalesForceLeadReplicationRequired]
	DEFAULT ((0)) FOR [ContactSalesForceLeadReplicationRequired]
...
CREATE NONCLUSTERED INDEX [IX_OM_Contact_ContactLastName]
	ON [OM_Contact] ([ContactLastName])
	
CREATE NONCLUSTERED INDEX [IX_OM_Contact_ContactMergedWithContactID]
	ON [OM_Contact] ([ContactMergedWithContactID])
	
CREATE NONCLUSTERED INDEX [IX_OM_Contact_ContactMergedWithContactID_ContactSiteID]
	ON [OM_Contact] ([ContactMergedWithContactID], [ContactSiteID])
...
CREATE NONCLUSTERED INDEX [IX_OM_Contact_SalesForce]
	ON [OM_Contact] ([ContactSalesForceLeadID], [ContactSalesForceLeadReplicationDisabled], [ContactSalesForceLeadReplicationSuspensionDateTime])
