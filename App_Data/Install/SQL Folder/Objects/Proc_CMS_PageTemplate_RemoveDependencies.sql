...
BEGIN
	...
	BEGIN TRANSACTION;
	-- CMS_Tree
    UPDATE [CMS_Tree] SET NodeTemplateID = NULL WHERE NodeTemplateID = @ID; 
    UPDATE [CMS_Tree] SET NodeWireframeTemplateID = NULL WHERE NodeWireframeTemplateID = @ID; 
	-- CMS_Document
	...
	DELETE FROM CMS_TemplateDeviceLayout WHERE PageTemplateID = @ID;    
	COMMIT TRANSACTION;
END
