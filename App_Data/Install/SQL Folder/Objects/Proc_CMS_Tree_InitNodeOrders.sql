CREATE PROCEDURE [Proc_CMS_Tree_InitNodeOrders]
	@NodeParentID int
AS
BEGIN
    ...
    SET @nodeCursor = CURSOR FOR SELECT NodeID, NodeOrder FROM @nodesTable ORDER BY NodeOrder ASC, NodeName ASC, NodeAlias ASC;
