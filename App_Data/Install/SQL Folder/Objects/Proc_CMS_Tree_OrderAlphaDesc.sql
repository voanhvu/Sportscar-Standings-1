CREATE PROCEDURE [Proc_CMS_Tree_OrderAlphaDesc]
	@NodeParentID int
AS
BEGIN
    ...
    SET @nodeCursor = CURSOR FOR SELECT NodeID, NodeOrder FROM @nodesTable ORDER BY NodeName DESC, NodeOrder ASC, NodeAlias DESC;
