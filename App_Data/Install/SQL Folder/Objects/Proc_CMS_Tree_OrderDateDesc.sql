CREATE PROCEDURE [Proc_CMS_Tree_OrderDateDesc]
	@NodeParentID int
AS
BEGIN
    ...
    SET @nodeCursor = CURSOR FOR SELECT NodeID, NodeOrder FROM @nodesTable ORDER BY DocumentModifiedWhen DESC, NodeOrder ASC;
