...
(SELECT     PageTemplateID AS ObjectID, PageTemplateCodeName AS CodeName, PageTemplateDisplayName AS DisplayName, PageTemplateCategoryID AS CategoryID, 
                        ...
                        'pagetemplate' AS ObjectType, PageTemplateIsReusable AS Parameter, PageTemplateForAllPages AS 'PageTemplateForAllPages', PageTemplateType, PageTemplateIsReusable
