SET ANSI_PADDING ON
GO
CREATE VIEW [View_CMS_Tree_Joined_Regular] WITH SCHEMABINDING AS 
...
FROM dbo.CMS_Tree T INNER JOIN dbo.CMS_Document D ON T.NodeID = D.DocumentNodeID INNER JOIN dbo.CMS_Site S ON T.NodeSiteID = S.SiteID INNER JOIN dbo.CMS_Class C ON T.NodeClassID = C.ClassID
GO
SET ANSI_PADDING ON
GO
