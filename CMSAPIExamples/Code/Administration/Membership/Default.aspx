...
<asp:Content ID="contentLeft" ContentPlaceHolderID="plcLeftContainer" runat="server">
    ...
    <%-- Membership --%>
    <cms:APIExamplePanel ID="pnlCreateMembership" runat="server" GroupingText="Membership">
    ...
    <%-- Membership role --%>
    <cms:APIExamplePanel ID="pnlCreateMembershipRole" runat="server" GroupingText="Membership in role">
    ...
    <%-- Membership user --%>
    <cms:APIExamplePanel ID="pnlAddMembershipUser" runat="server" GroupingText="Membership in user">
...
<asp:Content ID="contentRight" ContentPlaceHolderID="plcRightContainer" runat="server">
    ...
    <cms:APIExamplePanel ID="pnlDeleteUserRole" runat="server" GroupingText="User in role">
     ...
     <%-- Membership role --%>
    <cms:APIExamplePanel ID="pnlRemoveMembershipFromRole" runat="server" GroupingText="Membership in role">
    ...
    <%-- Membership user --%>
    <cms:APIExamplePanel ID="pnlRemoveMembershipFromUser" runat="server" GroupingText="Membership in user">
    ...
    <%-- Membership --%>
    <cms:APIExamplePanel ID="pnlDeleteMembership" runat="server" GroupingText="Membership">
