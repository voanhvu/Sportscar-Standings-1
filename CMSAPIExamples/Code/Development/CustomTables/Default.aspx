...
<asp:Content ID="contentLeft" ContentPlaceHolderID="plcLeftContainer" runat="server">
    ...
    <%-- Custom table item --%>     
    <cms:APIExamplePanel ID="pnlCreateCustomTableItem" runat="server" GroupingText="Custom table item">
...
<asp:Content ID="contentRight" ContentPlaceHolderID="plcRightContainer" runat="server">
    <%-- Custom table item --%>
    <cms:APIExamplePanel ID="pnlDeleteCustomTableItem" runat="server" GroupingText="Custom table item">
