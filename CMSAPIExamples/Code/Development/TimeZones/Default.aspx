...
<asp:Content ID="contentLeft" ContentPlaceHolderID="plcLeftContainer" runat="server">
    <%-- Timezone --%>
    <cms:APIExamplePanel ID="pnlCreateTimezone" runat="server" GroupingText="Timezone">
...
<asp:Content ID="contentRight" ContentPlaceHolderID="plcRightContainer" runat="server">
    <%-- Timezone --%>
    <cms:APIExamplePanel ID="pnlDeleteTimezone" runat="server" GroupingText="Timezone">
