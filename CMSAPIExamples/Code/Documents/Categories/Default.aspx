...
<asp:Content ID="contentLeft" ContentPlaceHolderID="plcLeftContainer" runat="server">
    ...
    <%-- Subcategory --%>
    <cms:APIExamplePanel ID="pnlCreateSubcategory" runat="server" GroupingText="Subcategory">
...
<asp:Content ID="contentRight" ContentPlaceHolderID="plcRightContainer" runat="server">
    ...
    <%-- Subcategory --%>
    <cms:APIExamplePanel ID="pnlDeleteSubcategory" runat="server" GroupingText="Subcategory">
