...
public partial class CMSAPIExamples_Code_Documents_Categories_Default : CMSAPIExamplePage
{
    ...
    private bool CreateSubcategory()
    {
        ...
        CategoryInfo parentCategory = CategoryInfoProvider.GetCategoryInfo("MyNewCategory", CMSContext.CurrentSiteName);
        if (parentCategory != null)
        {
            ...
            newSubcategory.CategorySiteID = CMSContext.CurrentSiteID;
    ...
    {
        // Get the category
        CategoryInfo deleteCategory = CategoryInfoProvider.GetCategoryInfo("MyNewSubcategory", CMSContext.CurrentSiteName);
