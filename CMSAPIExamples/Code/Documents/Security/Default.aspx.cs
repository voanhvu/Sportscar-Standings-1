...
public partial class CMSAPIExamples_Code_Documents_Security_Default : CMSAPIExamplePage
{
    ...
    private bool CheckDocTypePermissions()
    {
        ...
        if (user != null)
        {
            ...
            {
                apiCheckDocTypePermissions.InfoMessage = "User 'Andy' is allowed to read document type 'MenuItem'.";
            }
            else
            {
                apiCheckDocTypePermissions.InfoMessage = "User 'Andy' is not allowed to read document type 'MenuItem'.";
            }
    ...
    private bool FilterDataSet()
    {
        ...
        if (user != null)
        {
            ...
            if (!DataHelper.DataSourceIsEmpty(documents))
            {
                ...
                apiFilterDataSet.InfoMessage = "Data set with all documents filtered successfully by permission 'Modify permissions' for user 'Andy'. Permission inheritance broken for filtered items.";
            }
            else
            {
                // Data set filtered successfully - no items left in data set
                apiFilterDataSet.InfoMessage = "Data set with all documents filtered successfully by permission 'Modify permissions' for user 'Andy'. No items left in data set.";
            }
