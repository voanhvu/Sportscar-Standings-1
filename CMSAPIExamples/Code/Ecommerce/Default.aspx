...
<asp:Content ID="contentLeft" ContentPlaceHolderID="plcLeftContainer" runat="server">
    ...
    <%-- Product membership --%>
        <cms:APIExamplePanel ID="pnlCreateMembershipProduct" runat="server" GroupingText="Product - membership">
    ...
    <%-- Product eProduct --%>
        <cms:APIExamplePanel ID="pnlCreateEProduct" runat="server" GroupingText="Product - eProduct">
    ...
    <%-- Product donation --%>
        <cms:APIExamplePanel ID="pnlCreateDonation" runat="server" GroupingText="Product - donation">
    ...
    <%-- Product bundle --%>
        <cms:APIExamplePanel ID="pnlCreateBundle" runat="server" GroupingText="Product - bundle">
    ...
    <%-- Shopping cart --%>
    <cms:APIExamplePanel ID="pnlAddProductToShoppingCart" runat="server" GroupingText="Shopping cart">
...
<asp:Content ID="contentRight" ContentPlaceHolderID="plcRightContainer" runat="server">
    ...
    <%-- Shopping cart --%>
    <cms:APIExamplePanel ID="pnlRemoveProductFromShoppingCart" runat="server" GroupingText="Shopping cart">
    ...
    <%-- Product bundle --%>
    <cms:APIExamplePanel ID="pnlDeleteBundle" runat="server" GroupingText="Bundle">
    ...
    <%-- Product donation --%>
    <cms:APIExamplePanel ID="pnlDeleteDonation" runat="server" GroupingText="Donation">
     ...
     <%-- Product eProduct --%>
    <cms:APIExamplePanel ID="pnlDeleteEProduct" runat="server" GroupingText="EProduct">
   ...
   <%-- Product membership --%>
    <cms:APIExamplePanel ID="pnlDeleteMembershipProduct" runat="server" GroupingText="Membership">
