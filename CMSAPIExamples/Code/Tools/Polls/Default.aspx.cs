...
[Title(Text = "Polls", ImageUrl = "CMSModules/CMS_Polls/module.png")]
...
public partial class CMSAPIExamples_Code_Tools_Polls_Default : CMSAPIExamplePage
{
    ...
    {
        // Get the poll
        PollInfo updatePoll = PollInfoProvider.GetPollInfo("MyNewPoll", CMSContext.CurrentSiteID);
    ...
    {
        // Get the poll
        PollInfo deletePoll = PollInfoProvider.GetPollInfo("MyNewPoll", CMSContext.CurrentSiteID);
    ...
    {
        // Get the poll
        PollInfo poll = PollInfoProvider.GetPollInfo("MyNewPoll", CMSContext.CurrentSiteID);
