        ...
        <ItemTemplate>
            <asp:Panel runat="server" ID="pnlItem" CssClass="Item">
                <asp:Panel runat="server" ID="pnlItemPadding" CssClass="ItemPadding">
                    <asp:Image runat="server" ID="imgItem" CssClass="Icon" EnableViewState="false" ImageUrl='<%#UIHelper.GetImageUrl(Page, "Design/Controls/ContextMenu/User/" + Convert.ToString(DataBinder.Eval(Container.DataItem, "ActionIcon")))%>' />&nbsp;
