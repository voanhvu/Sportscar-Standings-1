            ...
            <tbody>
                <tr>
                    <td style="width: 250px">
                        <span id="msgSpellComplete" class="AdvancedLabel Succ" style="opacity: 0; position: fixed;">
                            <asp:Label ID="lblSpellComplete" runat="server" />
                        </span><em>
                            <asp:Label ID="lblNotInDictionary" runat="server" />
                        </em>
                    </td>
                    <td>
