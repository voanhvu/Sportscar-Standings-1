...
<table>
    <tr>
        <td style="vertical-align: middle">
            <cms:MacroTreeEditor ID="leftOperand" ShortID="lo" runat="server" MixedMode="false" AbsolutePosition="true" />
        </td>
        <td>
        ...
        <td>
            <asp:Panel runat="server" ID="pnlRightOperand">
                <cms:MacroTreeEditor ID="rightOperand" ShortID="ro" runat="server" MixedMode="false" AbsolutePosition="true" />
            </asp:Panel>
        </td>
    </tr>
</table>
