<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSAdminControls_UI_Macros_MacroEditor"
    CodeFile="MacroEditor.ascx.cs" %>
...
<cms:ExtendedTextArea runat="server" ID="txtCode" EditorMode="Advanced" Width="500px"
    Height="200px" Language="CSharp" />
