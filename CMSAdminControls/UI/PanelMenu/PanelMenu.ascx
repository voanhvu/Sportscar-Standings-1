...
<script type="text/javascript">
    ...
    function SelectRibbonButton(name) {
        if ((parent.frames[0] != null) && (parent.frames[0].CMSUniMenu != null) && (parent.frames[0].CMSUniMenu.SelectMenuButton != null)) {
            parent.frames[0].CMSUniMenu.SelectMenuButton(name);
        }
    }
    //]]>
</script>
