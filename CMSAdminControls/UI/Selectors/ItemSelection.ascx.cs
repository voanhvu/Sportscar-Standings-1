        ...
        if ((LeftItems != null) && (LeftItems.Length > 0))
        {
            ...
            for (int i = 0; i < lstLeftColumn.Items.Count; i++)
            {
                if (lstLeftColumn.Items[i].Selected == true)
                {
                    ...
                    lstRightColumn.Items.Add(lstLeftColumn.Items[i]);
                    lstLeftColumn.Items.Remove(lstLeftColumn.Items[i]);
                    i--;
                }
            }
            ChangeProperties();
        ...
        if ((RightItems != null) && (RightItems.Length > 0))
        {
            ...
            for (int i = 0; i < lstRightColumn.Items.Count; i++)
            {
                if (lstRightColumn.Items[i].Selected == true)
                {
                    ...
                    lstLeftColumn.Items.Add(lstRightColumn.Items[i]);
                    lstRightColumn.Items.Remove(lstRightColumn.Items[i]);
                    i--;
                }
            }
            btnDown.Enabled = false;
