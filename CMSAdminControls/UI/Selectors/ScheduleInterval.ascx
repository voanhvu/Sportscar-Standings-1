...
<asp:Panel runat="server" ID="pnlBody" CssClass="EditingFormControl">
    ...
    <table cellpadding="0" cellspacing="3">
        ...
        <asp:PlaceHolder runat="server" ID="pnlMonth" Visible="false">
            <tr>
                <td nowrap="nowrap">
                    <cms:LocalizedRadioButton ID="radMonthDate" runat="server" AutoPostBack="true" OnCheckedChanged="radMonthDate_CheckedChanged"
                        Checked="True" ResourceString="scheduleinterval.period.day" />
                </td>
                <td>
                    <asp:DropDownList ID="drpMonthDate" runat="server" />
                    &nbsp;
            ...
            <tr>
                <td>
                    <cms:LocalizedRadioButton ID="radMonthSpecification" runat="server" AutoPostBack="true"
                        OnCheckedChanged="radMonthSpecification_CheckedChanged" ResourceString="scheduleinterval.months.the" />
                </td>
                <td>
                    <asp:DropDownList ID="drpMonthOrder" runat="server" />
                    &nbsp;
                    <asp:DropDownList ID="drpMonthDay" runat="server" />
                    &nbsp;
