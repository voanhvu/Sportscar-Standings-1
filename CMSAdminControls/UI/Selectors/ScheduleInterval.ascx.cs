...
public partial class CMSAdminControls_UI_Selectors_ScheduleInterval : BaseSchedulingControl
{
    ...
    /// </summary>
    public override TextBox Quantity
    {
        get
        {
            return txtEvery;
    ...
    /// </summary>
    public override TextBox FromHours
    {
        get
        {
            return txtFromHours;
    ...
    /// </summary>
    public override TextBox FromMinutes
    {
        get
        {
    ...
    /// </summary>
    public override TextBox ToHours
    {
        get
        {
            return txtToHours;
    ...
    /// </summary>
    public override TextBox ToMinutes
    {
        get
        {
            return txtToMinutes;
    ...
    /// </summary>
    public override CheckBoxList WeekDays
    {
        get
        {
            return chkWeek;
    ...
    /// </summary>
    public override CheckBoxList WeekEnd
    {
        get
        {
            return chkWeekEnd;
    ...
    /// </summary>
    public override RadioButton MonthModeDate
    {
        get
        {
            return radMonthDate;
    ...
    /// </summary>
    public override RadioButton MonthModeSpecification
    {
        get
        {
