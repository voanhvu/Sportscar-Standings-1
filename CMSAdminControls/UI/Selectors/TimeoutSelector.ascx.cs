...
public partial class CMSAdminControls_UI_Selectors_TimeoutSelector : BaseSchedulingControl
{
    ...
    /// Time unit used
    /// </summary>
    public override DropDownList Period
    {
        get
        {
            return drpScale;
    ...
    /// </summary>
    public override DropDownList MonthDate
    {
        get
        {
            return drpNextDate;
    ...
    /// </summary>
    public override DropDownList MonthOrder
    {
        get
        {
            return drpNextOrder;
    ...
    /// </summary>
    public override DropDownList MonthDay
    {
        get
        {
            return drpNextDay;
    ...
    {
        plcHourMinute.Visible = cbSpecificTime.Checked;
        rvQuantity.MinimumValue = QuantityLowerBound.ToString();
    }
    ...
    private void ScaleChanged()
    {
        switch (drpScale.SelectedValue)
        {
            ...
            case SchedulingHelper.PERIOD_MONTH:
                ...
                plcNextDateMonth.Visible = false;
                plcNextDay.Visible = true;
    ...
    {
        // 'Quantity' panel validators
        rfvQuantity.ErrorMessage = GetString("timeoutselector.quantity.errorempty");
        rvQuantity.MinimumValue = "1";
        rvQuantity.MaximumValue = QUANTITYMAXIMUM.ToString();
        rvQuantity.ErrorMessage = String.Format(GetString("timeoutselector.quantity.wrongformat"), QUANTITYMAXIMUM);
    }
