...
public partial class CMSAdminControls_UI_Trees_UniTree : CMSUserControl, IPostBackEventHandler
{
    #region "Variables"
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        foreach (object item in defaultItems)
        {
            ...
            if (defaultItem != null)
            {
                ...
                if (selectedItem == defaultItem[2].ToLowerCSafe())
                {
    ...
    {
        return ControlsHelper.GetPostBackEventReference(btnItemSelected, null, false);
    }
