...
<table>
    ...
    <tr>
        ...
        <td>
            <cms:CodeName ID="txtName" runat="server" CssClass="TextBoxField" MaxLength="200"
    ...
    <tr>
        ...
        <td>
            <cms:FormSubmitButton ID="btnOk" runat="server" OnClick="btnOk_Click" ValidationGroup="UIProfile" EnableViewState="false" />
        </td>
    </tr>
</table>
