...
public partial class CMSAdminControls_Validation_AccessibilityValidator : DocumentValidator
{
    ...
    private DropDownList mStandardList = null;
    ...
    private void SetupControls()
    {
        ...
        validate.ControlType = HeaderActionTypeEnum.LinkButton;
        ...
        HeaderActions.HelpTopicName = "accessibilityvalidator";
    ...
    private DataSet GetValidationResult(string htmlData)
    {
        try
        {
            ...
            if (answer != null)
            {
                ...
                //var divWarnings = doc.DocumentNode.SelectSingleNode("//div[@id='AC_likely_problems']");
                //var divPotential = doc.DocumentNode.SelectSingleNode("//div[@id='AC_potential_problems']");
    ...
    {
        string separator = ResHelper.NewLine;
        boundary = "--" + boundary;
    ...
    public void ProcessResult(DataSet validationResult)
    {
        if (validationResult != null)
        {
            ...
            if (!DataHelper.DataSourceIsEmpty(validationResult))
            {
                ...
                lblStatus.Text = GetString("validation.access.resultinvalid");
            ...
            else
            {
                ...
                lblStatus.Text = GetString("validation.access.resultvalid");
