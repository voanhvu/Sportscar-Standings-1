...
public partial class CMSFormControls_Basic_TimeControl : FormEngineUserControl
{
    ...
    public DateTime Time
    {
        ...
        set
        {
            ...
            txtMinute.Text = ((value.Minute < 10) ? "0" : "") + value.Minute.ToString();
        }
    }
    ...
    private DateTimeFormatInfo DateTimeFormat
    {
        get
        {
            ...
            {
                CultureInfo ci = CultureHelper.GetCultureInfo(IsLiveSite ? CurrentUser.PreferredCultureCode : CurrentUser.PreferredUICultureCode);
