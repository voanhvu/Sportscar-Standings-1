                ...
                <tr>
                    ...
                    <td>
                        <asp:Panel runat="server" ID="pnlType">
                            <cms:LocalizedRadioButton runat="server" ID="radPage" ResourceString="URLPath.Standard"
                                Checked="true" GroupName="URL" AutoPostBack="true" />
                            <cms:LocalizedRadioButton runat="server" ID="radRoute" ResourceString="URLPath.Route"
                                GroupName="URL" AutoPostBack="true" />
                            <cms:LocalizedRadioButton runat="server" ID="radMVC" ResourceString="URLPath.MVC"
                                GroupName="URL" AutoPostBack="true" />
                        </asp:Panel>
                    </td>
                </tr>
