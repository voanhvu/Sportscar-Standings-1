...
public partial class CMSFormControls_Filters_SiteGroupFilter : CMSAbstractBaseFilterControl
{
    ...
    public override string WhereCondition
    {
        get
        {
            if (ShowSiteFilter)
            {
                base.WhereCondition = SqlHelperClass.AddWhereCondition(siteFilter.WhereCondition, GenerateWhereCondition(SelectedGroupID));
            }
            else
            {
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        if (ShowSiteFilter)
        {
            WhereCondition = SqlHelperClass.AddWhereCondition(siteFilter.WhereCondition, GenerateWhereCondition(SelectedGroupID));
        }
        else
        {
