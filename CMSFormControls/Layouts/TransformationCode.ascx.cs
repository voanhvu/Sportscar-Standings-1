...
public partial class CMSFormControls_Layouts_TransformationCode : FormEngineUserControl, IPostBackEventHandler
{
    ...
    public override object[,] GetOtherValues()
    {
        ...
        {
            TransformationInfo ti = CMSContext.EditedObject as TransformationInfo;
...
" + ControlsHelper.GetPostBackEventReference(this, "#").Replace("'#'", "type") + @"
        ...
        // Init transformation help icon
        helpElem.HelpName = "helpTopic";
        helpElem.TopicName = "newedit_transformation_methods";
        helpElem.Tooltip = GetString("documenttype_edit_transformation.help");
