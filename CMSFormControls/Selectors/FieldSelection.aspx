    ...
    <cms:CMSUpdatePanel ID="pnlUpdate" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:Panel ID="pnlContent" CssClass="PageContent" runat="server">
                <table>
                    <asp:PlaceHolder ID="plcClassNames" runat="server">
                        <tr>
                            <td>
                                <cms:LocalizedLabel ID="lblClassNames" runat="server" CssClass="ContentLabel" DisplayColon="true" />
                            </td>
                            <td>
                                <cms:SelectClassNames ID="selectionElem" runat="server" />
                            </td>
                        </tr>
                    </asp:PlaceHolder>
                    <tr>
