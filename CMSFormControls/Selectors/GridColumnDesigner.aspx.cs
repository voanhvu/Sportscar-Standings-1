...
public partial class CMSFormControls_Selectors_GridColumnDesigner : DesignerPage
{
    ...
    private string mSelColId = null;
    private string mColId = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (string.IsNullOrEmpty(QueryHelper.GetString("queryname", string.Empty)) || QueryHelper.ValidateHash("hash"))
        {
            ...
            CurrentMaster.Title.TitleText = GetString("GridColumnDesigner.Title");
            ...
            btnClose.Text = GetString("GridColumnDesigner.btnClose");
            ...
            CurrentMaster.Title.TitleImage = GetImageUrl("Design/Selectors/selectcolumns.png");
            ...
            script.AppendLine("document.getElementById('" + hdnClassNames.ClientID + "').value = wopener.GetClassNames('" + mColId + "'); ");
            script.AppendLine("document.getElementById('" + hdnSelectedColumns.ClientID + "').value = wopener.GetSelectedColumns('" + mSelColId + "'); ");
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        if (ItemSelection1.Visible)
        {
            ...
            {
                ShowWarning(GetString("grid.noselection"), null, null);
            }
        }
    }
    ...
    protected void btnClose_Click(object sender, EventArgs e)
    {
        ...
        script.AppendLine("wopener.SetValue(columnsElem.value, classNamesElem.value,'" + mSelColId + "','" + mColId + "'); ");
    ...
    /// <summary>
    /// Search if selcted item is in field.
    /// </summary>
