...
<asp:Content ID="content" ContentPlaceHolderID="plcContent" runat="Server">
    <asp:Panel ID="pnlContent" CssClass="PageContent" runat="server">
        ...
        <asp:PlaceHolder runat="server" ID="plcCreate" Visible="false">
            <br />
            <cms:LocalizedButton runat="server" ID="btnCreate" ResourceString="localizable.create" OnClick="btnCreate_Click" />
        </asp:PlaceHolder>
