...
public partial class CMSFormControls_Selectors_TagSelector : CMSModalPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        // Page title
        CurrentMaster.Title.TitleImage = ResolveUrl(GetImageUrl("Objects/CMS_TagGroup/object.png"));
    ...
    protected void btnOk_Click(object sender, EventArgs e)
    {
        ...
        {
            List<string> tags = gridElem.SelectedItems;
            tags.Sort();
    ...
    protected void gridElem_OnAfterDataReload()
    {
        ...
        {
            // Fill list with tags
            var selection = (from string tag in selectedTags.Values select tag.Trim('"')).ToList();
