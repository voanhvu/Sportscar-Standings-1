...
public partial class CMSInstall_Controls_WizardSteps_AsyncProgress : CMSUserControl, ICallbackEventHandler
{
    ...
    private class ProgressMessagesHelper
    {
        ...
        readonly string storageContent;
        ...
        {
            if (SystemHelper.DBSeparationStartedByServer != HTTPHelper.MachineName)
            {
    ...
    {
        LogMessage(message, CMSDatabaseHelper.MessageType.Info, false);
