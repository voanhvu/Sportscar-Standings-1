...
public partial class CMSInstall_Controls_WizardSteps_DatabaseDialog : CMSUserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsDBSeparation)
        {
            ...
            imgHelp.ToolTip = GetString("separationDB.enabledtasksseparation");
        }
    }
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        if (AzureHelper.IsRunningOnAzure && AzureHelper.IsSQLAzureServer(ServerName))
        {
        ...
        if (!RequestHelper.IsPostBack())
        {
            ...
            if (SqlHelperClass.IsConnectionStringInitialized && !IsDBSeparation)
            {
    ...
    private void DisplaySeparationError(string error)
    {
        ...
        lblError.Text = TextHelper.LimitLength(error, 180);
