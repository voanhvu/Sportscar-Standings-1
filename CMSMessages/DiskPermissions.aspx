<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="CMSMessages_DiskPermissions" Theme="Default" CodeFile="DiskPermissions.aspx.cs" %>
...
<head runat="server" enableviewstate="false">
    <title>Site Manager - Disk permissions</title>
    <style type="text/css">
        body
        {
            margin: 0px;
    ...
    <form id="form1" runat="server">
        <asp:Panel ID="PanelBody" runat="server" CssClass="PageBody">
            ...
            <asp:Panel ID="PanelContent" runat="server" CssClass="PageContent">
                ...
                <p>
                    <img src='<%= GetImageUrl("Others/Messages/Screens/Permissions/image001.gif") %>' alt="Local disk properties" />
                </p>
                <table border="1" cellspacing="0" style="width: 400px;">
                    <tr>
                        <td style="vertical-align: top; padding: 15px 5px 0px 5px;">
                            <img src='<%= GetImageUrl("Others/Messages/Screens/Permissions/image002.gif") %>' alt="Paper sheet" /></td>
                        <td style="vertical-align: top; padding: 15px 5px 10px 5px;">
                            ...
                            <p>
                                <img src='<%= GetImageUrl("Others/Messages/Screens/Permissions/image003.gif") %>' alt="Folder options" />
                            </p>
                        </td>
                    </tr>
                </table>
                ...
                <p>
                    <img src='<%= GetImageUrl("Others/Messages/Screens/Permissions/image004.gif") %>' alt="Select users, computers, groups" />
                </p>
                <p>
                    Click <strong>Locations...</strong> and choose your local computer:</p>
                <p>
                    <img src='<%= GetImageUrl("Others/Messages/Screens/Permissions/image005.gif") %>' alt="Locations" />
                </p>
                <p>
                ...
                <p>
                    <img src='<%= GetImageUrl("Others/Messages/Screens/Permissions/image006.gif") %>' alt="Select users or groups" />
                </p>
                <p>
                ...
                <p>
                    <img src='<%= GetImageUrl("Others/Messages/Screens/Permissions/image007.gif") %>' alt="Select users or groups" />
                </p>
                <h1>
                ...
                <p>
                    <img src='<%= GetImageUrl("Others/Messages/Screens/Permissions/image008.gif") %>' alt="Properties" />
                </p>
                <p>
                    Click <strong>Add...</strong> The <strong>Select Users, Computers and Groups</strong> dialog appears.</p>
                <p>
                    <img src='<%= GetImageUrl("Others/Messages/Screens/Permissions/image009.gif") %>' alt="Select users, computers, groups" />
                </p>
                <p>
                    Click <strong>Locations...</strong> and choose your local computer:</p>
                <p>
                    <img src='<%= GetImageUrl("Others/Messages/Screens/Permissions/image010.gif") %>' alt="Locations" />
                </p>
                <p>
                ...
                <p>
                    <img src='<%= GetImageUrl("Others/Messages/Screens/Permissions/image011.gif") %>' alt="Select users or groups" />
                </p>
                <p>
                    Click <strong>OK</strong>. The account is added to the list of accounts. Grant the account
                    with <strong>Modify</strong> permissions and click <strong>OK</strong>.
                ...
                <p>
                    <img src='<%= GetImageUrl("Others/Messages/Screens/Permissions/image012.gif") %>' alt="Select users or groups" />
                </p>
                <h1>
