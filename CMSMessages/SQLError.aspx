    ...
    <form id="form1" runat="server">
        <asp:Panel ID="PanelBody" runat="server" CssClass="PageBody">
            ...
            <asp:Panel ID="PanelContent" runat="server" CssClass="PageContent">
                ...
                <p>
                    <img src='<%= GetImageUrl("Others/Messages/Screens/sql/image001.gif") %>' alt="Screen" />
                </p>
                <h1>
                ...
                <ol>
                    ...
                    <li>Make sure the access to the database server is not blocked by some firewall (the
                        ...
                        <img src='<%= GetImageUrl("Others/Messages/Screens/sql/image003.gif") %>' alt="Configuration manager" />
                    </li>
                    <li>You may also need to enable the TCP/IP protocol in the <strong>SQL Native Client Configuration
                        ...
                        <img src='<%= GetImageUrl("Others/Messages/Screens/sql/image005.gif") %>' alt="Configuration manager" />
                    </li>
                </ol>
                <h1>
                ...
                <p>
                    ...
                    Logins:</p>
                <img src='<%= GetImageUrl("Others/Messages/Screens/sql/image007.gif") %>' alt="Logins" />
                <p>
                ...
                <ul>
                    <li>SQL Server 2000:<br />
                        <img src='<%= GetImageUrl("Others/Messages/Screens/sql/image009.gif") %>' alt="sql2000" />
                    </li>
                    <li>SQL Server 2005:<br />
                        <img src='<%= GetImageUrl("Others/Messages/Screens/sql/image011.gif") %>' alt="sql2005" />
                    </li>
                </ul>
                <p>
                ...
                <img src='<%= GetImageUrl("Others/Messages/Screens/sql/image013.gif") %>' alt="Windows authentication" />
                <p>
