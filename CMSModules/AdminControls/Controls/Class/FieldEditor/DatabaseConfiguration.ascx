...
<asp:Panel ID="pnlDatabase" runat="server" CssClass="FieldPanel">
    <table>
        ...
        <asp:PlaceHolder ID="plcDefaultValue" runat="server">
            <tr>
                ...
                <td>
                    ...
                    <cms:LargeTextArea ID="txtLargeDefaultValue" Width="292" runat="server" Visible="false" />
        ...
        <asp:PlaceHolder ID="plcTranslation" runat="server">
            <tr>
                <td class="FieldLabel">
                    <cms:LocalizedLabel ID="lblTranslateField" runat="server" EnableViewState="false"
                        ResourceString="TemplateDesigner.AttributeTranslateField" DisplayColon="true" />
                </td>
                <td>
                    <asp:CheckBox ID="chkTranslateField" runat="server" CssClass="CheckBoxMovedLeft" />
                </td>
            </tr>
        </asp:PlaceHolder>
    </table>
