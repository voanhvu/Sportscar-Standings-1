                    ...
                    <WizardSteps>
                            ...
                            <asp:Panel ID="pnlWzdStep2" runat="server" CssClass="GlobalWizardStep">
                                ...
                                <table>
                                    ...
                                    <asp:PlaceHolder ID="plcExisting" runat="server" Visible="false">
                                        <tr>
                                            <td colspan="3">
                                                <asp:RadioButton ID="radNewTable" runat="server" Checked="True" GroupName="CustomTable"
                                                    AutoPostBack="true" OnCheckedChanged="radExistingTable_CheckedChanged" /><br />
                                                <asp:RadioButton ID="radExistingTable" runat="server" GroupName="CustomTable" AutoPostBack="true"
                                                    OnCheckedChanged="radExistingTable_CheckedChanged" /><br />
                                                <br />
                                            </td>
                                        </tr>
                                    </asp:PlaceHolder>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="drpExistingTables" DataValueField="TABLE_NAME"
                                                DataTextField="TABLE_NAME" Visible="false" CssClass="DropDownField" />
                                    ...
                                    <asp:PlaceHolder ID="plcCustomTablesOptions" runat="server" Visible="false">
                                        <tr>
                                            ...
                                            <td class="FieldLabel" style="padding-top: 10px">
                                                <asp:Label ID="lblItemGUID" runat="server" />
                                            </td>
                                            <td style="padding-top: 10px">
                                                <asp:CheckBox ID="chkItemGUID" runat="server" Checked="true" />
                                            </td>
                                            <td>
                                            </td>
                                        </tr>
                        ...
                        <asp:WizardStep ID="wzdStep3" runat="server" AllowReturn="false">
                            <asp:Panel ID="pnlWzdStep3" runat="server" CssClass="GlobalWizardStep FieldEditorPanel"
                                Height="400px">
                                <cms:FieldEditor ID="FieldEditor" IsLiveSite="false" runat="server" DisplaySourceFieldSelection="false" />
                            </asp:Panel>
                        </asp:WizardStep>
                        <%-- Step 4 --%>
