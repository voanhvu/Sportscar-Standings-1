...
public partial class CMSModules_AdminControls_Controls_MetaFiles_FileList : CMSUserControl
{
    ...
    protected bool AllowModify
    {
        get
        {
            return Enabled && AllowEdit && (!CheckObjectPermissions || UserInfoProvider.IsAuthorizedPerObject(ObjectType, ObjectID, PermissionsEnum.Modify, CMSContext.CurrentSiteName, CMSContext.CurrentUser));
        }
    }
