...
<asp:Panel ID="pnlAdd" runat="server" CssClass="UploaderAddLink" EnableViewState="false">
    <asp:Image runat="server" ID="imgAdd" CssClass="NewItemImage" EnableViewState="false" /><asp:HyperLink
        ID="lnkAdd" runat="server" CssClass="NewItemLink" EnableViewState="false" />
</asp:Panel>
