...
<asp:Content runat="server" ContentPlaceHolderID="plcFooter" ID="cntFooter">
    <div class="FloatRight">
        <cms:LocalizedButton runat="server" ID="btnClose" OnClientClick="return CloseDialog();" ResourceString="General.Close" EnableViewState="false" CssClass="SubmitButton" />
    </div>
</asp:Content>
