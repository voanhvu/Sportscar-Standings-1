        ...
        <tr>
            <td colspan="2">
                <cms:UniGrid ID="gridHistory" runat="server" OrderBy="HistoryID DESC" IsLiveSite="false"
                    ...
                    <GridColumns>
                        <ug:Column Source="HistoryApprovedWhen" ExternalSourceName="approvedwhen" Caption="$Unigrid.Workflow.Columns.ApprovedWhen$"
                            Wrap="false">
                            <Tooltip Source="HistoryApprovedWhen" ExternalSourceName="approvedwhentooltip" />
                        </ug:Column>
                        ...
                        <ug:Column Source="HistoryComment" Caption="$Unigrid.Workflow.Workflow.Comment$"
                            IsText="true" Wrap="false" Width="100%" />
