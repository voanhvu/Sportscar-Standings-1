...
<asp:Content ID="cntBody" runat="server" ContentPlaceHolderID="plcContent">
    ...
    <table>
        <tr>
            ...
            <td>
                <asp:TextBox runat="server" ID="txtAvatarName" CssClass="TextBoxField" MaxLength="200" />
                <cms:CMSRequiredFieldValidator runat="server" ID="valAvatarName" ControlToValidate="txtAvatarName" EnableViewState="false" /></td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <cms:FormSubmitButton runat="server" ID="btnOk" Style="text-align: center;" OnClick="btnOK_Click" EnableViewState="false" />
            </td>
        </tr>
    </table>
</asp:Content>
