...
<asp:Content ID="cntBody" ContentPlaceHolderID="plcContent" runat="server">
    <table>
        ...
        <tr>
            ...
            <td class="FieldValue">
                <cms:CodeName runat="server" ID="txtName" MaxLength="100" CssClass="TextBoxField" />
        ...
        <tr>
            ...
            <td class="FieldValue">
                <cms:FormSubmitButton ID="btnOk" runat="server" ValidationGroup="validateOK" OnClick="btnOK_Click" EnableViewState="false" />
            </td>
        </tr>
    </table>
</asp:Content>
