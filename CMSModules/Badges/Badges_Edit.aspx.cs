...
public partial class CMSModules_Badges_Badges_Edit : SiteManagerPage
{
    ...
    {
        // Set the page title
        CurrentMaster.Title.TitleText = GetString("badge.newbadge");
        CurrentMaster.Title.TitleImage = GetImageUrl("Objects/CMS_Badge/new.png");
        CurrentMaster.Title.HelpTopicName = "badge_edit";
        ...
        if (badgeId > 0)
        {
            ...
            if (bi != null)
            {
                CurrentMaster.Title.TitleText = GetString("badge.properties");
                pageTitleTabs[1, 0] = HTMLHelper.HTMLEncode(bi.BadgeDisplayName);
                CurrentMaster.Title.TitleImage = GetImageUrl("Objects/CMS_Badge/object.png");
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        if (DataHelper.IsEmpty(error))
        {
            ...
            {
                ShowError(GetString("badge.errors.uniquecodename"));
            }
        }
        else
        {
