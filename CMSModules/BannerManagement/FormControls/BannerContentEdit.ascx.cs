...
public partial class CMSModules_BannerManagement_FormControls_BannerContentEdit : FormEngineUserControl
{
        ...
        get
        {
            ...
            switch (BannerType)
            {
                ...
                case BannerTypeEnum.Image:
                    ...
                    {
                        Src = URLHelper.UnResolveUrl(imsImage.Value, URLHelper.ResolveUrl("~/")),
    ...
    {
        //macroEditorPlain.Editor.EditorMode = EditorModeEnum.Basic;
        htmlBanner.RemoveButton("QuicklyInsertImage");
        ...
        macroEditorPlain.Editor.Language = LanguageEnum.HTMLMixed;
