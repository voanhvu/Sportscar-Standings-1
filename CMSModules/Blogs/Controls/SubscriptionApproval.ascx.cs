...
public partial class CMSModules_Blogs_Controls_SubscriptionApproval : CMSUserControl
{
    ...
    private void SetupControls(bool forceReload)
    {
        ...
        btnConfirm.CssClass = DataHelper.GetNotEmpty(ConfirmationButtonCssClass, "LongButton");
    ...
    private void CheckAndSubscribe(string subscriptionHash, string requestTime, bool checkOnly)
    {
        ...
        {
            // Validate hash 
            result = BlogPostSubscriptionInfoProvider.ValidateHash(SubscriptionObject, subscriptionHash, CMSContext.CurrentSiteName, datetime);
        ...
        else
        {
            ...
            result = BlogPostSubscriptionInfoProvider.ApproveSubscription(SubscriptionObject, subscriptionHash, false, CMSContext.CurrentSiteName, datetime);
        }
