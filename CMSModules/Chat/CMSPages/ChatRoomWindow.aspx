    ...
    <asp:Panel runat="server" ID="pnlChatRoomPasswordPrompt" CssClass="ModalPopupDialog"
        ...
        <div class="DialogPageBody">
            <div class="PageHeader">
                <cms:PageTitle runat="server" ID="passwordPromptElem" SetWindowTitle="false" />
            </div>
            <div class="DialogPageContent">
                ...
                <asp:TextBox runat="server" ID="txtChatRoomPasswordPromptInput" CssClass="TextBoxFieldSmall"
    ...
    <asp:Panel runat="server" ID="pnlFooterContainer" Visible="true">
        <div id="divFooter" class="PageFooterLine" >
            ...
            <asp:Panel runat="server" ID="pnlFooter" CssClass="FloatRight">
                <cms:LocalizedButton ID="btnCloseWindow" runat="server" UseSubmitBehavior="true" CssClass="SubmitButton" ResourceString="chat.closewindow"/>
            </asp:Panel>
        </div>
    </asp:Panel>
</asp:Panel>
