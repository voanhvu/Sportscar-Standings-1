ChatBBCodeParserObj = function () {
    ...
    function ResolveTag(tagobj, textOnly) {
        ...
        switch (tagobj[0]) {
            ...
            case "[img]":
                if (tagobj[2] != null) {
                    resolved = '<img class="ChatBBCodeImg" src="' + tagobj[2] + '" alt="' + tagobj[2] + '" />';
                    isImage = true;
                }
                break;
            default:
                    ...
                    case "url":
                        if (tagobj[2] != null) {
                            if (IsValidURL(tagobj[2])) {
                                resolved = '<a class="ChatBBCodeUrl" href="' + tagobj[2] + '" onclick="return !window.open(\'' + tagobj[2] + '\',\'_blank\',\'\');">';
                            }
                            else {
                                resolved = tagobj[2] + " ";
                            }
