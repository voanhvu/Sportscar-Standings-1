	                ...
	                if (obj != null) {
						...
						if (wasLoggedIn){
		                    ...
		                    if (ChatManager.Settings.CurrentCookieLevel >= 0) {
		                        ...
		                        jQuery.cookie("chat_kick_roomid_" + roomid, "kicked", { expires: exp })
		                    }
...
function ChatGroupManager(chatMan, grID) {
    ...
    this.JoinRoom = function (roomID, psw, fnok, fnerr) {
        ...
        if ((jQuery.cookie("chat_kick_roomid_" + roomID) != null) && that.ChatManager.Login.IsAnonymous) {
        ...
        callWebService("JoinRoom", function (roomInfo) {
            ...
            if (fnok != null) {
                fnok();
            } else if ((roomID != that.RoomIDToJoin) && (roomID != that.RoomIDToJoinCookie) && (that.ChatManager.Settings.RedirectURLJoin.length > 0)) {
	...
	this.ProcessRoomMessages = function(msgs) {
    ...
    function sendMessageToRoom(userID, msg, obj){
        ...
        callWebService((userID != null) ? "PostMessageToUser" : "PostMessage", function(response) {
            ...
            that.ProcessRoomMessages([response]);
        }, function(response) {
        	isSendingMessage = false;
        	that.ChatManager.GlobalError(response);
        ...
        if (that.WebpartsMessages.length > 0) {
        	if (response.Messages != null){
				...
				if ((msgs.List != null) && (msgs.List.length > 0)){
					that.ProcessRoomMessages(msgs.List);
				}
				else {
    ...
    function createRoomCookies(){
		...
		if(windowName.length > 0) {
			...
			jQuery.cookie(windowName + "_roomID", that.RoomID, {
				expires : 4
			});
		}
    }
    ...
    function deleteRoomCookies(){
		...
		if(windowName.length > 0) {
			windowName += "_" + that.GroupID;
			jQuery.cookie(windowName + "_roomID", null);
		}	
    }
...
function LoginObj(chMan) {
    ...
    function handleNickname(nick){
    	if (nick != null){
    		nick = jQuery.trim(nick.replace(/\s+/g," "));
    	}
    	return nick;
    }
...
function ChatManagerObj(stopRecursion) {
    ...
    if (jQuery.ChatManager != null) {
        return jQuery.ChatManager;
    }
    else if (!stopRecursion){
        jQuery.ChatManager = new ChatManagerObj(true);
        window.ChatManager = jQuery.ChatManager;
        return jQuery.ChatManager;
    }
	...
	this.IsSupportPopup = jQuery("div.ChatPopupWindow.IsOneToOne.IsSupport").length > 0;
        ...
        callWebService(actionType, function(response){ 
        	...
        	if ((actionType == "AcceptInvitation") && (notif != null) && (notif.RoomID != null)){
				...
				var settings = {
					...
					url: that.Settings.PopupWindowURL
				};
    ...
    this.KickUser = function(roomID, userID, groupID, permanently, clientID) {
        ...
        if (clientID != null){
        	...
        	if(obj != null){
        		wpHtml = jQuery(obj.Options.contentClientID).html();
        ...
        callWebService(fn, function() {
            ...
            if ((groupID!= null) && (groupID.length > 0)) {
                ...
                if (rm != null) {
                	...
                	jQuery(obj.Options.contentClientID).html(wpHtml);
                }
            }
        }, function(response){
    ...
    this.StartChat = function() {
        ...
        for (var i = 0; i < that.ChatGroupManagers.length; i++) {
        	if (refreshedPage){
        		...
        		if (windowName != null){
        			var roomID = jQuery.cookie(windowName + "_roomID");
               		if (roomID != null){
