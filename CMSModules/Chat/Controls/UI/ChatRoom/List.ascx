...
<cms:UniGrid runat="server" ID="gridElem" ObjectType="chat.room" OrderBy="ChatRoomDisplayName"
    ...
    <GridActions Parameters="ChatRoomID">
        ...
        <ug:Action Name="approve" ExternalSourceName="approve" Caption="$General.Enable$"  />
        <ug:Action Name="safedelete" ExternalSourceName="safedelete" Caption="$General.Delete$" Confirmation="$General.ConfirmDelete$" />
    </GridActions>
    <GridColumns>
