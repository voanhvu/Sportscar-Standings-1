...
public partial class CMSModules_Chat_Controls_UI_ChatSupportCannedResponse_List : CMSAdminListControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                Grid.WhereCondition = string.Format("(ChatSupportCannedResponseSiteID = {0} OR ChatSupportCannedResponseSiteID IS NULL) AND ChatSupportCannedResponseChatUserID IS NULL", CMSContext.CurrentSiteID);
            }
        }
