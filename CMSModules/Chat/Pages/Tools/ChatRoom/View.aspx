...
<div style="font-family:Arial" class="ChatDeskView" >
    <asp:Panel runat="server" ID="pnlChatWebpartLeftCol" style="float:left; max-width:250px;" >
    ...
    <asp:Panel runat="server" ID="pnlChatWebpartRightCol" style="float:left; max-width:750px" >
