...
<asp:Panel ID="pnlGeneral" runat="server" CssClass="ContentPanel">
    <table>
        ...
        <tr>
            ...
            <td class="AccountControlRight">
                <cms:SelectUser ID="accountOwner" runat="server" IsLiveSite="false" HideHiddenUsers="true"
                    HideDisabledUsers="true" HideNonApprovedUsers="true" AlwaysShowGlobalAdministrators="true" />
            </td>
        </tr>
    </table>
</asp:Panel>
...
<asp:Panel ID="pnlContacts" runat="server" CssClass="ContentPanel">
    <table>
        <tr>
            ...
            <td class="AccountControlLeft">
                <cms:ContactSelector ID="primaryContact" AutoPostBack="true" runat="server" IsLiveSite="false" />
            </td>
            <td class="AccountLabelRight">
        ...
        <tr>
            ...
            <td class="AccountControlLeft">
                <cms:ContactSelector ID="secondaryContact" AutoPostBack="true" runat="server" IsLiveSite="false" />
            </td>
            <td class="AccountLabelRight">
