...
public partial class CMSModules_ContactManagement_Controls_UI_Account_List : CMSAdminListControl, ICallbackEventHandler
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        gridElem.EditActionUrl = "Frameset.aspx?accountId={0}&siteId=" + SiteID;
...
{
    modalDialog('" + ResolveUrl(CONTACT_DETAIL_DIALOG) + @"?contactid=' + contactID, 'ContactDetail', '1024px', '700px');
}
