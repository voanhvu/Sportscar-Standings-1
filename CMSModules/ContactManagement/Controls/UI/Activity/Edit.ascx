...
<cms:UIForm runat="server" ID="EditForm" ObjectType="om.activity" IsLiveSite="false"
    DefaultFieldLayout="Inline" RedirectUrlAfterCreate="~/CMSModules/ContactManagement/Pages/Tools/Activities/Activity/List.aspx?saved=1&siteid={?siteid?}">
    <LayoutTemplate>
        <table>
            <tr>
                <cms:FormField runat="server" ID="fContact">
                    <td class="ActivityDetailsLabel">
                        <cms:FormLabel ID="lblContact" runat="server" EnableViewState="false" ResourceString="om.activity.contact"
                            DisplayColon="true" />
                    </td>
                    <td>
            ...
            <tr>
                <cms:FormField runat="server" ID="fType" Field="ActivityType">
                    <td class="ActivityDetailsLabel">
                        <cms:FormLabel ID="lblType" runat="server" EnableViewState="false" ResourceString="om.activity.type"
                            DisplayColon="true" />
                    </td>
                    <td>
            ...
            <tr>
                <cms:FormField runat="server" ID="fTitle" Field="ActivityTitle">
                    <td class="ActivityDetailsLabel">
                        <cms:FormLabel ID="lblTitle" runat="server" EnableViewState="false" ResourceString="om.activity.title"
                            DisplayColon="true" />
                    </td>
                    <td>
            ...
            <tr>
                <cms:FormField runat="server" ID="fValue" Field="ActivityValue">
                    <td class="ActivityDetailsLabel">
                        <cms:FormLabel ID="lblValue" runat="server" EnableViewState="false" ResourceString="om.activity.value"
                            DisplayColon="true" />
                    </td>
                    <td>
            ...
            <tr>
                <cms:FormField runat="server" ID="fURL" Field="ActivityURL">
                    <td class="ActivityDetailsLabel">
                        <cms:FormLabel ID="lblURL" runat="server" EnableViewState="false" ResourceString="om.activity.url"
                            DisplayColon="true" />
                    </td>
                    <td>
                        <cms:TextBoxControl ID="txtURL" runat="server" />
                    </td>
                </cms:FormField>
            </tr>
            <asp:PlaceHolder runat="server" ID="plcSite" Visible="false">
                <tr>
                    <cms:FormField runat="server" ID="fSite">
                        <td class="ActivityDetailsLabel">
                            <cms:FormLabel ID="lblSite" runat="server" EnableViewState="false" ResourceString="om.activity.site"
                                DisplayColon="true" />
                        </td>
                        <td>
            ...
            <tr>
                <cms:FormField runat="server" ID="fCampaign">
                    <td class="ActivityDetailsLabel">
                        <cms:FormLabel ID="lblCampaign" runat="server" EnableViewState="false" ResourceString="om.activity.campaign"
                            DisplayColon="true" />
                    </td>
                    <td>
            ...
            <tr>
                <cms:FormField runat="server" ID="fCreated" Field="ActivityCreated">
                    <td class="ActivityDetailsLabel">
                        <cms:FormLabel ID="lblCreated" runat="server" EnableViewState="false" ResourceString="om.activity.created"
                            DisplayColon="true" />
                    </td>
                    <td>
            ...
            <tr>
                <cms:FormField runat="server" ID="fComment">
                    <td class="ActivityDetailsLabel" style="vertical-align: top;">
                        <cms:FormLabel ID="lblComment" runat="server" EnableViewState="false" ResourceString="om.activity.comment"
                            DisplayColon="true" />
                    </td>
