...
<asp:Panel ID="pnl" runat="server" DefaultButton="btnFilter">
    <table cellpadding="0" cellspacing="2">
        ...
        <tr>
            <td>
                <cms:LocalizedLabel ID="lblType" runat="server" EnableViewState="false" ResourceString="general.type"
                    DisplayColon="true" />
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <cms:LocalizedButton ID="btnFilter" runat="server" CssClass="ContentButton"  ResourceString="general.search" EnableViewState="false" />
