...
<%@ Register Src="~/CMSFormControls/System/LocalizableTextBox.ascx" TagName="LocalizableTextBox"
    TagPrefix="cms" %>
<%@ Register Src="~/CMSModules/ContactManagement/FormControls/FormControlsSelector.ascx"
    TagName="FormControlsSelector" TagPrefix="cms" %>
<cms:UIForm runat="server" ID="EditForm" ObjectType="om.activitytype" RedirectUrlAfterCreate="Tab_General.aspx?typeid={%EditedObject.ID%}&saved=1"
    ...
    <LayoutTemplate>
        ...
        <cms:FormField runat="server" ID="fName" Field="ActivityTypeName" FormControl="CodeName"
        ...
        <tr>
            <td>
                <cms:FormLabel runat="server" ID="lblScoring" ResourceString="om.activitytype.scoringcontrols"
                    CssClass="Title" DisplayColon="true" EnableViewState="false" />
            </td>
            <td>
            </td>
            <td>
        ...
        <cms:FormField runat="server" ID="fMainFormControl" Field="ActivityTypeMainFormControl"
            ...
            <tr>
                ...
                <td>
                    <cms:FormControlsSelector runat="server" ID="ucMainControl" ShowControlsForInteger="true"
                        ShowAdditionalControls="selectdocument" />
                </td>
                <td>
                </td>
            </tr>
