...
<cms:UniGrid runat="server" ID="listElem" ObjectType="ma.automationstate" OrderBy="StateStatus, StateStepID" Columns="StateID, StateStepID, StateObjectID, StateWorkflowID, StateStatus, StateCreated, StateSiteID, StateUserID"
    ...
    <GridActions Parameters="StateID;StateObjectID">
        <ug:Action Name="edit" Caption="$ma.process.manage$" ExternalSourceName="edit" Icon="Edit.png" />
        <ug:Action Name="dialogedit" Caption="$ma.process.manage$" ExternalSourceName="dialogedit" OnClick="viewPendingContactProcess({0}); return false;" Icon="Edit.png" />
        <ug:Action Name="view" ExternalSourceName="view" Caption="$om.contact.viewdetail$" Icon="contactdetail.png" OnClick="viewContactDetails({1}); return false;" />
