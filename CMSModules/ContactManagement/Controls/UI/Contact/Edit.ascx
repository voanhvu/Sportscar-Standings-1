            ...
            <table>
                <tr>
                    <cms:FormField runat="server" ID="fFirstName" Field="ContactFirstName">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblFirstName" runat="server" EnableViewState="false" ResourceString="om.contact.firstname"
                                DisplayColon="true" />
                        </td>
                    ...
                    <cms:FormField runat="server" ID="fLastName" Field="ContactLastName">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblLastName" runat="server" EnableViewState="false" ResourceString="om.contact.lastname"
                                DisplayColon="true" />
                        </td>
                ...
                <tr>
                    <cms:FormField runat="server" ID="fMiddleName" Field="ContactMiddleName">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblMiddleName" runat="server" EnableViewState="false" ResourceString="om.contact.middlename"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControl">
                    ...
                    <cms:FormField runat="server" ID="fSalutation" Field="ContactSalutation">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblSalutation" runat="server" EnableViewState="false" ResourceString="om.contact.salutation"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControlRight">
                ...
                <tr>
                    <cms:FormField runat="server" ID="fTitleBefore" Field="ContactTitleBefore">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblTitleBefore" runat="server" EnableViewState="false" ResourceString="om.contact.titlebefore"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControl">
                    ...
                    <cms:FormField runat="server" ID="fTitleAfter" Field="ContactTitleAfter">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblTitleAfter" runat="server" EnableViewState="false" ResourceString="om.contact.titleafter"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControlRight">
            ...
            <table>
                <tr>
                    <cms:FormField runat="server" ID="fBirthday" Field="ContactBirthday">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblBirthday" runat="server" EnableViewState="false" ResourceString="om.contact.birthday"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControl">
                    ...
                    <cms:FormField runat="server" ID="fCompanyName" Field="ContactCompanyName">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblCompanyName" runat="server" EnableViewState="false" ResourceString="om.contact.companyname"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControlRight">
                            <cms:TextBoxControl ID="txtCompanyName" runat="server" MaxLength="100" />
                        </td>
                    </cms:FormField>
                </tr>
                <tr>
                    <cms:FormField runat="server" ID="fGender" Field="ContactGender">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblGender" runat="server" EnableViewState="false" ResourceString="om.contact.gender"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControl">
                    ...
                    <cms:FormField runat="server" ID="fJobTitle" Field="ContactJobTitle">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblJobTitle" runat="server" EnableViewState="false" ResourceString="om.contact.jobtitle"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControlRight">
                ...
                <tr>
                    <cms:FormField runat="server" ID="fCreated" Field="ContactCreated">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblCreated" runat="server" EnableViewState="false" ResourceString="general.created"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControl">
                    ...
                    <cms:FormField runat="server" ID="fLastLogon" Field="ContactLastLogon">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblLastLogon" runat="server" EnableViewState="false" ResourceString="general.lastlogon"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControlRight">
                            <asp:Label ID="cLastLogon" runat="server" />
                        </td>
                    </cms:FormField>
                </tr>
            </table>
            ...
            <table>
                <tr>
                    <cms:FormField runat="server" ID="fContactStatus" Field="ContactStatusID">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblContactStatus" runat="server" EnableViewState="false" ResourceString="om.contactstatus"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControl">
                    ...
                    <cms:FormField runat="server" ID="fOwner" Field="ContactOwnerUserID">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblOwner" runat="server" EnableViewState="false" ResourceString="om.contact.owner"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControlRight">
                            <cms:SelectUser ID="userSelector" runat="server" ShowSiteFilter="false" IsLiveSite="false"
                                HideHiddenUsers="true" HideDisabledUsers="true" HideNonApprovedUsers="true" AlwaysShowGlobalAdministrators="true" />
                        </td>
                    </cms:FormField>
                </tr>
                <tr>
                    <cms:FormField runat="server" ID="fMonitored" Field="ContactMonitored">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblMonitored" runat="server" EnableViewState="false" ResourceString="om.contact.tracking"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControl">
                    ...
                    <cms:FormField runat="server" ID="fCampaignSelection" Field="ContactCampaign">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblCampaign" runat="server" EnableViewState="false" ResourceString="analytics.campaign"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControlRight">
                            <cms:CampaignSelector ID="campaignSelector" runat="server" AllowEmpty="true" NoneRecordValue=""
                                CreateOnUnknownName="false" />
                        </td>
                    </cms:FormField>
                </tr>
            </table>
            ...
            <table>
                <tr>
                    <cms:FormField runat="server" ID="fAddress1" Field="ContactAddress1">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblAddress1" runat="server" EnableViewState="false" ResourceString="om.contact.address1"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControl">
                    ...
                    <cms:FormField runat="server" ID="fMobilePhone" Field="ContactMobilePhone">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblMobilePhone" runat="server" EnableViewState="false" ResourceString="om.contact.mobilephone"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControlRight">
                ...
                <tr>
                    <cms:FormField runat="server" ID="fAddress2" Field="ContactAddress2">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblAddress2" runat="server" EnableViewState="false" ResourceString="om.contact.address2"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControl">
                    ...
                    <cms:FormField runat="server" ID="fHomePhone" Field="ContactHomePhone">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblHomePhone" runat="server" EnableViewState="false" ResourceString="om.contact.homephone"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControlRight">
                ...
                <tr>
                    <cms:FormField runat="server" ID="fCity" Field="ContactCity">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblCity" runat="server" EnableViewState="false" ResourceString="general.city"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControl">
                    ...
                    <cms:FormField runat="server" ID="fBusinessPhone" Field="ContactBusinessPhone">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblBusinessPhone" runat="server" EnableViewState="false" ResourceString="om.contact.businessphone"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControlRight">
                ...
                <tr>
                    <cms:FormField runat="server" ID="fZip" Field="ContactZIP">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblZip" runat="server" EnableViewState="false" ResourceString="general.zip"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControl">
                    ...
                    <cms:FormField runat="server" ID="fEmail" Field="ContactEmail">
                        <td class="ContactLabel">
                            <cms:FormLabel ID="lblEmail" runat="server" EnableViewState="false" ResourceString="general.emailaddress"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControlRight">
                ...
                <tr>
                        <td class="ContactLabelDoubleHeight">
                            <cms:LocalizedLabel ID="lblCountry" runat="server" EnableViewState="false" ResourceString="general.country"
                                DisplayColon="true" AssociatedControlID="countrySelector" CssClass="EditingFormLabel" />
                        </td>
                        <td class="ContactControl">
                    ...
                    <cms:FormField runat="server" ID="fURL" Field="ContactWebSite">
                        <td class="ContactLabelDoubleHeight">
                            <cms:FormLabel ID="lblURL" runat="server" EnableViewState="false" ResourceString="om.contact.website"
                                DisplayColon="true" />
                        </td>
                        <td class="ContactControl">
