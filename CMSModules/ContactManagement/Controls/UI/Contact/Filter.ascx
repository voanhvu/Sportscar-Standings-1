...
<asp:Panel ID="pnlFilter" runat="server" DefaultButton="btnSearch">
    <table cellpadding="0" cellspacing="2">
        ...
        <tr>
            <td>
                <cms:LocalizedLabel ID="lblEmail" runat="server" ResourceString="general.emailaddress" DisplayColon="true"
        ...
        <asp:PlaceHolder ID="plcAdvancedSearch" runat="server" Visible="false">
            ...
            <tr>
                <td>
                    <cms:LocalizedLabel ID="lblSalesForceLeadReplicationStatus" runat="server" ResourceString="general.show"
                        DisplayColon="true" EnableViewState="false" />
                </td>
                <td>
                    <asp:RadioButtonList ID="radSalesForceLeadReplicationStatus" runat="server" RepeatDirection="Horizontal">
                    </asp:RadioButtonList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <cms:LocalizedLabel ID="lblCreated" runat="server" ResourceString="general.created"
                        DisplayColon="true" EnableViewState="false" />
                </td>
                <td>
