...
<asp:Panel ID="pnlSelector" runat="server" CssClass="CMSEditMenu">
    ...
    <cms:ProcessSelector ID="processSelector" runat="server" Enabled="false" IsLiveSite="false" />
    <div class="ClearBoth">
        &nbsp;</div>
</asp:Panel>
        ...
        <ContentTemplate>
            ...
            <cms:UniGrid runat="server" ID="gridElem" OrderBy="ContactLastName" ObjectType="om.contactgroupcontactlist"
                ...
                <GridActions Parameters="ContactID">
                    <ug:Action Name="edit" Caption="$om.contact.viewdetail$" Icon="contactdetail.png"
                        OnClick="EditContact({0});return false;" ModuleName="CMS.OnlineMarketing" />
