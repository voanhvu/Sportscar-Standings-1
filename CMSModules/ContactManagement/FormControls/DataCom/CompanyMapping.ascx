...
<ContentTemplate>
    ...
    <cms:LocalizedButton ID="EditMappingButton" runat="server" EnableViewState="false" ResourceString="datacom.mappingeditor.edit" CssClass="ContentButton"></cms:LocalizedButton>
</ContentTemplate>
</cms:CMSUpdatePanel>