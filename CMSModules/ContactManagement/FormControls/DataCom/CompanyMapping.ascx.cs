...
public partial class CMSModules_ContactManagement_FormControls_DataCom_CompanyMapping : FormEngineUserControl, ICallbackEventHandler
{
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        string script = String.Format("function DataCom_EditCompanyMapping (arg, context) {{ modalDialog('{0}', 'EditCompanyMapping', '600', '700', null); return false; }}", URLHelper.AddParameterToUrl(url, "hash", QueryHelper.GetHash(url)));
