...
/// <summary>
/// A control that provides the UI elements to display and edit the Data.com contact mapping.
/// </summary>
public partial class CMSModules_ContactManagement_FormControls_DataCom_ContactMapping : FormEngineUserControl, ICallbackEventHandler
{
    ...
    /// <summary>
    /// Gets or sets the serialized Data.com contact mapping.
    /// </summary>
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        string script = String.Format("function DataCom_EditContactMapping (arg, context) {{ modalDialog('{0}', 'EditContactMapping', '600', '700', null); return false; }}", URLHelper.AddParameterToUrl(url, "hash", QueryHelper.GetHash(url)));
        ScriptHelper.RegisterClientScriptBlock(this, GetType(), "DataCom_EditContactMapping", script, true);
    }
    ...
    /// <summary>
    /// Configures the edit button to open the dialog window to edit the specified Data.com contact mapping.
    /// </summary>
    private void InitializeEditButton()
    {
        EditMappingButton.OnClientClick = String.Format("{0}; return false;", Page.ClientScript.GetCallbackEventReference(this, null, "DataCom_EditContactMapping", null));
    }
