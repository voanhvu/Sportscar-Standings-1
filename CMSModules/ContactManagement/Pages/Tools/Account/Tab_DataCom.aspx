...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="plcContent">
    <cms:ErrorSummary ID="ErrorSummary" runat="server"></cms:ErrorSummary>
    <asp:HiddenField ID="CompanyHiddenField" runat="server" EnableViewState="false" />
    <cms:CMSPanel ID="CompanyFormPanel" ShortID="p" runat="server" EnableViewState="false">
        <cms:DataComForm ID="CompanyForm" runat="server"></cms:DataComForm>
    </cms:CMSPanel>
