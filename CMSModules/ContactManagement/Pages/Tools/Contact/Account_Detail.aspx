<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Account_Detail.aspx.cs" Inherits="CMSModules_ContactManagement_Pages_Tools_Contact_Account_Detail"
    Theme="Default" ValidateRequest="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Frameset//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-frameset.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server" enableviewstate="false">
    <title>Contact properties - Account detail</title>
    <style type="text/css">
        body
        {
            margin: 0px;
