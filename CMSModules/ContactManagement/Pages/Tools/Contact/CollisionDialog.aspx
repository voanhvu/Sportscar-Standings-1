                        ...
                        <div class="PaddingPanel">
                            ...
                            <asp:Panel ID="pnlPersonal" runat="server" CssClass="ContentPanel">
                                <table class="CollisionPanel">
                                    ...
                                    <tr class="CollisionRow">
                                        <td class="LabelColumn">
                                            <cms:LocalizedLabel ID="lblCompanyName" runat="server" ResourceString="om.contact.companyname"
                                                DisplayColon="true" EnableViewState="false" CssClass="ContentLabel" AssociatedControlID="cmbContactCompanyName" />
                                        </td>
                                        <td class="ComboBoxColumn">
                                            <div class="ComboBox">
                                        ...
                                        <td>
                                            <asp:Image ID="imgContactCompanyName" runat="server" CssClass="ResolveButton" Visible="false" />
                                        </td>
                                    </tr>
                                    <tr class="CollisionRow">
                                        <td class="LabelColumn">
                            ...
                            <asp:Panel ID="pnlAddress" runat="server" CssClass="ContentPanel">
                                <table class="CollisionPanel">
                                    ...
                                    <tr class="CollisionRow">
                                        <td class="LabelColumn">
                                            <cms:LocalizedLabel ID="lblContactEmail" runat="server" ResourceString="general.emailaddress" 
