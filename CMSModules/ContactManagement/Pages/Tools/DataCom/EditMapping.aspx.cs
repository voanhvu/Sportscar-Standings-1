...
public partial class CMSModules_ContactManagement_Pages_Tools_DataCom_EditMapping : CMSDataComDialogPage
{
    ...
    /// </summary>
    private RequestContext mContext = null;


    /// <summary>
    /// A dictionary of form field name/entity attribute dropdown control pairs.
    /// </summary>
    private Dictionary<string, DropDownList> mAttributeNamesDropDownLists = new Dictionary<string, DropDownList>();
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        CurrentMaster.Title.TitleText = GetString("datacom.editmapping.title");
    ...
    {
        Literal literal = e.Item.FindControl("FieldNameLiteral") as Literal;
        DropDownList dropDownList = e.Item.FindControl("AttributeNamesDropDownList") as DropDownList;
        FormFieldInfo fieldInfo = e.Item.DataItem as FormFieldInfo;
        literal.Text = ResHelper.LocalizeString(fieldInfo.Caption);
