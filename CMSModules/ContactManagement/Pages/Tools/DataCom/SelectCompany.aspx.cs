...
public partial class CMSModules_ContactManagement_Pages_Tools_DataCom_SelectCompany : CMSDataComDialogPage
{
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        CompanyGrid.OnDataReload += new OnDataReloadEventHandler(CompanyGrid_OnDataReload);
        CompanyGrid.OnAction += new OnActionEventHandler(CompanyGrid_OnAction);
        CompanyFilterControl.Search += new EventHandler(CompanyFilterControl_Search);
        CurrentMaster.Title.TitleText = GetString("datacom.companies.title");
