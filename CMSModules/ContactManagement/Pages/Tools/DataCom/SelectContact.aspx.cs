...
public partial class CMSModules_ContactManagement_Pages_Tools_DataCom_SelectContact : CMSDataComDialogPage
{
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        ContactGrid.OnDataReload += new OnDataReloadEventHandler(ContactGrid_OnDataReload);
        ContactGrid.OnAction += new OnActionEventHandler(ContactGrid_OnAction);
        ContactFilterControl.Search += new EventHandler(ContactFilterControl_Search);
        CurrentMaster.Title.TitleText = GetString("datacom.contacts.title");
