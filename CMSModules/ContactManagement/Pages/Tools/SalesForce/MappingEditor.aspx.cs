...
public partial class CMSModules_ContactManagement_Pages_Tools_SalesForce_MappingEditor : CMSSalesForceDialogPage
{
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        CurrentMaster.Title.TitleText = GetString("sf.mapping.leadreplication.title");
        ...
        try
        {
            if (RequestHelper.IsPostBack() && Page.Request.Params["__EVENTTARGET"] == "RefreshButton")
            {
                EntityModel = null;
            }
            RestoreParameters();
    ...
    private void RegisterStyles()
    {
        ...
        ";
        CSSHelper.RegisterCSSBlock(Page, content);
    }
