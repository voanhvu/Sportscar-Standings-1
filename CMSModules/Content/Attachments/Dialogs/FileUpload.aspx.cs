...
public partial class CMSModules_Content_Attachments_Dialogs_FileUpload : CMSModalPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (uploaderPath != "")
            {
                FileUpload fileUploaderElem = this.LoadUserControl(uploaderPath) as FileUpload;
