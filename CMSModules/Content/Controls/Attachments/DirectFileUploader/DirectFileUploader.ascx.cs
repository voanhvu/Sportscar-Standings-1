...
public partial class CMSModules_Content_Controls_Attachments_DirectFileUploader_DirectFileUploader : DirectFileUploader
{
    ...
    /// <summary>
    /// Indicates if silverlight uploader should be enabled. If false only direct file uploader iFrame will be rendered.
    /// </summary>
    ...
    /// <summary>
    /// If set, NodeGroupID of content file is set as well.
    /// </summary>
    public override int NodeGroupID
    {
        get
        {
            return base.NodeGroupID;
        }
        set
        {
            base.NodeGroupID = value;
            mfuDirectUploader.NodeGroupID = NodeGroupID;
        }
    }
