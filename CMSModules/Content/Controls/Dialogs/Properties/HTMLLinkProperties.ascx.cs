...
public partial class CMSModules_Content_Controls_Dialogs_Properties_HTMLLinkProperties : ItemProperties
{
    ...
    public override Hashtable GetItemProperties()
    {
        ...
        retval[DialogParameters.LINK_TEXT] = HTMLHelper.HTMLEncode(urlSelectElem.LinkText.Replace("%", "%25"));
        retval[DialogParameters.LINK_URL] = url.StartsWithCSafe("~/") ? URLHelper.ResolveUrl(url) : url;
        ...
        retval[DialogParameters.LINK_TOOLTIP] = HTMLHelper.HTMLEncode(txtAdvTooltip.Text.Trim().Replace("%", "%25"));
