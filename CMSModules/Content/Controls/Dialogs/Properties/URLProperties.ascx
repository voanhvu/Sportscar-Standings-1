                    ...
                    <table style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td style="width: 100%;" colspan="2">
                                    <div style="width: 100%;">
                                        ...
                                        <asp:ImageButton ID="imgRefresh" runat="server" OnClick="imgRefresh_Click" CssClass="DialogItemUrlRefresh"
                        ...
                        <asp:PlaceHolder ID="plcPreviewArea" runat="server">
                            <tr>
                                ...
                                <asp:PlaceHolder ID="plcAltTextValue" runat="server">
                                <td>
                                    <cms:CMSTextBox ID="txtAlt" runat="server" CssClass="LongTextBox" />
                                </td>
                                </asp:PlaceHolder>
                                <td runat="server" id="previewTd" style="width: 100%; vertical-align: top;" rowspan="3"
                                    enableviewstate="false">
