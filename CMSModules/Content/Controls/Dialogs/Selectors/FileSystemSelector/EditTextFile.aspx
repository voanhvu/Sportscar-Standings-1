<%@ Page Title="" Language="C#" MasterPageFile="~/CMSMasterPages/UI/Dialogs/ModalDialogPage.master"
    AutoEventWireup="True" CodeFile="EditTextFile.aspx.cs" Inherits="CMSModules_Content_Controls_Dialogs_Selectors_FileSystemSelector_EditTextFile"
    Theme="Default" %>
...
<asp:Content ID="cntFooter" ContentPlaceHolderID="plcFooter" runat="server">
    <div class="FloatRight">
        <cms:LocalizedButton runat="server" ID="btnOK" ResourceString="General.OK" CssClass="SubmitButton"
            OnClick="btnOK_Click" />
        <cms:LocalizedButton runat="server" ID="btnCancel" OnClientClick="CloseDialog(); return false"
