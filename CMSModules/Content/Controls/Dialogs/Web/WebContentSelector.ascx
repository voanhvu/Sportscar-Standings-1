        ...
        <div class="DialogWebContent">
            <table width="100%">
                <tr>
                    ...
                    <td class="TextRight" style="width: 100%; vertical-align: top; white-space: nowrap;" rowspan="2">
                ...
                <asp:PlaceHolder ID="plcAlternativeText" runat="server">
                    <tr>
                        ...
                        <td colspan="2">
                            <cms:CMSTextBox ID="txtAlt" runat="server" CssClass="DialogWebUrlMaxBox LeftAlign" />
                        </td>
                    </tr>
                </asp:PlaceHolder>
