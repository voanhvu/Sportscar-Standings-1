        ...
        switch (sourceName)
        {
            ...
            case "documentname":
                {
                    ...
                    if (isRootDocument)
                    {
                        ...
                        name = CMSContext.CurrentSiteName;
                    }
                    ...
                    if (ShowDocumentMarks)
                    {
                        ...
                        // Add icons
                        sb.Append(" ", UIHelper.GetDocumentMarks(Page, currentSiteName, CultureCode, stepType, container));
                    }
            ...
            case "modifiedwhentooltip":
                ...
                else
                {
                    ...
                    currentSiteInfo = currentSiteInfo ?? CMSContext.CurrentSite;
    ...
    public string GetCallbackResult()
    {
        ...
        switch (callbackAction)
        {
            ...
            case Action.Link:
                ...
                {
                    parameters["where"] = SqlHelperClass.AddWhereCondition(CurrentWhereCondition, "", "OR");
                }
