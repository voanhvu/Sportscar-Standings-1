...
public partial class CMSModules_Content_Controls_EditMenu : EditMenu
{
    ...
    private void RegisterActionScripts()
    {
        ...
        if (spellcheck != null)
        {
            ...
            sb.Append("var spellURL = '", ((CMSContext.ViewMode == ViewModeEnum.LiveSite) ? CMSContext.ResolveDialogUrl("~/CMSFormControls/LiveSelectors/SpellCheck.aspx") : CMSContext.ResolveDialogUrl("~/CMSModules/Content/CMSDesk/Edit/SpellCheck.aspx")), "'; \n");
                            ...
                            switch (originalMode)
                            {
                                ...
                                case FormModeEnum.Convert:
                                    ...
                                    else
                                    {
                                        ...
                                        if ((originalMode == FormModeEnum.InsertNewCultureVersion) && CMSContext.DisplaySplitMode && (CultureHelper.GetOriginalPreferredCulture() != Node.DocumentCulture))
                                        {
                                        ...
                                        else
                                        {
                                            ...
                                            AddScript("RefreshTree(" + Node.NodeID + "," + Node.NodeID + ");SelectNode(" + Node.NodeID + ");");
                                        }
                                    }
                                    break;
                            }
