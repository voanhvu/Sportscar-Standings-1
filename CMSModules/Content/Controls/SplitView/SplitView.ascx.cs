...
public partial class CMSModules_Content_Controls_SplitView_SplitView : CMSUserControl
{
    ...
    protected bool DisplaySplitMode
    {
        get
        {
            return CMSContext.DisplaySplitMode;
        }
    }
    ...
    protected bool SynchronizeScrollbar
    {
        get
        {
            return CMSContext.SplitModeSyncScrollbars;
        }
    }
        ...
        if (DisplaySplitMode)
        {
            ...
            switch (SplitMode)
            {
                ...
                case SplitModeEnum.Vertical:
                    ...
                    verticalFrameset.Attributes["cols"] = "*,12,*";
            ...
            // Register Init script - FSP_Init(frm1Url, frm2Url, emptyUrl, sepUrl, mainFrmId, frm1Id, frm1VId, frm2Id, vFrmId, frmSId, tHeight, mode, synchronize)
