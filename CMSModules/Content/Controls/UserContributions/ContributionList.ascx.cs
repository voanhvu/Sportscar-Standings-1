...
public partial class CMSModules_Content_Controls_UserContributions_ContributionList : CMSUserControl
{
    ...
    protected bool IsUserAuthorizedToDeleteDocument(TreeNode node)
    {
        ...
        bool isAuthorized = CMSContext.CurrentUser.IsAuthorizedPerDocument(node, new NodePermissionsEnum[] { NodePermissionsEnum.Delete, NodePermissionsEnum.Read }) == AuthorizationResultEnum.Allowed;
