...
<cms:UniGrid runat="server" ID="gridStates" ObjectType="cms.state" OrderBy="StateDisplayName"
    Columns="StateID, StateDisplayName, StateCode" IsLiveSite="false" EditActionUrl="Edit.aspx?countryid={%EditedObjectParent.ID%}&stateid={0}"
    ...
    <GridColumns>
        ...
        <ug:Column Source="StateCode" Caption="$Unigrid.Country_State.Columns.StateCode$"
            Wrap="false" Localize="true">
            <Filter Type="text" />
        </ug:Column>
        <ug:Column Width="100%" />
