...
<frameset border="0" rows="<%=mHeight%>, *" id="rowsFrameset">
    <frame name="Menu" src="CssStylesheet_Header.aspx?<%=QueryHelper.EncodedQueryString%>"
        scrolling="no" frameborder="0" noresize="noresize" />
    <frame name="Content" src="CssStylesheet_General.aspx?<%=QueryHelper.EncodedQueryString%>"
