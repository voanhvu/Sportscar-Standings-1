    ...
    <asp:Panel ID="pnlContainer" runat="server" EnableViewState="false">
        <table style="width: 100%">
            <tr>
                ...
                <td style="width: 100%">
                    ...
                    <cms:CMSRequiredFieldValidator ID="rfvDisplayName" runat="server" EnableViewState="false"
                        ControlToValidate="txtDisplayName:textbox" Display="dynamic" />
                </td>
            </tr>
            <tr>
                <td class="FieldLabel">
                ...
                <td>
                    <cms:CodeName ID="txtName" runat="server" MaxLength="200" CssClass="TextBoxField" /><br />
                    <cms:CMSRequiredFieldValidator ID="rfvName" runat="server" EnableViewState="false"
            ...
            <tr>
                ...
                <td>
                    <cms:ExtendedTextArea ID="txtText" runat="server" EnableViewState="false" EditorMode="Advanced"
                        Language="CSS" Height="385px" Width="99%" />
                </td>
            </tr>
            <tr>
                <td>
