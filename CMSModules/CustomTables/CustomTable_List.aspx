...
<asp:Content ID="cntBody" runat="server" ContentPlaceHolderID="plcContent">
    <cms:UniGrid runat="server" ID="uniGrid" OrderBy="ClassDisplayName" IsLiveSite="false"
        ...
        <GridActions>
            <ug:Action Name="edit" CommandArgument="ClassID" Caption="$General.Edit$" Icon="Edit.png" />
            <ug:Action Name="delete" CommandArgument="ClassID" Caption="$General.Delete$" Icon="Delete.png"
