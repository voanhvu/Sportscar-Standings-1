...
public partial class CMSModules_DeviceProfile_Pages_Development_PageLayouts : CMSDeviceProfilesPage, IPostBackEventHandler
{
    ...
    protected DeviceProfileInfo DeviceProfile
    {
        get
        {
            ...
            {
                mDeviceProfile = EditedObject as DeviceProfileInfo;
            }
    ...
    /// <summary>
    /// Gets or sets a value indicating whether the request processing should stop.
    /// </summary>
    /// <remarks>
    /// If there is an exception, the request processing is stopped to prevent another errors.
    /// </remarks>
    ...
    private CMSModules_DeviceProfile_Controls_LayoutBinding CreateLayoutBindingControl(int sourceLayoutId)
    {
        CMSModules_DeviceProfile_Controls_LayoutBinding control = LoadControl("~/CMSModules/DeviceProfile/Controls/LayoutBinding.ascx") as CMSModules_DeviceProfile_Controls_LayoutBinding;
