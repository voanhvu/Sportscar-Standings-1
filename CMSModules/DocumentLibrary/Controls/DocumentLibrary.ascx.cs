...
public partial class CMSModules_DocumentLibrary_Controls_DocumentLibrary : CMSUserControl, IPostBackEventHandler
{
    ...
    public string PermissionsIconImageUrl
    {
        get
        {
            return DataHelper.GetNotEmpty(GetValue("PermissionsIconImageUrl"), GetImageUrl("CMSModules/CMS_DocumentLibrary/LibraryPermissions.png", IsLiveSite));
        }
        set
        {
            SetValue("PermissionsIconImageUrl", value);
            imgPermissions.ImageUrl = value;
        }
    }
    ...
    public string NewFileIconImageUrl
    {
        get
        {
            return DataHelper.GetNotEmpty(GetValue("NewFileIconImageUrl"), GetImageUrl("CMSModules/CMS_DocumentLibrary/NewDocument.png", IsLiveSite));
        }
        set
        {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                lblPermissions.Style.Add(HtmlTextWriterStyle.Visibility, "hidden");
            }
            lnkPermissions.Enabled = hasModifyPermission;
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        else
        {
            ...
            btnPropertiesSaveClose.Visible = propertiesElem.Visible && propertiesElem.AllowSave;
