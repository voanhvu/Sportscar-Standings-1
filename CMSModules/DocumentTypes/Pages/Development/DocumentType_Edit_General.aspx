...
<%@ Register Src="~/CMSModules/PortalEngine/Controls/PageTemplates/SelectPageTemplate.ascx"
    TagName="SelectTemplateCategory" TagPrefix="cms" %>
...
<asp:Content ID="cntBody" runat="server" ContentPlaceHolderID="plcContent">
    <div class="cms_documenttype">
        <cms:CMSPanel runat="server" ID="pnlGeneral" CssClass="EditingFormFieldSet" GroupingTextResourceString="General.General">
            <table>
                <tr>
                    <td class="FieldLabel">
                    ...
                    <td>
                        <cms:LocalizableTextBox runat="server" ID="tbDisplayName" CssClass="TextBoxField"
                            ...
                            <tr>
                                <td colspan="3">
                                    <cms:CMSRequiredFieldValidator ID="RequiredFieldValidatorCodeName" runat="server"
                                        EnableViewState="false" ControlToValidate="tbCodeName" Display="dynamic" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3">
                        ...
                        <cms:CMSUpdatePanel runat="server" ID="pnlIcons" UpdateMode="Conditional">
                            <ContentTemplate>
                                <table>
                                    <tr>
                                        <td>
                                            <asp:Image runat="server" ID="imgSmall" EnableViewState="false" CssClass="Image16" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:Image runat="server" ID="imgLarge" EnableViewState="false" CssClass="Image48" />
                                        </td>
                                        <td>
        ...
        <cms:CMSUpdatePanel runat="server" ID="pnlTemplates">
            <ContentTemplate>
                <cms:CMSPanel runat="server" ID="pnlNew" CssClass="EditingFormFieldSet" GroupingTextResourceString="DocumentType.NewSettings">
                    <table>
                        <tr>
                            <td class="FieldLabel">
                        ...
                        <asp:PlaceHolder runat="server" ID="plcRootTemplate">
                            <tr>
                                <td class="FieldLabel">
                                    <asp:Label runat="server" ID="lblRootTemplate" EnableViewState="false" />
                                </td>
                                <td>
                                    <cms:SelectTemplateCategory ID="categorySelector" runat="server" ShowAdHocCategory="false"
                                        EnableCategorySelection="true" ShowTemplates="false" ShowRoot="true" RootValue="0" AutoPostBack="true" />
                                </td>
                            </tr>
                        </asp:PlaceHolder>
                        <asp:PlaceHolder runat="server" ID="plcDefaultTemplate">
                            <tr>
                                <td class="FieldLabel">
        ...
        <cms:CMSPanel runat="server" ID="pnlPages" CssClass="EditingFormFieldSet" GroupingTextResourceString="DocumentType.EditingSettings">
            <table>
                <tr>
                    <td class="FieldLabel">
        ...
        <cms:CMSPanel runat="server" ID="pnlAdvanced" CssClass="EditingFormFieldSet" GroupingTextResourceString="DocumentType.Advanced">
            <table>
                <tr>
                    <td class="FieldLabel">
