...
<frameset border="0" rows="<%=mHeight%>, *" id="rowsFrameset">
    <frame name="t_edit_menu" src="DocumentType_Edit_Transformation_Header.aspx?<%=QueryHelper.EncodedQueryString%>"
        scrolling="no" frameborder="0" noresize="noresize" />
    <frame name="t_edit_content" src="DocumentType_Edit_Transformation_Edit.aspx?<%=QueryHelper.EncodedQueryString%>"
        frameborder="0" />
