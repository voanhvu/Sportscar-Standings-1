    ...
    protected void uniGrid_OnAction(string actionName, object actionArgument)
    {
        ...
        else if (actionName == "delete")
        {
            ...
            if (dci != null)
            {
                ...
                {
                    ShowError(String.Format(GetString("DocumentType_List.Dependences"), dci.ClassName));
                }
                else
                {
                    ...
                    try
                    {
                        ...
                        // Delete icons
                        string iconFile = UIHelper.GetDocumentTypeIconPath(this, className, "", false, true);
                        string iconLargeFile = UIHelper.GetDocumentTypeIconPath(this, className, "48x48", false, true);
