...
<frameset border="0" rows="<%=mHeight%>, *" id="rowsFrameset">
    <frame name="hierarchicalheader" scrolling="no" noresize="noresize" frameborder="0"
         id="frameHeader" src="HierarchicalTransformations_Header.aspx?<%=QueryHelper.EncodedQueryString%>" />
    <frame name="content" frameborder="0" noresize="noresize" src="HierarchicalTransformations_Transformations.aspx?<%=QueryHelper.EncodedQueryString%>"
        id="content" />
