...
<asp:Content ContentPlaceHolderID="plcFooter" runat="server">
    <div class="FloatRight">
        <%-- Donate --%>
        <cms:LocalizedButton ID="btnDonate" runat="server" CssClass="SubmitButton" ResourceString="com.donatedialog.donate"
            EnableViewState="false" />
        <%-- Cancel --%>
        <cms:LocalizedButton ID="btnCancel" runat="server" ResourceString="general.cancel"
            CssClass="SubmitButton" OnClientClick="return CloseDialog();" EnableViewState="false" />
    </div>
</asp:Content>
