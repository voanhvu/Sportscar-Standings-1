...
[Title(ImageUrl = "Objects/Ecommerce_SKU/donation.png", ResourceString = "com.donatedialog.title")]
public partial class CMSModules_Ecommerce_CMSPages_Donate : CMSLiveModalPage
{
    ...
    private string dialogIdentifier = null;
    private Hashtable dialogParameters = null;
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        lblError.Visible = !String.IsNullOrEmpty(lblError.Text) && !donationPropertiesElem.ShowDonationAmount;
    }
