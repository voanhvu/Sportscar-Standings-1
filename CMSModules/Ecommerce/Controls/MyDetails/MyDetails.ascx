...
<asp:Panel ID="pnlMyDetails" runat="server" DefaultButton="btnOK">
    ...
    <table style="vertical-align: top">
        ...
        <asp:PlaceHolder runat="server" ID="plcCompanyInfo" Visible="false" EnableViewState="false">
            <tr>
                <td class="FieldLabel">
        ...
        <tr>
            ...
            <td>
                <cms:CurrencySelector ID="selectCurrency" runat="server" AddNoneRecord="true" IncludeSelected="false"
                    DisplayOnlyWithExchageRate="true" DisplayOnlyEnabled="true" />
            </td>
        </tr>
        <tr>
            <td class="FieldLabel">
        ...
        <tr>
            ...
            <td>
                <cms:PaymentSelector ID="drpPayment" runat="server" AddNoneRecord="true" IncludeSelected="false"
