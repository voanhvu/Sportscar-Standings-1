...
<table cellpadding="3">
    ...
    <tr>
        ...
        <td>
            <cms:CMSTextBox ID="txtCCV" runat="server" CssClass="TextBoxField" MaxLength="100"
                EnableViewState="false" /><asp:Label ID="lblMark2" runat="server" EnableViewState="false" />
    ...
    <tr>
        ...
        <td>
            ...
            <asp:Label ID="lblMark3" runat="server" EnableViewState="false" /><br />
