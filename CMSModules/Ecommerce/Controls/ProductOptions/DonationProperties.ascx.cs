...
public partial class CMSModules_Ecommerce_Controls_ProductOptions_DonationProperties : CMSUserControl
{
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        lblAmountError.Visible = !String.IsNullOrEmpty(lblAmountError.Text);
    }
    ...
    public void ReloadData()
    {
        ...
        if ((SKU != null) && (SKU.SKUProductType == SKUProductTypeEnum.Donation))
        {
            ...
            if (!DonationAmountInitialized)
            {
                // Set donation default amount in cart currency                
                amountPriceSelector.Price = ShoppingCart.ApplyExchangeRate(SKU.SKUPrice, SKU.IsGlobal);
    ...
    public string Validate()
    {
        ...
        if (String.IsNullOrEmpty(ErrorMessage))
        {
            ...
            lblAmountError.Text = ErrorMessage;
        }
