...
public partial class CMSModules_Ecommerce_Controls_UI_ProductOptions : CMSAdminControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (ProductID > 0)
        {
            ...
            {
                currentValues = TextHelper.Join(";", SystemDataHelper.GetStringValues(ds.Tables[0], "CategoryID"));
            }
        ...
        uniSelector.IconPath = GetObjectIconUrl("ecommerce.optioncategory", "object.png");
    }
