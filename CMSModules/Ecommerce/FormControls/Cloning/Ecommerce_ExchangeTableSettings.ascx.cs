...
public partial class CMSModules_Ecommerce_FormControls_Cloning_Ecommerce_ExchangeTableSettings : CloneSettingsControl
{
    ...
    private Hashtable GetProperties()
    {
        ...
        result[ECommerceObjectType.EXCHANGETABLE + ".validfrom"] = dtValidFrom.SelectedDateTime;
        result[ECommerceObjectType.EXCHANGETABLE + ".validto"] = dtValidTo.SelectedDateTime;
        return result;
    }
