...
public partial class CMSModules_Ecommerce_FormControls_SelectSKUBinding : FormEngineUserControl
{
    ...
    public bool AllowCreateNewGlobal
    {
        get
        {
            return ECommerceSettings.AllowGlobalProducts(CMSContext.CurrentSiteName) && mAllowCreateNewGlobal;
        }
        set
        {
    ...
    private void InitSkuSelector()
    {
        ...
        skuSelectorElem.SiteID = CMSContext.CurrentSiteID;
    ...
    public string GetValueFromRequest()
    {
        ...
        {
            string radioGoupKey = Request.Form.AllKeys.FirstOrDefault(k => (!string.IsNullOrEmpty(k)) && k.EndsWith("SelectSKUBindingRadioGroup"));
