                ...
                <td style="height: 32px">
                    ...
                    <div>
                        <cms:CMSRequiredFieldValidator ID="rfvMinCount" runat="server" ControlToValidate="txtVolumeDiscountMinCount"
                            Display="Dynamic" EnableViewState="false" /><cms:CMSRangeValidator ID="rvMinCount"
                                runat="server" ControlToValidate="txtVolumeDiscountMinCount" MinimumValue="1"
                                Type="Integer" Display="Dynamic" EnableViewState="false"></cms:CMSRangeValidator>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <cms:CMSTextBox ID="txtVolumeDiscountValue" runat="server" CssClass="TextBoxField"
                        MaxLength="9" />&nbsp;<asp:Label ID="lblCurrency" runat="server" />&nbsp;&nbsp;
                    <div>
...
<asp:Content ID="cntFooter" runat="server" ContentPlaceHolderID="plcFooter">
    <div class="FloatRight">
        <cms:CMSButton runat="server" ID="btnOk" OnClick="btnOK_Click" EnableViewState="false"
            CssClass="SubmitButton" /><cms:CMSButton runat="server" ID="btnCancel" OnClientClick="CloseDialog();"
