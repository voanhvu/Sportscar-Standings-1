<%@ Page Language="C#" AutoEventWireup="true" Inherits="CMSModules_Ecommerce_Pages_Tools_Configuration_Departments_Department_General"
    Theme="Default" MasterPageFile="~/CMSMasterPages/UI/SimplePage.master" CodeFile="Department_General.aspx.cs" %>
        ...
        <tr>
            ...
            <td>
                <cms:LocalizableTextBox ID="txtDepartmentDisplayName" runat="server" CssClass="TextBoxField"
                    EnableViewState="false" MaxLength="200" />
