...
[Security(Resource = "CMS.Ecommerce", UIElements = "Configuration.TaxClasses.States")]
        ...
        for (int i = 0; i < gvStates.Rows.Count; i++)
        {
            ...
            if (stateId > 0)
            {
                ...
                if ((mChangedTextBoxes[txtValue.ID] != null) || (mChangedCheckBoxes[chkIsFlat.ID] != null))
                {
                    ...
                    {
                        TaxClassStateInfoProvider.RemoveStateTaxValue(mTaxClassId, stateId);
                    ...
                    else
                    {
                        ...
                        {
                            stateInfo = TaxClassStateInfoProvider.GetTaxClassStateInfo(mTaxClassId, stateId);
