...
public partial class CMSModules_Ecommerce_Pages_Tools_Customers_Customer_Edit_Address_Edit : CMSCustomersPage
{
    ...
    private void InitializeMasterPage(string titleImage, string titleText, string currentAddress)
    {
        ...
        CurrentMaster.Title.HelpTopicName = "newedit_address";
    ...
    private void drpAddressType_SelectedIndexChanged(object sender, EventArgs e)
    {
    }
    ...
    private void InitData()
    {
        if (customerObj != null)
        {
            ...
            txtPersonalName.Text = TextHelper.LimitLength(txtPersonalName.Text, 200);
        }
    }
}