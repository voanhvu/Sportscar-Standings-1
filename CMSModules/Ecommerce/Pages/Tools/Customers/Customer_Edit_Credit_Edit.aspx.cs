...
[Security(Resource = "CMS.Ecommerce", UIElements = "Customers.Credit")]
public partial class CMSModules_Ecommerce_Pages_Tools_Customers_Customer_Edit_Credit_Edit : CMSCustomersPage
{
    ...
    private void InitializeMasterPage(string title, string eventImage, string currentCreditEvent)
    {
        ...
        CurrentMaster.Title.HelpTopicName = "newedit_credit_event";
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        if (errorMessage == "")
        {
            ...
            creditEventObj.EventCreditChange = txtEventCreditChange.Price;
    ...
    private string ValidateForm()
    {
        ...
        if (errorMessage == "")
        {
            errorMessage = txtEventCreditChange.Validate(true);
        }
