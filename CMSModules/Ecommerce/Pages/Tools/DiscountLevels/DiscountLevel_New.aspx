<%@ Page Language="C#" AutoEventWireup="true" Inherits="CMSModules_Ecommerce_Pages_Tools_DiscountLevels_DiscountLevel_New"
    Theme="Default" MasterPageFile="~/CMSMasterPages/UI/SimplePage.master" Title="Discount level - new"
    CodeFile="DiscountLevel_New.aspx.cs" %>
        ...
        <tr>
            ...
            <td>
                ...
                <cms:CMSRequiredFieldValidator ID="rfvDiscountLevelDisplayName" runat="server" ErrorMessage="RequiredFieldValidator"
                    ControlToValidate="txtDiscountLevelDisplayName:textbox" Display="Dynamic" EnableViewState="false"></cms:CMSRequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <cms:CodeName ID="txtDiscountLevelName" runat="server" CssClass="TextBoxField" MaxLength="100"
                    EnableViewState="false" />&nbsp;
                <cms:CMSRequiredFieldValidator ID="rfvDiscountLevelName" runat="server" ErrorMessage="RequiredFieldValidator"
                    ControlToValidate="txtDiscountLevelName" Display="Dynamic" EnableViewState="false"></cms:CMSRequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                <cms:CMSRequiredFieldValidator ID="rfvDiscountLevelValue" runat="server" ErrorMessage="RequiredFieldValidator"
                    ControlToValidate="txtDiscountLevelValue" Display="Dynamic" EnableViewState="false"></cms:CMSRequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
