...
public partial class CMSModules_Ecommerce_Pages_Tools_Orders_Order_Edit_Address : CMSOrdersModalPage
{
    ...
    {
        CurrentMaster.Title.TitleText = GetString("Order_Edit_Address.Title");
        ...
        if (addressId > 0)
        {
            ...
            CurrentMaster.Title.TitleImage = GetImageUrl("Objects/Ecommerce_Address/object.png");
        }
        ...
        else
        {
            ...
            CurrentMaster.Title.TitleImage = GetImageUrl("Objects/Ecommerce_Address/new.png");
        }
    }
