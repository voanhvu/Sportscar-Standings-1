...
<asp:Content ID="cntBody" runat="server" ContentPlaceHolderID="plcContent">
    <script type="text/javascript"> 
        ...
        function AddAddress(customerId) {
            if (customerId != 0) {
                modalDialog(addressEditUrl + '?typeId=1&customerId=' + customerId, 'addAddresss', 600, 450);
            }
        }

        function EditAddress(customerId, addressId) {
            if ((customerId != 0) && (addressId != 0)) {
                modalDialog(addressEditUrl + '?typeId=1&customerId=' + customerId + "&addressId=" + addressId, 'editAddresss', 600, 450);
            }
        }
