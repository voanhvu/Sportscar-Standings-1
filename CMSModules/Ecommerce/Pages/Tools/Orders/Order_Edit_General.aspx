...
<asp:Content ID="cntBody" runat="server" ContentPlaceHolderID="plcContent">
    ...
    <script type="text/javascript">
        ...
        function EditCustomer(customerid) {
            if (customerid != 0) {
                modalDialog(customerEditUrl + '?customerid=' + customerid, 'editcustomer', 742, 600);
            }
        }

        function AddAddress(customerId) {
            if (customerId != 0) {
                modalDialog(addressEditUrl + '?typeId=2&customerId=' + customerId, 'addAddresss', 600, 450);
            }
        }

        function EditAddress(customerId, addressId) {
            if ((customerId != 0) && (addressId != 0)) {
                modalDialog(addressEditUrl + '?typeId=2&customerId=' + customerId + "&addressId=" + addressId, 'editAddresss', 600, 450);
            }
        }
        //]]>
    </script>
