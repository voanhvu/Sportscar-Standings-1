...
<cms:UniGrid ID="gridElem" runat="server" ShortID="g" ObjectType="cms.email" IsLiveSite="false"
    ...
    <GridActions>
        <ug:Action ExternalSourceName="resend" Name="resend" Caption="$general.resend$" Icon="ResendEmail.png" />
        <ug:Action ExternalSourceName="delete" Name="delete" Caption="$General.Delete$" Icon="Delete.png" Confirmation="$general.confirmdelete$" />
