...
<asp:Content ID="cntBody" runat="server" ContentPlaceHolderID="plcContent">
    <div class="UniSelectorDialogGridArea">
        <cms:UniGrid ID="gridElem" runat="server" ShortID="g" ObjectType="cms.emailuser" Columns="UserID,LastSendResult,Status" OrderBy="UserID" IsLiveSite="false" ShowActionsMenu="true">
            ...
            <GridColumns>
                <ug:Column Source="UserID" ExternalSourceName="userid" Caption="$emailqueue.recipient$" Wrap="false" Width="100%" />
...
<asp:Content ID="cntFooter" ContentPlaceHolderID="plcFooter" runat="server">
    <div class="FloatRight">
        <cms:LocalizedButton ID="btnClose" runat="server" CssClass="SubmitButton" ResourceString="general.close"
            OnClientClick="CloseDialog();return false;" EnableViewState="false" />
    </div>
</asp:Content>
