...
<cms:UniGrid runat="server" ID="gridElem" OrderBy="EmailTemplateDisplayName" ObjectType="cms.emailtemplate"
    Columns="EmailTemplateID, EmailTemplateDisplayName, EmailTemplateSiteID, EmailTemplateType" ShortID="g"
    IsLiveSite="false">
    ...
    <GridColumns>
        <ug:Column Source="EmailTemplateDisplayName" Caption="$Unigrid.EmailTemplateList.Columns.EmailTemplateName$"
            ...
            <Filter Type="text" Width="188" />
        </ug:Column>
        <ug:Column Source="EmailTemplateType" ExternalSourceName="type" Caption="$Unigrid.EmailTemplateList.Columns.EmailTemplateType$"
            Wrap="false" Localize="true">
