...
public partial class CMSModules_EmailTemplates_Pages_List : CMSEmailTemplatesPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        CurrentMaster.Title.HelpTopicName = "e-mail_templates_list";
        CurrentMaster.Title.HelpName = "helpTopic";

        // Control initialization
        HeaderActions.AddAction(new HeaderAction()
        {
            Text = GetString("EmailTemplate_List.NewTemplateButton"),
            ImageUrl = GetImageUrl("Objects/CMS_EmailTemplate/add.png"),
