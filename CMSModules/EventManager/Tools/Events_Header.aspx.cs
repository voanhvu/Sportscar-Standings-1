...
public partial class CMSModules_EventManager_Tools_Events_Header : CMSEventManagerPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        CurrentMaster.Title.TitleText = GetString("Events_Edit.headercaption");
        CurrentMaster.Title.TitleImage = GetImageUrl("Objects/CMS_EventManager/object.png");

        CurrentMaster.Title.HelpTopicName = "attendees_tab";
    ...
    protected void InitMenu()
    {
        ...
        CurrentMaster.Tabs.UrlTarget = "eventsContent";
    }
}