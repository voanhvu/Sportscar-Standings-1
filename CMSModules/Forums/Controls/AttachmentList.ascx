...
<table class="AttachmentTable" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td colspan="3" class="AttachmentTableUpload">
            ...
            <cms:CMSButton ID="btnUpload" runat="server" CssClass="ContentButton" OnClick="btnUpload_OnClick" />
            <cms:CMSButton ID="btnBack" runat="server" CssClass="ContentButton" OnClick="btnBack_OnClick" />
        </td>
    </tr>
    <tr>
