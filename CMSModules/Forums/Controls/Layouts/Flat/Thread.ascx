                                                                    ...
                                                                    <td style="border: medium none; padding: 5px; width: 100%" class="Content">
                                                                        ...
                                                                        <div style="float: left;">
                                                                            <span class="PostUserName">
                                                                                ...
                                                                                <%#CMSContext.ConvertDateTime(ValidationHelper.GetDateTime(Eval("PostTime"), DateTimeHelper.ZERO_TIME), this)%>
                                                                            </span>
                                                                        </div>
                                                                        ...
                                                                        <div style="float: right;">
                                                                            ...
                                                                            <cms:AbuseReport ID="ucAbuse" runat="server" ReportObjectType="forums.forumpost"
                                                                                ...
                                                                                ReportTitle='<%#ResHelper.GetString("Forums_WebInterface_ForumPost.AbuseReport", SettingsKeyProvider.GetStringValue(CMSContext.CurrentSiteName + ".CMSDefaultCultureCode")) + Eval("PostText")%>'
                                                                                CssClass="ActionLink" />
                                                                        </div>
                                                                        <div style="clear: both;">
                                                                        </div>
