...
public partial class CMSModules_Forums_Controls_LiveControls_Groups : CMSAdminItemsControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            groupList.OnAction += new CommandEventHandler(subscriptionList_OnAction);
            ...
            groupNew.OnSaved += new EventHandler(groupNew_OnSaved);
    ...
    protected void groupNew_OnSaved(object sender, EventArgs e)
    {
        ...
        if (fgi != null)
        {
            lblEditBack.Text = " <span class=\"TitleBreadCrumbSeparator\">&nbsp;</span> " + HTMLHelper.HTMLEncode(fgi.GroupDisplayName);
        }
    ...
    {
        lblNewBack.Text = " <span class=\"TitleBreadCrumbSeparator\">&nbsp;</span> " + GetString("Group_General.NewGroup");

        lnkEditBack.Text = GetString("Group_General.GroupList");
        lnkNewBack.Text = GetString("Group_General.GroupList");
