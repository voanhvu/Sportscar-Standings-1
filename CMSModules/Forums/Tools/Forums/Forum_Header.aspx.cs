...
public partial class CMSModules_Forums_Tools_Forums_Forum_Header : CMSForumsPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        InitalizeMasterPage(currentForum, groupId);
    ...
    protected void InitalizeMasterPage(string currentForum, int groupId)
    {
        ...
        Title = "Forums - Header";
        CurrentMaster.Title.HelpTopicName = "posts_tab";
    ...
    protected void InitalizeMenu()
    {
        ...
        CurrentMaster.Tabs.UrlTarget = "forumsContent";
