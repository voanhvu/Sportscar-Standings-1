...
<table>
    <asp:PlaceHolder runat="server" ID="plcAdvanceOptions">
        ...
        <asp:PlaceHolder runat="server" ID="plcCodeName">
            <tr>
                ...
                <td>
                    <!-- Do not disable view state - simple mode -->
                    <cms:CodeName ID="txtCodeName" runat="server" MaxLength="100" CssClass="TextBoxField" />
    ...
    <tr>
        ...
        <td>
            <cms:FormSubmitButton ID="btnSave" runat="server" CssClass="SubmitButton" EnableViewState="false"
