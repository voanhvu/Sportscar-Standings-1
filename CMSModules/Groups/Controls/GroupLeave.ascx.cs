...
public partial class CMSModules_Groups_Controls_GroupLeave : CMSAdminControl
{
    ...
    protected void btnLeave_Click(object sender, EventArgs e)
    {
        ...
        GroupMemberInfo gmi = GroupMemberInfoProvider.GetGroupMemberInfo(CMSContext.CurrentUser.UserID, Group.GroupID);
        if (gmi != null)
        {
    ...
    {
        Activity activity = new ActivityLeaveGroup(gmi, group, CMSContext.CurrentDocument, CMSContext.ActivityEnvironmentVariables);
        activity.Log();
    }
}