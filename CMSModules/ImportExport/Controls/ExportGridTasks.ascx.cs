...
public partial class CMSModules_ImportExport_Controls_ExportGridTasks : CMSUserControl, IUniPageable
{
    #region "Variables"
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        hdnAvailableTasks.Value = (sbAvailable != null) ? sbAvailable.ToString() : string.Empty;
    }
