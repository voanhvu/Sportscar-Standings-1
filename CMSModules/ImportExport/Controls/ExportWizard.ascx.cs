    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsCallback)
        {
            ...
            if (notTargetPermissions || notTempPermissions)
            {
                ...
                lblError.Text = string.Format(GetString("ExportSite.ErrorPermissions"), folder, WindowsIdentity.GetCurrent().Name);
...
var exErrorText = '';
var exWarningText = '';
var exMachineName = '" + SqlHelperClass.MachineName.ToLowerCSafe() + @"';
var getBusy = false;
