...
public partial class CMSModules_ImportExport_Controls_Import___objects__ : ImportExportControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!StopProcessing)
        {
            ...
            lblSettings.Text = GetString("ImportObjects.Settings");
            ...
            string script = "var im_g_parent = document.getElementById('" + chkCopyFiles.ClientID + "'); \n" +
                            "var im_g_childIDs = ['" + chkCopyGlobalFiles.ClientID + "', '" + chkCopySiteFiles.ClientID + "','" + chkCopyAssemblies.ClientID + "']; \n" +
                            "var im_g_childIDNames = ['gl', 'site','asbl']; \n" +
                            "InitCheckboxes(); \n";
