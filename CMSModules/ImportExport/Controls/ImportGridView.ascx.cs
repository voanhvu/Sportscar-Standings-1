...
public partial class CMSModules_ImportExport_Controls_ImportGridView : CMSUserControl, IUniPageable
{
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        if (sbAvailable != null)
        {
            hdnAvailableItems.Value = sbAvailable.ToString();
        }
        else
        {
            hdnAvailableItems.Value = "";
        }
    }
    ...
    protected string GetCheckBoxId(object codeName)
    {
        ...
        return preposition + ValidationHelper.GetIdentifier(codeName).ToLowerCSafe().Replace("'", "\'");
        ;
    }
    ...
    {
        // Load all selection
        Settings.LoadDefaultSelection(ObjectType, SiteObject, ImportTypeEnum.All, true, false);
    }
