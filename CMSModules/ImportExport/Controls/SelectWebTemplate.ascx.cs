...
public partial class CMSModules_ImportExport_Controls_SelectWebTemplate : CMSUserControl
{
    ...
    {
        // Load the data
        DataSet templates = WebTemplateInfoProvider.GetWebTemplates(null, "WebTemplateOrder", 0, "WebTemplateID, WebTemplateDisplayName, WebTemplateDescription, WebTemplateFileName, WebTemplateThumbnailGUID", true);
