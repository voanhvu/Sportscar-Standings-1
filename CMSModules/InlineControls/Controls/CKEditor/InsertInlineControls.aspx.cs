...
public partial class CMSModules_InlineControls_Controls_CKEditor_InsertInlineControls : CMSPage
{
    ...
    {
        lstControls.Items.Remove(new ListItem("Media", "Media"));
        lstControls.Items.Remove(new ListItem("Image control", "Image"));
        lstControls.Items.Remove(new ListItem("YouTube video", "YouTubeVideo"));
        lstControls.Items.Remove(new ListItem("Media file", "MediaFileControl"));
        lstControls.Items.Remove(new ListItem("Widget", "Widget"));
    }
