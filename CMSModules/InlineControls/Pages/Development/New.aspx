<%@ Page Language="C#" AutoEventWireup="true" Inherits="CMSModules_InlineControls_Pages_Development_New"
    Theme="Default" MasterPageFile="~/CMSMasterPages/UI/SimplePage.master" Title="Inline control - edit"
...
<asp:Content ID="cntBody" runat="server" ContentPlaceHolderID="plcContent">
    <table style="vertical-align: top">
        ...
        <tr>
            ...
            <td>
                <cms:CodeName ID="txtControlName" runat="server" CssClass="TextBoxField" MaxLength="200" /><br />
        ...
        <tr>
            ...
            <td>
                <cms:LocalizableTextBox ID="txtControlDescription" runat="server" TextMode="MultiLine"
