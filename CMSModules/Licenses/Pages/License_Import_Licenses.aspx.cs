...
public partial class CMSModules_Licenses_Pages_License_Import_Licenses : SiteManagerPage, ICallbackEventHandler
{
    ...
    private AsyncWorker worker = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        wzdImport.NextButtonClick += new WizardNavigationEventHandler(wzdImport_NextButtonClick);
        wzdImport.FinishButtonClick += new WizardNavigationEventHandler(wzdImport_FinishButtonClick);
        ...
        if (!IsCallback)
        {
            ...
            CurrentMaster.Title.TitleText = GetString("license.import");
            CurrentMaster.Title.TitleImage = GetImageUrl("Objects/CMS_LicenseKey/import24.png");

            // Context help
            CurrentMaster.Title.HelpTopicName = "license_import";
            ...
            string script =
                ...
                + "var argument = cancel + ';' + imMessageText.length + ';' + imErrorText.length + ';' + imWarningText.length; return " + Page.ClientScript.GetCallbackEventReference(this, "argument", "SetStateMsg", "argument", true) + " }\n";
    ...
    /// <param name="sender">Sender</param>
    /// <param name="e">Arguments</param>
    private void wzdImport_NextButtonClick(object sender, WizardNavigationEventArgs e)
    {
    ...
    /// <param name="sender">Sender</param>
    /// <param name="e">Arguments</param>
    private void wzdImport_FinishButtonClick(object sender, WizardNavigationEventArgs e)
    {
    ...
    private void LoadFiles()
    {
        if (lstImports.Items.Count == 0)
        {
            ...
            if (Directory.Exists(path))
            {
                ...
                {
                    files.Add(filesInDir[i].Substring(filesInDir[i].LastIndexOfCSafe("\\") + 1));
                }
            }
