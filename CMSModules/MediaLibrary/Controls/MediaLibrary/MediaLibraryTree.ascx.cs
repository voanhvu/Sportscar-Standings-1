    ...
    public string ImageFolderPath
    {
        get
        {
            if (mImageFolderPath == null)
            {
                ...
                if (isRTL)
                {
                    mImageFolderPath = GetImageUrl("RTL/Design/Controls/Tree", IsLiveSite, false);
                }
                else
                {
                    mImageFolderPath = GetImageUrl("Design/Controls/Tree", IsLiveSite, false);
                }
            }
...
function GetCurrentFolderID() {
    if (currentFolderId != 0) {
        ...
        return $j('#", hdnPath.ClientID, @"').attr('value');
    }
}
