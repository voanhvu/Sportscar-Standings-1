...
public partial class CMSModules_Membership_FormControls_Membership_SelectMembership : FormEngineUserControl
{
    ...
    public int MembershipID
    {
        get
        {
            ...
            if (UseGUIDForSelection)
            {
                ...
                MembershipInfo mi = MembershipInfoProvider.GetMembershipInfo(guid, SiteID);
            ...
            else if (UseCodeNameForSelection)
            {
                ...
                MembershipInfo mi = MembershipInfoProvider.GetMembershipInfo(name, SiteInfoProvider.GetSiteName(SiteID));
    ...
    public Guid MembershipGUID
    {
        ...
        set
        {
            ...
            {
                MembershipInfo mi = MembershipInfoProvider.GetMembershipInfo(value, SiteID);
    ...
    public string MembershipName
    {
        ...
        set
        {
            ...
            if (UseGUIDForSelection)
            {
                MembershipInfo mi = MembershipInfoProvider.GetMembershipInfo(value, SiteInfoProvider.GetSiteName(SiteID));
    ...
    protected void InitSelector()
    {
        ...
        {
            // Add site items
            where = SqlHelperClass.AddWhereCondition(where, String.Format("(MembershipSiteID = {0})", SiteID));
        }
        else
        {
            // Add global items
        ...
        if (MembershipID > 0)
        {
            where = SqlHelperClass.AddWhereCondition(where, String.Format("(MembershipID = {0})", MembershipID), "OR");
        }
