...
public partial class CMSModules_Membership_Pages_Users_General_User_Reject : CMSUsersPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        CurrentMaster.Title.TitleText = GetString("administration.users.rejectusers");
        CurrentMaster.Title.TitleImage = GetImageUrl("Objects/CMS_User/reject.png");
        CurrentMaster.Title.HelpTopicName = "User_Reject";
