...
public partial class CMSModules_Membership_Pages_Users_User_Edit : CMSUsersPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        // If this is not a separate window, show title and breadcrumbs
        if (!QueryHelper.GetBoolean("popup", false))
        {
            ...
            breadcrumbs[0, 0] = users;
            breadcrumbs[0, 1] = "~/CMSModules/Membership/Pages/Users/User_List.aspx?siteid=" + SiteID;
            breadcrumbs[0, 2] = "_parent";
            breadcrumbs[1, 0] = currentUser;
            breadcrumbs[1, 1] = "";
            breadcrumbs[1, 2] = "";
    ...
    protected void InitalizeMenu()
    {
        ...
        if (ui != null)
        {
            ...
            customFieldsTab = (formInfo.GetFormElements(true, false, true).Any() ? 1 : 0);
