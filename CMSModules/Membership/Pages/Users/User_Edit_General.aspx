...
<asp:Content ID="cntBody" runat="server" ContentPlaceHolderID="plcContent">
    <asp:PlaceHolder ID="plcTable" runat="server">
        <table>
            ...
            <tr>
                <td class="FieldLabel">
                    <cms:LocalizedLabel ID="lblInvalidLogonAttempts" runat="server" EnableViewState="false"
                        ResourceString="Administration-User_Edit_General.InvalidLogonAttempts" DisplayColon="true" />
                </td>
                <td class="FieldLabel">
                    <div class="TextFollowedByButton">
                        <asp:Label ID="lblInvalidLogonAttemptsNumber" runat="server" />
                    </div>
                    <cms:LocalizedButton ID="btnResetLogonAttempts" runat="server" OnClick="btnResetLogonAttempts_Click"
                        CssClass="LongButton" EnableViewState="false" ResourceString="invalidlogonattempts.unlockaccount.reset" />
                </td>
            </tr>
            <tr>
                <td class="FieldLabel">
                    <cms:LocalizedLabel ID="lblPassExpiration" runat="server" DisplayColon="true" />
                </td>
                <td class="FieldLabel">
                    <div class="TextFollowedByButton">
                        <asp:Label ID="lblExpireIn" runat="server" />
                    </div>
                    <cms:LocalizedButton ID="btnExtendValidity" runat="server" OnClick="btnExtendValidity_Click"
                        CssClass="LongButton" EnableViewState="false" ResourceString="passwordexpiration.extendvalidity" />
                </td>
            </tr>
            <tr>
                <td colspan="2">
