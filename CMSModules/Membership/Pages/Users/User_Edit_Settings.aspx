...
<asp:Content ID="cntBody" runat="server" ContentPlaceHolderID="plcContent">
    <asp:PlaceHolder ID="plcTable" runat="server">
        <table>
            ...
            <tr>
                <td>
                    <cms:LocalizedLabel ID="lblUserShowWebPartToolbar" runat="server" EnableViewState="false"
                        ResourceString="adm.user.lblusershowwebparttoolbar" DisplayColon="true" />
                </td>
                <td>
                    <asp:CheckBox ID="chkUserShowWebPartToolbar" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
                    <cms:LocalizedLabel ID="lblUserWebPartToolbarPosition" runat="server" EnableViewState="false"
                        ResourceString="adm.user.lbluserwebparttoolbarposition" DisplayColon="true" />
                </td>
                <td>
                    <asp:DropDownList ID="drpUserWebPartToolbarPosition" runat="server" ></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td colspan="2">
            ...
            <tr>
                ...
                <td>
                    <cms:FormSubmitButton ID="btnOk" runat="server" OnClick="ButtonOK_Click" CssClass="SubmitButton"
