...
public partial class CMSModules_Membership_Pages_Users_User_List : CMSUsersPage
{
    ...
    protected CurrentUserInfo CurrentUserObj
    {
        get
        {
            return currentUser ?? (currentUser = CMSContext.CurrentUser);
        }
    }
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        filter.DisplayUserEnabled = true;
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ScriptHelper.RegisterClientScriptBlock(this, typeof(string), "ManageRoles", ScriptHelper.GetScript(
            ...
            "    modalDialog('" + URLHelper.ResolveUrl("User_ManageRoles.aspx") + "?userId=' + userId, 'ManageUserRoles', 650, 400);" +
            "}"));
        ...
        // Place messages over alphabet menu instead of moving it
        ...
        else if (actionName == "delete")
        {
            ...
            try
            {
                ...
                if (delUser != null)
                {
                    ...
                    {
                        ShowError(GetString("Administration-User_List.ErrorNoGlobalAdmin"));
                        return;
                    }
                    ...
                    {
                        ShowError(GetString("Administration-User_List.ErrorOwnAccount"));
                        return;
                    }
