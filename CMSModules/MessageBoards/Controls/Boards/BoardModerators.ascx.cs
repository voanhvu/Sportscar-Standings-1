...
public partial class CMSModules_MessageBoards_Controls_Boards_BoardModerators : CMSAdminEditControl
{
    ...
    private void SetupControls()
    {
        ...
        lblModerators.Text = GetString("board.moderators.title") + ResHelper.Colon;
        chkBoardModerated.Text = GetString("board.moderators.ismoderated");
    ...
    public override void ReloadData(bool forceReload)
    {
        ...
        if (Board != null)
        {
            ...
            if (forceReload)
            {
                ...
                {
                    string where = SqlHelperClass.AddWhereCondition(userSelector.CurrentSelector.WhereCondition, "UserID IN (" + currentValues.Replace(';', ',') + ")", "OR");
