...
<cms:LocalizedCheckBox runat="server" ID="chkUseCaptcha" ResourceString="board.security.usecaptcha" />
<br />
<br />
...
<table>
    ...
    <tr>
        <td colspan="2">
            <cms:FormSubmitButton ID="btnOk" runat="server" Text="" CssClass="SubmitButton" OnClick="btnOk_Click"
