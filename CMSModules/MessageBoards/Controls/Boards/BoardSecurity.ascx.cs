...
public partial class CMSModules_MessageBoards_Controls_Boards_BoardSecurity : CMSAdminEditControl
{
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        if (!CMSContext.CurrentUser.IsAuthorizedPerResource("cms.messageboards", PERMISSION_MODIFY))
        {
    ...
    private void SetupControls()
    {
        ...
        lblTitleComments.Text = GetString("board.security.commentstitle");
        lblTitleGeneral.Text = GetString("general.general");
    ...
    private void ReloadRoles()
    {
        ...
        addRoles.CurrentSelector.Value = TextHelper.Join(";", SystemDataHelper.GetStringValues(roles.Tables[0], "RoleID"));
    }
