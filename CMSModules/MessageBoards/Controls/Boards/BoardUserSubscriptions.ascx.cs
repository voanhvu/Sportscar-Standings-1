...
public partial class CMSModules_MessageBoards_Controls_Boards_BoardUserSubscriptions : CMSAdminControl
{
    ...
    private void SetupControls()
    {
        if (UserID > 0)
        {
            ...
            boardSubscriptions.AllColumns = SqlHelperClass.MergeColumns(SqlHelperClass.MergeColumns(bsi.ColumnNames), "BoardID, BoardDisplayName, BoardSiteID, NodeAliasPath, DocumentCulture, SubscriptionApproved");
