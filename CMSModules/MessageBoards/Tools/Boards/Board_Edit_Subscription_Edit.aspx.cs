...
public partial class CMSModules_MessageBoards_Tools_Boards_Board_Edit_Subscription_Edit : CMSMessageBoardBoardsPage
{
    ...
    {
        URLHelper.Redirect("~/CMSModules/MessageBoards/Tools/Boards/Board_Edit_Subscription_Edit.aspx?subscriptionid=" + boardSubscription.SubscriptionID + "&boardid=" + mBoardId.ToString() + "&saved=1" + "&changemaster=" + changeMaster);
    }
    ...
    private void InitializeBreadcrumbs()
    {
        ...
        breadcrumbs[0, 1] = "~/CMSModules/MessageBoards/Tools/Boards/Board_Edit_Subscriptions.aspx?boardid=" + mBoardId.ToString() + "&changemaster=" + changeMaster;
