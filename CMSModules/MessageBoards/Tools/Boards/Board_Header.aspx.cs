...
public partial class CMSModules_MessageBoards_Tools_Boards_Board_Header : CMSMessageBoardBoardsPage
{
    ...
    private void InitializeBreadcrumb()
    {
        ...
        breadcrumbs[0, 1] = "~/CMSModules/MessageBoards/Tools/Boards/Board_List.aspx" + ((mGroupId > 0) ? "?groupid=" + mGroupId : "");
