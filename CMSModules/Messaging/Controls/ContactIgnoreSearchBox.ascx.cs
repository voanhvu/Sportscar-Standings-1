...
public partial class CMSModules_Messaging_Controls_ContactIgnoreSearchBox : CMSAbstractBaseFilterControl
{
    ...
    protected string GenerateWhereCondition()
    {
        ...
        {
            whereBuilder.Append("UserName LIKE '%" + SqlHelperClass.GetSafeQueryString(txtSearch.Text, false) + "%' OR ");
            whereBuilder.Append("UserNickName LIKE '%" + SqlHelperClass.GetSafeQueryString(txtSearch.Text, false) + "%'");
        }
