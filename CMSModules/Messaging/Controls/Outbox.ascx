<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSModules_Messaging_Controls_Outbox"
    CodeFile="Outbox.ascx.cs" %>
    ...
    <ContentTemplate>
        <div class="MessagingBox">
            ...
            <asp:Panel ID="pnlList" runat="server" CssClass="ListPanel">
                ...
                <br />
                <cms:UniGrid runat="server" ID="outboxGrid" ShortID="g" GridName="~/CMSModules/Messaging/Controls/Outbox.xml"
