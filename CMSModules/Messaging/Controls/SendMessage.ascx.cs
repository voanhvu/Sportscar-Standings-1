...
public partial class CMSModules_Messaging_Controls_SendMessage : CMSUserControl
{
    ...
    public override void ShowConfirmation(string text)
    {
        base.ShowConfirmation(text);
    ...
    {
        return ((body.Trim() != string.Empty) && (body.Trim().ToLowerCSafe() != CMSContext.CurrentUser.UserSignature.Trim().ToLowerCSafe()));
    }
