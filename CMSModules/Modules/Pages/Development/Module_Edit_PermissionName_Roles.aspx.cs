...
public partial class CMSModules_Modules_Pages_Development_Module_Edit_PermissionName_Roles : SiteManagerPage
{
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        if (Permission != null)
        {
            ...
            if (!gridMatrix.HasData)
            {
                ...
                lblInfo.Text = (chkUserOnly.Checked) ? GetString("general.norolemember") : GetString("general.emptymatrix");
            }
            else
            {
                ...
                {
                    lblInfo.Text = GetString("Administration-Permissions_Matrix.GlobalAdministrator");
                }
    ...
    private string GetBeforeRowsContent()
    {
        ...
        if ((SelectedUser != null) && (Permission != null) && (resource != null))
        {
            ...
            // Append tooltip and alternative text
