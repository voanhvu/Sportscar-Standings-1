<%@ Page Title="Module edit - User interface - Tree" Language="C#" MasterPageFile="~/CMSMasterPages/UI/EmptyPage.master"
    AutoEventWireup="true" Inherits="CMSModules_Modules_Pages_Development_Module_UI_Tree"
    Theme="Default" CodeFile="Module_UI_Tree.aspx.cs" %>

<%@ Register Src="~/CMSAdminControls/UI/UIProfiles/MenuActions.ascx" TagName="MenuActions"
    TagPrefix="cms" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="plcContent" runat="Server">
    ...
    <cms:treeborder id="borderElem" runat="server" framesetname="uiFrameset" />
