...
}}", IsDialogMode ? "divContent" : CMSPage.CurrentPage.CurrentMaster.Body.ClientID,
  IsDialogMode ? "null" : "document.getElementById('" + CMSPage.CurrentPage.CurrentMaster.PanelHeader.ClientID + "')");
