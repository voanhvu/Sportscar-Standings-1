...
public partial class CMSModules_Newsletters_Controls_SubscriptionStatusFilter : CMSAbstractBaseFilterControl
{
    ...
    {
        ddlStatusFilter.Items[1].Attributes.Add("Class", "StatusGreen");
        ddlStatusFilter.Items[2].Attributes.Add("Class", "StatusOrange");
        ddlStatusFilter.Items[3].Attributes.Add("Class", "StatusRed");
    }
