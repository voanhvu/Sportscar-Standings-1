...
public partial class CMSModules_Newsletters_Controls_TemplateFlatSelector : CMSAdminControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (NewsletterId > 0)
        {
            ...
            flatElem.WhereCondition = SqlHelperClass.AddWhereCondition(flatElem.WhereCondition,
        ...
        if (SiteId > 0)
        {
            ...
            flatElem.WhereCondition = SqlHelperClass.AddWhereCondition(flatElem.WhereCondition, "TemplateSiteID=" + CMSContext.CurrentSiteID);
        }
