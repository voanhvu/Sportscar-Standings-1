    ...
    private void SetupControl()
    {
        if (!ControlLoaded)
        {
            ...
            else
            {
                ...
                ucTitle.HelpName = "helpTopic";
                ucTitle.HelpIconUrl = UIHelper.GetImageUrl(Page, "General/HelpLargeDark.png");
                ...
                btnOKAdd.Click += new EventHandler(btnOKAdd_Click);
                btnOKProperties.Click += new EventHandler(btnOKProperties_Click);
                btnOKRemove.Click += new EventHandler(btnOKRemove_Click);

                radEmpty.Attributes.Add("onclick", String.Format("DisableList_{0}(true);", this.ClientID));
                radBasedOnTemplate.Attributes.Add("onclick", String.Format("DisableList_{0}(false);", this.ClientID));
