...
public partial class CMSModules_Newsletters_FormControls_VariantFilter : FormEngineUserControl, IFilterFormControl
{
    ...
    // Indicates if (all) option will be available
    ...
    protected void InitVariantSelector(int issueId)
    {
        if (drpVariants.Items.Count == 0)
        {
            ...
            List<IssueABVariantItem> variants = IssueHelper.GetIssueVariants(issueId, null);
