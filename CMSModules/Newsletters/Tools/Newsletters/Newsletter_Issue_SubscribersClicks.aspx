        ...
        <cms:UniGrid runat="server" ID="UniGrid" ShortID="g" OrderBy="Clicks DESC" IsLiveSite="false"
            ...
            <GridColumns>
                <ug:Column Source="##ALL##" Caption="$unigrid.subscribers.columns.subscribername$"
                    ExternalSourceName="name" Wrap="false" Width="100%" />
                <ug:Column Source="##ALL##" Caption="$general.email$" ExternalSourceName="email"
                    Wrap="false" />
...
<asp:Content ID="cntFooter" ContentPlaceHolderID="plcFooter" runat="server">
    <div class="FloatRight">
        <cms:LocalizedButton ID="btnClose" runat="server" CssClass="SubmitButton" OnClientClick="return CloseDialog();"
