        ...
        <ContentTemplate>            
            <cms:UniGrid ID="UniGrid" runat="server" OrderBy="FullName" IsLiveSite="false"
                ...
                <GridActions Parameters="UserID">
                    <ug:Action Name="block" ExternalSourceName="block" Caption="$general.block$" Icon="Block.png" Confirmation="$subscribers.blocksubscriber$" />
                    <ug:Action Name="unblock" ExternalSourceName="unblock" Caption="$general.unblock$" Icon="Unblock.png" Confirmation="$subscribers.unblocksubscriber$" />
                </GridActions>
                <GridColumns>
