...
<frameset border="0" rows="<%=TabsBreadHeadFrameHeight%>, *" id="rowsFrameset">
    <frame name="Menu" src="NewsletterTemplate_Header.aspx?<%=QueryHelper.EncodedQueryString%>"
        scrolling="no" frameborder="0" noresize="noresize" />
    <frame name="Content" src="NewsletterTemplate_Edit.aspx?<%=QueryHelper.EncodedQueryString%>"
