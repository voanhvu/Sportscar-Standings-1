...
<table width="100%">
    <asp:PlaceHolder runat="server" ID="plcSubject" EnableViewState="false">
        <tr>
            ...
            <td>
                <cms:CMSTextBox runat="server" ID="txtSubject" CssClass="TextBoxField" MaxLength="250"
                    EnableViewState="false" />
            </td>
        </tr>
    </asp:PlaceHolder>
    ...
    <asp:PlaceHolder runat="server" ID="plcPlainText" EnableViewState="false">
        <tr>
            ...
            <td>
                <cms:CMSTextBox runat="server" ID="txtPlainText" TextMode="MultiLine" CssClass="TextAreaLarge"
                    EnableViewState="false" />
            </td>
        </tr>
    </asp:PlaceHolder>
