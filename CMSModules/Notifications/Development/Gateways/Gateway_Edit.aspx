<%@ Page Language="C#" AutoEventWireup="true" Inherits="CMSModules_Notifications_Development_Gateways_Gateway_Edit"
    MasterPageFile="~/CMSMasterPages/UI/SimplePage.master" Theme="Default" Title="Gateway - edit"
    CodeFile="Gateway_Edit.aspx.cs" %>
...
<asp:Content ID="cntBody" runat="server" ContentPlaceHolderID="plcContent">
    <table>
        ...
        <tr>
            ...
            <td>
                <cms:LocalizableTextBox runat="server" ID="txtDescription" CssClass="TextAreaField"
        ...
        <tr>
            ...
            <td>
                <cms:CMSTextBox runat="server" ID="txtAssemblyName" CssClass="TextBoxField" MaxLength="200"
                    EnableViewState="false" />
                <cms:CMSRequiredFieldValidator runat="server" ControlToValidate="txtAssemblyName"
                    ID="valAssemblyName" EnableViewState="false" />
            </td>
        </tr>
        <tr>
            <td>
