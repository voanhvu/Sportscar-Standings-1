<%@ Page Language="C#" AutoEventWireup="true" Inherits="CMSModules_Notifications_Development_Templates_Template_List"
    Theme="Default" MasterPageFile="~/CMSMasterPages/UI/SimplePage.master" Title="Template list"
    CodeFile="Template_List.aspx.cs" %>
...
<asp:Content ID="cntBody" ContentPlaceHolderID="plcContent" runat="Server">
    <cms:CMSUpdatePanel runat="server" ID="pnlUpdate" UpdateMode="Conditional">
        <ContentTemplate>
            <cms:UniGrid ID="gridTemplates" runat="server" GridName="Template_List.xml" IsLiveSite="false"
                Columns="TemplateID, TemplateDisplayName" />
        </ContentTemplate>
    </cms:CMSUpdatePanel>
</asp:Content>
