        ...
        <tr>
            ...
            <td>
                <div class="TextRight">
                    ...
                    <cms:LocalizedButton ID="btnMakeMajor" runat="server" CssClass="XXLongButton" OnClick="btnMakeMajor_Click"
                ...
                <cms:UniGrid ID="gridHistory" runat="server" ObjectType="cms.objectversionhistorylist"
                    ...
                    <GridActions Parameters="VersionID">
                        ...
                        <ug:Action Name="contextmenu" ExternalSourceName="contextmenu" Caption="$General.OtherActions$"
                            Icon="menu.png" ContextMenu="~/CMSModules/Objects/Controls/Versioning/VersionListMenu.ascx"
                            MenuParameter="'{0}'" />
                    </GridActions>
                    <GridColumns>
