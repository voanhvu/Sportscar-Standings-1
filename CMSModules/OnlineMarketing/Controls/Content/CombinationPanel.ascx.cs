...
public partial class CMSModules_OnlineMarketing_Controls_Content_CombinationPanel : CMSAbstractPortalUserControl, ICallbackEventHandler
{
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        else
        {
            ...
            cookieTestName = CookieName.GetNoMVTCookieName(CMSContext.CurrentDocument.GetUsedPageTemplateId());
        }
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        loading.ProgressHTML = "<div class=\"MVTLoading\" style=\"display: none;\" id=\"" + loading.ClientID + "\">" + CMSUpdateProgress.GetDefaultContent(Page) + "</div>";
        ...
        {
            int templateId = CMSContext.CurrentDocument.GetUsedPageTemplateId();
    ...
    private void SetupControl()
    {
        ...
        if ((CMSContext.CurrentPageInfo != null) && (CMSContext.CurrentPageInfo.UsedPageTemplateInfo != null))
        {
            ...
            combinationSelector.PageTemplateID = CMSContext.CurrentPageInfo.UsedPageTemplateInfo.PageTemplateId;
        }
        ...
        ScriptHelper.RegisterClientScriptBlock(Page, typeof(string), "MVTCombinationPanel", ScriptHelper.GetScript(@"
