...
<table style="vertical-align: top">
    <tr>
        ...
        <td>
            <cms:LocalizableTextBox ID="txtABTestDisplayName" runat="server" CssClass="TextBoxField"
    ...
    <tr>
        ...
        <td>
            <cms:CodeName ID="txtABTestName" runat="server" CssClass="TextBoxField" MaxLength="50"
                EnableViewState="false" />
            <cms:CMSRequiredFieldValidator ID="rfvABTestName" runat="server" Display="Dynamic"
                ControlToValidate="txtABTestName" ValidationGroup="vgAbTest" EnableViewState="false" />
        </td>
    </tr>
    <tr>
        <td class="FieldLabel">
    ...
    <tr>
        ...
        <td>
            <cms:FormSubmitButton runat="server" ID="btnOk" EnableViewState="false" CssClass="SubmitButton"
                OnClick="btnOk_Click" ValidationGroup="vgAbTest" ResourceString="general.ok" />
        </td>
    </tr>
</table>
