...
public partial class CMSModules_OnlineMarketing_Dialogs_MVTVariantEdit : CMSVariantDialogPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        title.HelpTopicName = "mvtvariant_edit";
    ...
    protected void UIFormControl_OnBeforeSaved(object sender, EventArgs e)
    {
        if (editElem.ValidateData())
        {
            ...
            parameters.Add("displayname", ValidationHelper.GetString(((FormEngineUserControl)editElem.UIFormControl.FieldControls["MVTVariantDisplayName"]).Value, string.Empty));
            parameters.Add("codename", editElem.VariantCodeName);
            parameters.Add("description", ValidationHelper.GetString(((FormEngineUserControl)editElem.UIFormControl.FieldControls["MVTVariantDescription"]).Value, string.Empty));
            parameters.Add("enabled", ValidationHelper.GetBoolean(((FormEngineUserControl)editElem.UIFormControl.FieldControls["MVTVariantEnabled"]).Value, false));
