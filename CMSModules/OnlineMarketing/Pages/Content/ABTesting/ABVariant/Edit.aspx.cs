...
public partial class CMSModules_OnlineMarketing_Pages_Content_ABTesting_ABVariant_Edit : CMSABTestContentPage
{
    ...
    {
        URLHelper.Redirect("Edit.aspx?saved=1&abTestID=" + QueryHelper.GetInteger("abTestID", 0) + "&variantId=" + editElem.ItemID + "&nodeID=" + nodeID);
    }
