...
public partial class CMSModules_Polls_Tools_Polls_Header : CMSPollsPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        CurrentMaster.Title.TitleText = GetString("Polls_Edit.headercaption");
        CurrentMaster.Title.TitleImage = GetImageUrl("Objects/Polls_Poll/object.png");
        CurrentMaster.Title.Breadcrumbs = breadcrumbs;
        CurrentMaster.Title.HelpTopicName = "general_tab4";
    ...
    protected void InitalizeMenu(PollInfo pi)
    {
        ...
        CurrentMaster.Tabs.UrlTarget = "pollContent";
    }
}