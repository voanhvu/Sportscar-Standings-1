...
public partial class CMSModules_Polls_Tools_Polls_List : CMSPollsPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        PollsList.DeleteEnabled = CheckPollsModifyPermission(CMSContext.CurrentSiteID, false);
    ...
    private void PollsList_OnEdit(object sender, EventArgs e)
    {
        ...
        URLHelper.Redirect(ResolveUrl("Polls_Edit.aspx?pollId=" + PollsList.SelectedItemID + "&siteid=" + fltSite.SiteID));
    }
    ...
    private void InitMaster()
    {
        ...
        // Set the page title
        CurrentMaster.Title.TitleText = GetString("Polls_List.HeaderCaption");
        CurrentMaster.Title.TitleImage = GetImageUrl("Objects/Polls_Poll/object.png");
        CurrentMaster.Title.HelpName = "helpTopic";
        CurrentMaster.Title.HelpTopicName = "polls_list";
