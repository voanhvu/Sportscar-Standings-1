...
public partial class CMSModules_Polls_Tools_Polls_New : CMSPollsPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        // New item title
        CurrentMaster.Title.TitleText = GetString("Polls_New.HeaderCaption");
        CurrentMaster.Title.TitleImage = GetImageUrl("Objects/Polls_Poll/new.png");
        CurrentMaster.Title.HelpTopicName = "new_poll";
