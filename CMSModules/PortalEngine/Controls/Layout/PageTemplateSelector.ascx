    ...
    <tr>
            ...
            <div class="SelectorTree">
                <div class="TreeAreaTree">
                    <cms:PageTemplateTree EnableViewState="false" UsePostBack="false" ID="treeElem" ShortID="t"
                        runat="server" SelectPageTemplates="false" SelectFunctionName="PTS_SelectNode" OnOnItemSelected="treeElem_OnItemSelected" />
                </div>
            </div>
        </td>
        ...
        <td class="ItemSelectorArea">
            <div class="ItemSelector">
                <cms:PageTemplateFlatSelector ID="flatElem" ShortID="f" runat="server" />
            </div>
        </td>
    </tr>
</table>
