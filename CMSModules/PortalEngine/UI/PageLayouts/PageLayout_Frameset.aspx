...
<head id="Head1" runat="server" enableviewstate="false">
    ...
    <frameset border="0" rows="<%=headerHeight%>, *" id="rowsFrameset">
    <frame name="pl_edit_menu" src="PageLayout_Header.aspx?<%=QueryHelper.EncodedQueryString%>"
        scrolling="no" frameborder="0" noresize="noresize" />
    <frame name="pl_edit_content" src="PageLayout_Edit.aspx?<%=QueryHelper.EncodedQueryString%>"
        frameborder="0" />
