...
public partial class CMSModules_PortalEngine_UI_PageTemplates_PageTemplate_Category : SiteManagerPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        CurrentMaster.Title.TitleText = GetString("development-pagetemplate_category.title");
        CurrentMaster.Title.TitleImage = GetImageUrl("Objects/CMS_PageTemplateCategory/new.png");
        CurrentMaster.Title.HelpTopicName = "new_category";
        ...
        else
        {
            // New category
            CurrentMaster.Title.HelpName = "helpTopic";
            CurrentMaster.Title.HelpTopicName = "page_template_category_general";
            ...
            CurrentMaster.Title.TitleText = currentTemplateCategoryName;
            CurrentMaster.Title.TitleImage = GetImageUrl("Objects/CMS_PageTemplateCategory/new.png");
        }
