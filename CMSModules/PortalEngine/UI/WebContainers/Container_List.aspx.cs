...
public partial class CMSModules_PortalEngine_UI_WebContainers_Container_List : SiteManagerPage
{
    ...
    {
        // Set page title
        CurrentMaster.Title.TitleText = GetString("Container_List.HeaderCaption");
        CurrentMaster.Title.TitleImage = GetImageUrl("Objects/CMS_WebPartContainer/object.png");
        CurrentMaster.Title.HelpTopicName = "web_part_containers_list";
