    ...
    <asp:Panel ID="pnlContainer" runat="server">
        <table style="vertical-align: top;">
            ...
            <tr>
                ...
                <td>
                    <cms:CodeName ID="txtContainerName" runat="server" CssClass="TextBoxField" MaxLength="200" />
                    <cms:CMSRequiredFieldValidator ID="rfvCodeName" runat="server" ControlToValidate="txtContainerName" />
                </td>
            </tr>
            <tr>
                <td class="FieldLabel">
                    <cms:LocalizedLabel runat="server" ID="lblContainerText" ResourceString="Container_Edit.ContainerText"
                        DisplayColon="true" EnableViewState="false" />
                </td>
                <td>
