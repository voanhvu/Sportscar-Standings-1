...
<head runat="server" enableviewstate="false">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function CloneWebPart() {
            if ((selectedItemId > 0) && (selectedItemType == 'webpart')) {
                modalDialog(cloneURL + '&objectid=' + selectedItemId + '&reloadall=1', 'WebPartClone', 750, 400);
            }
        }
        ...
        <div class="TreeArea">
            ...
            <div class="TreeAreaTree">
                <cms:WebPartTree ID="treeElem" runat="server" UsePostBack="false" ShowRecentlyUsed="false"
                    SelectWebParts="true" ShortID="t" IsLiveSite="false" ShowWidgetOnlyWebparts="true" />
                <cms:WebPartTree ID="treeWireframes" runat="server" UsePostBack="false" ShowRecentlyUsed="false"
                    SelectWebParts="true" ShortID="tw" IsLiveSite="false" ShowWidgetOnlyWebparts="true" RootPath="Wireframes" />
            </div>
        </div>
    </asp:Panel>
