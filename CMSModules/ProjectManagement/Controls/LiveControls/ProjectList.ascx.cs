...
public partial class CMSModules_ProjectManagement_Controls_LiveControls_ProjectList : CMSAdminControl
{
        ...
        get
        {
            if (mProjectObj == null)
            {
                ...
                if (proj != null)
                {
                    ...
                    if (IsAuthorizedPerCreateProject() || ProjectInfoProvider.IsAuthorizedPerProject(ProjectID, ProjectManagementPermissionType.READ, CMSContext.CurrentUser))
                    {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            lblEditBack.Text = " <span class=\"TitleBreadCrumbSeparator\">&nbsp;</span>" + HTMLHelper.HTMLEncode(ResHelper.LocalizeString(ProjectObj.ProjectDisplayName));
