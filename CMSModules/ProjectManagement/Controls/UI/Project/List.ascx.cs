...
public partial class CMSModules_ProjectManagement_Controls_UI_Project_List : CMSAdminListControl, IPostBackEventHandler
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        gridElem.WhereCondition = SqlHelperClass.AddWhereCondition(gridElem.WhereCondition, "ProjectSiteID = " + CMSContext.CurrentSiteID);

        //Project list webpart condition - usually used in project list
        if (ProjectNodeID != 0)
        {
            gridElem.WhereCondition = SqlHelperClass.AddWhereCondition(gridElem.WhereCondition, "ProjectNodeID =" + ProjectNodeID);
        }
