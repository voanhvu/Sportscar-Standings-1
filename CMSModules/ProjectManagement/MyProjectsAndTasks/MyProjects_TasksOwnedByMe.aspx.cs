...
public partial class CMSModules_ProjectManagement_MyProjectsAndTasks_MyProjects_TasksOwnedByMe : CMSMyProjectsAndTasksPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        actions[0, 3] = ResolveUrl("~/CMSModules/ProjectManagement/MyProjectsAndTasks/MyProjects_TaskEdit.aspx");
