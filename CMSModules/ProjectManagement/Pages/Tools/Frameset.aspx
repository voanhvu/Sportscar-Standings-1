<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="CMSModules_ProjectManagement_Pages_Tools_Frameset" CodeFile="Frameset.aspx.cs" %>
...
<frameset border="0" rows="73, *" id="rowsFrameset">
    ...
    <frame name="content" src="Project/List.aspx<%=Request.Url.Query%>" frameborder="5" />    
    <noframes>
		<body>
		 <p id="p1">
