...
public partial class CMSModules_Reporting_Controls_UserSubscriptions : CMSAdminControl
{
    ...
    public int UserID
    {
        get
        {
            return ValidationHelper.GetInteger(GetValue("userid"), CMSContext.CurrentUser.UserID);
        }
        set
        {
    ...
    public int SiteID
    {
        get
        {
            return ValidationHelper.GetInteger(GetValue("siteid"), CMSContext.CurrentSiteID);
        }
        set
        {
