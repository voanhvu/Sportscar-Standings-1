...
public partial class CMSModules_Reporting_FormControls_ReportItemSelector : FormEngineUserControl
{
    ...
    private ReportItemType mReportItemType;
    private int mReportID;
    private bool mDisplay = true;
    private DataSet currentDataSet = null;
    private bool keepDataInWindowsHelper = false;
    private string firstItemText = String.Empty;
    private bool mShowItemSelector = true;
    ...
    private DataSet CurrentDataSet
    {
        get
        {
            ...
            if (DataHelper.DataSourceIsEmpty(ds))
            {
                ...
                {
                    currentDataSet = LoadFromXML(Convert.ToString(ViewState["ParametersXmlData"]), Convert.ToString(ViewState["ParametersXmlSchema"]));
                }
                ds = currentDataSet;
            }
            return ds;
