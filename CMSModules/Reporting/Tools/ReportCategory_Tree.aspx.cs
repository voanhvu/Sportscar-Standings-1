...
public partial class CMSModules_Reporting_Tools_ReportCategory_Tree : CMSReportingPage, IPostBackEventHandler
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        lnkCloneReport.Attributes.Add("onclick", "modalDialog('" + URLHelper.ResolveUrl("~/CMSModules/Objects/Dialogs/CloneObjectDialog.aspx?reloadall=1&objecttype=reporting.report&objectid=") + "' + selectedItemId, 'CloneReport', 750, 400)");
