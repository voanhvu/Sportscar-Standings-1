...
<asp:Content ContentPlaceHolderID="plcContent" ID="content" runat="server">
    ...
    <div class="WebpartProperties LightTabs">
        ...
        <div id="pnlWebPartForm_Properties" class="WebPartForm ReportGraph" runat="server">
                ...
                <div id="FormPanelHolder" class="ReportFormPanel" runat="server" style="overflow: hidden">
                    ...
                    <cms:CategoryPanel ID="DefaultPanel" runat="server" ResourceString="rep.default">
                        ...
                        <cms:CategoryPanelRow ID="DefaultCodeNameRow" runat="server" IsRequired="true" LabelTitle="general.codename">
                            <cms:CodeName runat="server" CssClass="TextBoxField" ID="txtDefaultCodeName" MaxLength="50"
                    ...
                    <cms:CategoryPanel runat="server" ID="ChartTypePanel" ResourceString="rep.charttype">
                        ...
                        <cms:CategoryPanelRow ID="BarStackedOrientationRow" runat="server" ItemGroup="StackedBar"
                            LabelTitle="rep.graph.orientation" ContextHelp="rep.graph.orientation.help" IsRequired="false">
