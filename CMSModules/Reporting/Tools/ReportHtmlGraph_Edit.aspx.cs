...
public partial class CMSModules_Reporting_Tools_ReportHtmlGraph_Edit : CMSReportingModalPage
{
    ...
    private void LoadData()
    {
        if (graphInfo != null)
        {
            ...
            ucSelectString.Value = graphInfo.GraphConnectionString;
        }
    }
    ...
    private bool Save(bool save)
    {
        ...
        if (errorMessage == String.Empty)
        {
            ...
            graphInfo.GraphConnectionString = ValidationHelper.GetString(ucSelectString.Value, String.Empty);
    ...
    protected void btnApply_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (newReport)
            {
                URLHelper.Redirect(ResolveUrl("~/CMSModules/Reporting/Tools/ReportHtmlGraph_Edit.aspx?reportId=" + graphInfo.GraphReportID + "&itemid=" + graphInfo.GraphID));
            }
        }
    }
