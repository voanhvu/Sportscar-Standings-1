...
public partial class CMSModules_Reporting_Tools_ReportTable_Edit : CMSReportingModalPage
{
    ...
    protected void LoadData()
    {
        if (tableInfo != null)
        {
            ...
            chkSubscription.Checked = ValidationHelper.GetBoolean(tableInfo.TableSettings["SubscriptionEnabled"], false);
            ucSelectString.Value = tableInfo.TableConnectionString;
        }
    }
    ...
    protected bool Save(bool save)
    {
        ...
        if ((errorMessage == ""))
        {
            ...
            tableInfo.TableSettings["SubscriptionEnabled"] = chkSubscription.Checked.ToString();
            tableInfo.TableConnectionString = ValidationHelper.GetString(ucSelectString.Value, String.Empty); ;
    ...
    protected void btnApply_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (newTable)
            {
                URLHelper.Redirect(ResolveUrl("~/CMSModules/Reporting/Tools/ReportTable_Edit.aspx?reportId=" + tableInfo.TableReportID + "&itemid=" + tableInfo.TableID));
            }
        }
    }
