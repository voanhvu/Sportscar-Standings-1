                ...
                <div style="height: 120px; width: 100%; overflow: auto;">
                    <table>
                        ...
                        <asp:PlaceHolder runat="server" ID="pnlConversions" Visible="false">
                            <tr>
                                <td>
                                    <cms:LocalizedLabel ID="lblConversions" runat="server" ResourceString="conversion.conversion.list"
                                        DisplayColon="true" />
                                </td>
                                <td>
...
<asp:Content ID="cntFooter" runat="server" ContentPlaceHolderID="plcFooter">
    <div class="FloatRight">
        ...
        <cms:LocalizedButton ID="btnCancel" runat="server" OnClientClick="return CloseDialog();"
