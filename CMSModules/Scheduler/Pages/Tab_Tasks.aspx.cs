...
public partial class CMSModules_Scheduler_Pages_Tab_Tasks : CMSScheduledTasksPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        HeaderActions.AddAction(new HeaderAction()
        {
            ...
            ImageUrl = GetImageUrl("Objects/CMS_ScheduledTask/add.png"),
            RedirectUrl = "Task_Edit.aspx?" + GetSiteOrSelectedSiteQuery()
        });
        ...
        HeaderActions.AddAction(new HeaderAction()
        {
            ...
            RedirectUrl = "Tab_Tasks.aspx?" + GetSiteOrSelectedSiteQuery()
        });
        ...
        rightHeaderActions.AddAction(new HeaderAction()
        {
            ...
            ImageUrl = GetImageUrl("Objects/CMS_ScheduledTask/reset.png"),
            OnClientClick = "if (!confirm('" + GetString("tasks.resetall") + "')) return false;",
        ...
        if (QueryHelper.GetBoolean("reseted", false))
        {
