...
<cms:CMSUpdatePanel ID="pnlUpdate" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <br />
        <cms:UniGrid runat="server" ID="gridElem" ObjectType="om.scorecontactlist" Columns="ContactID, SUM(Value) AS Score"
            OrderBy="SUM(Value) DESC" ShowObjectMenu="false">
            <GridActions>
                ...
                <ug:Action Name="view" ExternalSourceName="view" Caption="$om.score.viewdetail$" Icon="view.png"
