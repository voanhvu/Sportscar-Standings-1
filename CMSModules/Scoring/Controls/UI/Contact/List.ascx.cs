    ...
    protected void btnOk_Click(object sender, EventArgs e)
    {
        ...
        switch (what)
        {
            ...
            case What.All:
                ...
                DataSet contacts = gridElem.InfoObject.GetData(gridElem.QueryParameters, gridElem.CompleteWhereCondition, null, -1, "ContactID", false);
        ...
        {
            where = SqlHelperClass.GetWhereCondition<int>("ContactID", contactIds, false);
        }
        else
        {
            where = "0=1";
