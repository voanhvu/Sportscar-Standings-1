        ...
        <td style="vertical-align: top; width: 100%;">
            <cms:UIForm runat="server" ID="EditForm" ObjectType="om.score" IsLiveSite="false"
                ...
                <LayoutTemplate>
                    ...
                    <cms:FormField runat="server" ID="fName" Field="ScoreName" FormControl="CodeName"
                    ...
                    <asp:PlaceHolder runat="server" ID="plcUpdate">
                        ...
                        <tr>
                            <td class="FieldLabel" style="vertical-align: top;">
                                <cms:LocalizedLabel runat="server" ID="lblScheduler" EnableViewState="false" ResourceString="om.score.schedule"
                                    DisplayColon="true" AssociatedControlID="chkSchedule" CssClass="EditingFormLabel" />
                            </td>
                            <td>
