            ...
            foreach (DataRow dr in columns.Tables[0].Rows)
            {
                if ((i > 0) || !keys)
                {
                    ...
                    if ((dataType == "nchar") || (dataType == SqlHelperClass.DATATYPE_TEXT) || (dataType == SqlHelperClass.DATATYPE_LONGTEXT))
                    {
                        ...
                        if ((indexOfKeyDefaultValue < 0) && (dr["COLUMN_NAME"].ToString().ToLowerCSafe() == "keydefaultvalue"))
                        {
                            indexOfKeyDefaultValue = i;
                        }

                        //Get index of key value
                        if ((indexOfKeyValue < 0) && (dr["COLUMN_NAME"].ToString().ToLowerCSafe() == "keyvalue"))
                        {
                            indexOfKeyValue = i;
                        }
                    ...
                    else if (dataType == SqlHelperClass.DATATYPE_DATETIME)
                    {
                        ...
                        if (dr["COLUMN_NAME"].ToString().ToLowerCSafe().IndexOfCSafe("lastmodified") != -1)
                        {
