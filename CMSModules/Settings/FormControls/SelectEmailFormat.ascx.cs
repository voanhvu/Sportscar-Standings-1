...
public partial class CMSModules_Settings_FormControls_SelectEmailFormat : FormEngineUserControl
{
    ...
    private void ReloadData()
    {
        ...
        {
            drpSelectFormat.Items.Add(new ListItem(GetString("general.plaintext"), "plaintext"));
            drpSelectFormat.Items.Add(new ListItem(GetString("general.html"), "html"));
            drpSelectFormat.Items.Add(new ListItem(GetString("settings.both"), "both"));
        }
