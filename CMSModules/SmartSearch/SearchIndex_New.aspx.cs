...
public partial class CMSModules_SmartSearch_SearchIndex_New : SiteManagerPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        // New item title
        CurrentMaster.Title.TitleText = GetString("srch.index.newtitle");
        CurrentMaster.Title.TitleImage = GetImageUrl("Objects/CMS_SearchIndex/new.png");
        CurrentMaster.Title.HelpTopicName = "new_index";
    ...
    /// </summary>
    private void IndexNew_OnSaved(object sender, EventArgs e)
    {
