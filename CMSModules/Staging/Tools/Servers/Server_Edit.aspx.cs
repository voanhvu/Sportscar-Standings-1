...
public partial class CMSModules_Staging_Tools_Servers_Server_Edit : CMSStagingServersPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ScriptHelper.RegisterStartupScript(this, typeof(string), "setHelpTopic", ScriptHelper.GetScript("parent.frames['stagingHeader'].SetHelpTopic('helpTopic', 'configuring_server');"));
