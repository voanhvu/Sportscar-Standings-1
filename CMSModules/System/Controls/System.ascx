                    ...
                    <table>
                        <asp:PlaceHolder ID="plcSeparatedHeader" runat="server" EnableViewState="false">
                            <tr>
                                <td style="white-space: nowrap; width: 110px;">
                                    <cms:LocalizedLabel ID="lblDatabase" runat="server" ResourceString="separationDB.databasepurpose" DisplayColon="true"
                                            EnableViewState="false" />
                                </td>
                                <td style="white-space: nowrap; width: 110px;">
                                    <strong>
                                        <cms:LocalizedLabel ID="lblMainDB" runat="server" ResourceString="separationDB.mainDB"
                                            EnableViewState="false" />
                                    </strong>
                                </td>
                                <td>&nbsp;</td>
                                <td>
                                    <strong>
                                        <cms:LocalizedLabel ID="lblSeparatedDB" runat="server" ResourceString="separationDB.separatedDB"
                                            EnableViewState="false" />
                                    </strong>
                                </td>
                            </tr>
                        ...
                        <tr>
                            ...
                            <asp:PlaceHolder ID="plcSeparatedServerName" runat="server" EnableViewState="false">
                                <td>&nbsp;</td>
                                <td>
                                    <asp:Label ID="lblSeparatedServerName" runat="server" />
                                </td>
                            </asp:PlaceHolder>
                        </tr>
                        <tr>
                            ...
                            <asp:PlaceHolder ID="plcSeparatedVersion" runat="server">
                                <td>&nbsp;</td>
                                <td>
                                    <asp:Label ID="lblSeparatedVersion" runat="server" />
                                </td>
                            </asp:PlaceHolder>
                        </tr>
                        <tr>
                            ...
                            <asp:PlaceHolder ID="plcSeparatedSpace" runat="server" EnableViewState="false">
                                <td colspan="2">&nbsp;</td>
                            </asp:PlaceHolder>
                        </tr>
                        <tr>
                            ...
                            <asp:PlaceHolder ID="plcSeparatedName" runat="server">
                                <td>&nbsp;</td>
                                <td>
                                    <asp:Label ID="lblSeparatedName" runat="server" />
                                </td>
                            </asp:PlaceHolder>
                        </tr>
                        <tr>
                            ...
                            <asp:PlaceHolder ID="plcSeparatedSize" runat="server">
                                <td>&nbsp;</td>
                                <td>
                                    <asp:Label ID="lblSeparatedSize" runat="server" />
                                </td>
                            </asp:PlaceHolder>
                        </tr>
                    </table>
