            ...
            case "name":
                {
                    ...
                    return "<img class=\"Image16\" src=\"" + UIHelper.GetFileIconUrl(Page, extension, null) + "\" alt=\"" + name + "\" />&nbsp;<a href=\"" + url + "\" target=\"_blank\">" + tooltipSpan + "</a>";
                }
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        if (!String.IsNullOrEmpty(drpAction.SelectedValue))
        {
            ...
            if ((items != null) && (items.Count > 0))
            {
                ...
                titleElemAsync.TitleText = drpAction.SelectedItem.Text;
