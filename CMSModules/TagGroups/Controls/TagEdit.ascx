<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSModules_TagGroups_Controls_TagEdit"
    CodeFile="TagEdit.ascx.cs" %>
...
<table>
    ...
    <tr>
        ...
        <td>
            <cms:CodeName ID="txtCodeName" runat="server" MaxLength="250" CssClass="TextBoxField"
                EnableViewState="false" />
