...
public partial class CMSModules_UICultures_Pages_Development_UICulture_New : SiteManagerPage
{
    ...
    private void InitializeMasterPage()
    {
        ...
        // Set help icon
        CurrentMaster.Title.HelpTopicName = "new_culturegeneral_tab";
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            CultureInfo obj = new CultureInfo(txtUICultureCode.Text);
            if (obj != null)
            {
        ...
        if (String.IsNullOrEmpty(result))
        {
            try
            {
                ...
                ShowError(GetString("UICulture.UICultureAlreadyExist"));
            }
            catch
            {
