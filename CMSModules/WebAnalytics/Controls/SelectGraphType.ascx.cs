...
public partial class CMSModules_WebAnalytics_Controls_SelectGraphType : CMSAdminControl, IPostBackEventHandler
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (UseImages)
        {
            ...
            // Set tooltip for period selector
            ...
            // Set alternate text for period selector
    ...
    public void HighlightSelectedType()
    {
        ...
        // Add CSS class for selected item
    ...
    {
        // Select item according to event argument
