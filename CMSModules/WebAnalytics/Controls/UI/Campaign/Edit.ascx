        ...
        <asp:Panel runat="server" ID="pnlBasic" CssClass="CampaignPanel">
            <table>
                <cms:FormField runat="server" ID="fDisplay" Field="CampaignDisplayName">
                    <tr>
                        <td>
                            <cms:FormLabel ID="lblDisplayName" runat="server" EnableViewState="false" ResourceString="campaign.displayname"
                                DisplayColon="true" />
                        </td>
                        <td>
                ...
                <cms:FormField runat="server" ID="fCodeName" Field="CampaignName">
                    <tr>
                        <td>
                            <cms:FormLabel ID="lblCodeName" runat="server" EnableViewState="false" ResourceString="campaign.codename"
                                DisplayColon="true" />
                        </td>
                        <td>
                ...
                <cms:FormField runat="server" ID="fDescription" Field="CampaignDescription">
                    <tr>
                        <td>
                            <cms:FormLabel ID="lblDescription" runat="server" EnableViewState="false" ResourceString="campaign.description"
                                DisplayColon="true" />
                        </td>
                        <td>
                ...
                <cms:FormField runat="server" ID="fOpenFrom" Field="CampaignOpenFrom">
                    <tr>
                        <td>
                            <cms:FormLabel ID="lblOpenFrom" runat="server" EnableViewState="false" ResourceString="general.openfrom"
                                DisplayColon="true" />
                        </td>
                        <td>
                ...
                <cms:FormField runat="server" ID="fOpenTo" Field="CampaignOpenTo">
                    <tr>
                        <td>
                            <cms:FormLabel ID="lblOpenTo" runat="server" EnableViewState="false" ResourceString="general.opento"
                                DisplayColon="true" />
                        </td>
                        <td>
                ...
                <cms:FormField runat="server" ID="fEnabled" Field="CampaignEnabled">
                    <tr>
                        <td>
                            <cms:FormLabel ID="lblEnabled" runat="server" EnableViewState="false" ResourceString="general.enabled"
                                DisplayColon="true" />
                        </td>
                        <td>
        ...
        <asp:Panel runat="server" ID="pnlAdvanced" CssClass="CampaignPanel">
            <table>
                <cms:FormField runat="server" ID="fImpressions" Field="CampaignImpressions">
                    <tr>
                        <td>
                            <cms:FormLabel ID="lblImpressions" runat="server" EnableViewState="false" ResourceString="campaign.impressions"
                                DisplayColon="true" />
                        </td>
                        <td>
                ...
                <cms:FormField runat="server" ID="fTotalCost" Field="CampaignTotalCost">
                    <tr>
                        <td>
                            <cms:FormLabel ID="lblTotalCost" runat="server" EnableViewState="false" ResourceString="campaign.totalcost"
                                DisplayColon="true" />
                        </td>
                        <td>
                ...
                <cms:FormField runat="server" ID="fCampaignRules" Field="CampaignRules">
                    <tr>
                        <td>
                            <cms:FormLabel ID="LocalizedLabel3" runat="server" EnableViewState="false" ResourceString="campaign.rules"
                                DisplayColon="true" />
                        </td>
                        <td>
                            <cms:ConditionBuilder ID="ucMacroEditor" runat="server" RuleCategoryNames="cms.onlinemarketing" />
                        </td>
                    </tr>
                </cms:FormField>
            </table>
