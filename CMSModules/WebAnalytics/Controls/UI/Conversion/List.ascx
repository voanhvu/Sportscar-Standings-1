...
<cms:UniGrid runat="server" ID="gridElem" ObjectType="analytics.conversion" OrderBy="ConversionDisplayName"
    ...
    <GridActions Parameters="ConversionID">
        ...
        <ug:Action Name="#delete" Caption="$General.Delete$" Icon="Delete.png" Confirmation="$General.ConfirmDelete$" ModuleName="CMS.WebAnalytics" Permissions="ManageConversions" />
    </GridActions>
    <GridColumns>
