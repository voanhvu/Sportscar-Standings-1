...
public partial class CMSModules_WebAnalytics_Pages_Tools_Conversion_Tab_Campaigns : CMSCampaignAndConversionPage
{
    #region "Variables"
    ...
    private string GetConversions()
    {
        ...
        {
            return TextHelper.Join(";", SystemDataHelper.GetStringValues(ds.Tables[0], "CampaignID"));
        }
