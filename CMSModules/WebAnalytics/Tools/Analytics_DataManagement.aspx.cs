...
public partial class CMSModules_WebAnalytics_Tools_Analytics_DataManagement : CMSWebAnalyticsPage
{
    ...
    private void ReloadInfoPanel()
    {
        if (StatisticsInfoProvider.DataGeneratorIsRunning)
        {
            ltrProgress.Text = "<span class=\"InfoLabel\"><table><tr><td>" + GetString("analyt.settings.generatorinprogress") + "</td><td><img style=\"width:12px;height:12px;\" src=\"" + UIHelper.GetImageUrl(Page, "Design/Preloaders/preload16.gif") + "\" alt=\"reload\" /></td></tr></table></span>";
        }
