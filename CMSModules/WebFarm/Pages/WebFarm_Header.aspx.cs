...
public partial class CMSModules_WebFarm_Pages_WebFarm_Header : SiteManagerPage
{
    ...
    {
        // Set the page title
        CurrentMaster.Title.TitleText = GetString("webfarm_header.title");
        CurrentMaster.Title.TitleImage = GetImageUrl("Objects/CMS_WebfarmServer/object.png");
        CurrentMaster.Title.HelpTopicName = "webfarm_server_list";
