...
public partial class CMSModules_Widgets_UI_WidgetTree : SiteManagerPage, IPostBackEventHandler
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        script += "var cloneURL = '" + URLHelper.ResolveUrl("~/CMSModules/Objects/Dialogs/CloneObjectDialog.aspx?objecttype=cms.widget") + "';\n";
        ...
        string postbackRef = ControlsHelper.GetPostBackEventReference(Page, "##");
