    ...
    var jsPlumbUIComponent = function(params) {
        ...
        */
        this.setHover = function(hover, ignoreAttachedElements) {
            if (!self._jsPlumb.currentlyDragging) { //CMS EDIT - keeps UI from flashing
                _hover = hover;

                /*CMS EDIT - easy way to find out what element is hover*/
                if(!ignoreAttachedElements){
                    if(hover) {
                        if(this._jsPlumb.hoverItem){
                            $j(this._jsPlumb.hoverItem.canvas).mouseleave();
                        }
                        this._jsPlumb.hoverItem = this;
                        if(self.tooltip) {
                            $j(self.canvas).tooltip().show();
                        }
                    } else {
                        this._jsPlumb.hoverItem = null;
                        if(self.tooltip) {
                            $j(self.canvas).tooltip().hide();
                        }
                    }
                }
                /*CMS EDIT END*/

                if (self.hoverPaintStyle != null && !$j(self.canvas).hasClass("Selected")) {
    ...
    var jsPlumbInstance = function(_defaults) {
        ...
        */
        this.Defaults = {
            ...
            SelectedConnectionPaintStyle: "Bezier", //CMS EDIT: propably just creators mistake
            AllowNodeAttachToSelf: false, //CMS EDIT: defines wheter or not can connection be wired from one node to it self
            ParentElement: document //CMS EDIT: defines wheter or not can connection be wired from one node to it self
        };

        this.jsPlumbFillCanvases = true; //CMS EDIT - optimization
        ...
        initialized = false,
        connectionsByScope = {},
        connectionsByUUID = {}, // CMS EDIT - better way to store connection
        /**
        ...
        */
        ...
        _newConnection = function(params) {
            ...
            $j(con.canvas).data('jsPlumbObject', con); //CMS EDIT - to support handlers over endpoints
            return con;
        },
        ...
        _newEndpoint = function(params) {
            ...
            $j(ep.canvas).data('jsPlumbObject', ep); //CMS EDIT - to support handlers over endpoints
            return ep;
        },
        ...
        */
        this.addEndpoint = function(el, params, referenceParams) {
            ...
            for (var i = 0; i < inputs.length; i++) {
                ...
                _addToList(endpointsByUUID, e.canvas.id, e); //CMS EDIT
                var myOffset = offsets[id], myWH = sizes[id];
        ...
        */
        this.connect = function(params, referenceParams) {
            ...
            //CMS EDIT - fake endpoints support
            _p.targetEndpoint = _p.targetEndpoint.createFakeEndpoint();
            /* CMS EDIT START - changing anchors when attaching */
            if (_p.sourceEndpoint.attachedAnchors) {
                _p.sourceEndpoint.anchor = _p.sourceEndpoint.attachedAnchors;
            }
            if (_p.targetEndpoint.attachedAnchors) {
                _p.targetEndpoint.anchor = _p.targetEndpoint.attachedAnchors;
            }
            /* CMS EDIT END */
            ...
            _addToList(connectionsByUUID, jpc.canvas.id, jpc); // CMS EDIT - better way to store connections
            // fire an event
            // CMS EDIT : needed to be commented, because we don't want to fire the event if connection was established programmatically
        ...
        */
                ...
                for (var e in endpointsByElement) {
                    ...
                    if (endpoints) {
                        ...
                        for (key in this.sourcePoints) {
                            endpointsByUUID[newEndpoints[key].canvas.id] = newEndpoints[key]; //CMS EDIT
                        }
                    }
                }
                delete endpoint;
        ...
        /*CMS EDIT - deletes every endpoint on node*/
        this.deleteEndpointsOnElement = function(selector){
            var id = _getAttribute(selector, "id");
            var endpoints = endpointsByElement[id];
            if(endpoints){
                for (var i = 0; i < endpoints.length; i++)
        ...
        */
        this.deleteEveryEndpoint = function() {
            ...
            endpointsByElement = {};
            delete endpointsByUUID; //CMS EDIT
            endpointsByUUID = {}; //CMS EDIT
        };
            ...
            if (arguments.length == 2) {
                ...
                _operation(sId, function(jpc) {
                    if ((jpc.sourceId == sId && jpc.targetId == tId) || (jpc.targetId == sId && jpc.sourceId == tId)) {
                        ...
                        _removeFromList(connectionsByUUID, jpc.canvas.id, jpc); //CMS EDIT
                    }
                });
            }
        ...
        */
        this.detachEveryConnection = function() {
            ...
            connectionsByScope = {};
            delete connectionsByUUID; //CMS EDIT
            connectionsByUUID = {}; //CMS EDIT
        };
        ...
        this.init = function() {
            if (!initialized) {
                ...
                var _bind = function(event) {
                    jsPlumb.CurrentLibrary.bind(_currentInstance.Defaults.ParentElement, event, function(e) {
                        if (!_currentInstance.currentlyDragging && _mouseEventsEnabled && renderMode == jsPlumb.CANVAS && !arguments[0].jsPlumbProcessed) {
                            ...
                            if(_currentInstance.hoverItem && _currentInstance.hoverItem.canvas.tagName == "CANVAS" && !e.jsPlumbProcessed)
                            {
                                if(typeof(_currentInstance.hoverItem.connector) != undefined && _currentInstance.hoverItem.connector)
                                    _currentInstance.hoverItem.connector[event](e);
                                else if(typeof(_currentInstance.hoverItem.endpoint) != undefined && _currentInstance.hoverItem.endpoint)
                                    _currentInstance.hoverItem.endpoint[event](e);
                            } else {

                                var target = arguments[0].target;
                                var targetJQ = $j(target);
                                var elArr = new Object();

                                if( _currentInstance.hoverItem){
                                    var oldTarget = _currentInstance.hoverItem.canvas;
                                    var oldTargetJQ = $j(oldTarget);
                                }

                                while(target.tagName == "CANVAS"){
                                    e.target = target;
                                    if(targetJQ.hasClass(_currentInstance.connectorClass)) {
                                        connectionsByUUID[target.id][0].connector[event](e);
                                    } else if(targetJQ.hasClass(_currentInstance.endpointClass)) {
                                        endpointsByUUID[target.id][0].endpoint[event](e);
                                    } else {
                                        break;
                                    } 
                                    elArr[target.id] = {t:targetJQ, w:targetJQ.width()};
                                    while(elArr[target.id])
                                    {
                                        targetJQ.css("width", 0);
                                        target = document.elementFromPoint(arguments[0].clientX, arguments[0].clientY);
                                        targetJQ = $j(target);
                                    }
                                }
                                ...
                                for (var key in elArr) {
                                    var row = elArr[key];
                                    row.t.css("width", row.w);
                                }
                                
                                e.jsPlumbProcessed = true;

                                if(oldTarget && oldTarget.tagName != "CANVAS"){
                                    if(oldTarget == target){
                                        e.currentTarget = target;
                                        e.target = target;
                                        targetJQ.trigger(e);
                                    } else {
                                        oldTargetJQ.mouseleave();
                                        $j(".tooltip:visible").hide();
                                        _currentInstance.hoverItem = null;
                                    }
                                } else if (target != this) {
                                    targetJQ.mouseenter();
                                    _currentInstance.hoverItem = { canvas: target };
                                    if(eventTarget.hasClass("_jsPlumb_connector")){
                                        eventTarget.css("cursor", targetJQ.css("cursor"));
                                    }
                                } else {
                ...
                if(_currentInstance != jsPlumb){ //CMS EDIT - we dont want to bind event handlers of instance to which connections and endpoints does not belong
                    _bind("click");
                    _bind("dblclick");
                    _bind("mousemove");
                    _bind("mousedown");
        ...
        */
        this.sizeCanvas = function(canvas, x, y, w, h) {
            if (canvas) {
                /* CMS EDIT - optimized code */
                var c = $j(canvas);
                c.attr({height:h, width:w}); //needs to be here for canvas render mode
                c.css("height", h); //needs to be here for vml render mode
                c.css("width", w); //needs to be here for vml render mode
                c.css("left", x);
                c.css("top", y);
                /* CMS EDIT END */
                // original jsPlumb code
        ...
        */
        var Anchor = function(params) {
            ...
            this.compute = function(params) {
                ...
                /* CMS EDIT - offsetParent problem in IE8*/
                var parent = null;
                try{
                    parent = element.canvas.offsetParent;
                } catch(err){}
                if(!parent){
                    parent = element.parent[0];
                }
                
                var po = parent.tagName.toLowerCase() === "body" ? { left: 0, top: 0} : _getOffset(parent);
            ...
            /*CMS EDIT*/
            /* Used to return sourcePoint to its default position */
            this.selectDefaultAnchor = function() {
            }
            /*CMS EDIT END*/
        };
        ...
        */
        var DynamicAnchor = function(anchors, anchorSelector) {
            ...
            this.over = function(anchor) { if (_curAnchor && _curAnchor.over) _curAnchor.over(anchor); }; // CMS EDIT - check if over is function
            this.out = function() { if (_curAnchor && _curAnchor.out) _curAnchor.out(); }; // CMS EDIT - check if out is function
        };
        ...
        */
        var Connection = function(params) {
            ...
            */
            ...
            if (eS) _addToList(endpointsByUUID, eS.canvas.id, eS); //CMS EDIT
            ...
            if (eS) _addToList(endpointsByUUID, eT.canvas.id, eT); //CMS EDIT
            ...
            */
            ...
            /*CMS EDIT*/
            /* Used to create reattach helper, which is source&target endpoint on the end of connection */
            this.createReattachHelper = function(el, externalAnchors) {                    
                _removeFakeRetreatEndpoint();
                self.retreatEndpoint = self.endpoints[1];
                self.retreatEndpoint.detachFromConnection(self);
                var color = { fillStyle: self._jsPlumb.Defaults.SelectedConnectionPaintStyle.strokeStyle };
                var anchor = externalAnchors || self.retreatEndpoint.anchor;
                var newEndpoint = self.endpoints[0].getReattachHelperGraphicRepresentation(anchor, { isSource: true, isTarget: true, reattach: true, node: self.endpoints[1].node });
                self.endpoints[1] = self._jsPlumb.addEndpoint(el || self.endpoints[1].elementId, newEndpoint);
                self.endpoints[1].paintStyleInUse = color;
                if(!externalAnchors)
                {
                    self.endpoints[1].anchor = self.retreatEndpoint.anchor;
                    self.endpoints[1].anchor.locked = true;
                }
                self.endpoints[1].addConnection(self);
                self.paintStyleInUse = self._jsPlumb.Defaults.SelectedConnectionPaintStyle;
                self.endpoints[1].anchor.locked = false;
                if(self.endpoints[1].tooltip){
                    var configuration = $j(self.endpoints[0].canvas).tooltip().getConf();
                    $j(self.endpoints[1].canvas).tooltip(configuration);
                }

                self.endpoints[0].paintStyleInUse = color;
                if(self.endpoints[0].canvas.tagName == "IMG" && self.endpoints[0].endpointSelected){
                    var imgParams = self.endpoints[0].endpointSelected[1];
                    self.endpoints[0].canvas.src = imgParams.url || imgParams.img;
                }
                _repaintEndpoints();
                self.repaint();
                self.endpoints[1].isReattachHelper = true;
                self.endpoints[1].toggleClass("Front");
            };

            /* Used to remove reattach helper, which is source&target endpoint on the end of connection */
            this.removeReattachHelper = function() {
                _removeTargetPoint(self);
                self.endpoints[1] = self.retreatEndpoint;
                self.retreatEndpoint = null;
                self.endpoints[1].addConnection(self);
                var newPaintStyle = self.endpoints[0].connectorStyle || this._jsPlumb.Defaults.PaintStyle;
                self.paintStyleInUse = jsPlumb.extend(newPaintStyle);
                self.paintStyle = jsPlumb.extend(newPaintStyle);

                self.endpoints[0].paintStyleInUse = self.endpoints[0].paintStyle;
                
                if(self.endpoints[0].canvas.tagName == "IMG" && self.endpoints[0].endpointSelected){
                    var imgParams = self.endpoints[0].endpointSelected[1];
                    self.endpoints[0].canvas.src = imgParams.originalUrl;
                }
                _repaintEndpoints();
                self.repaint();
            };

            this.removeWithAllProperties = function(){
                _removeFakeRetreatEndpoint();
                if(self.endpoints[1].isFake){
                    _removeTargetPoint();
                }
                self.endpoints[0].detach(self);
            };

            var _repaintEndpoints = function(){
                for(key in self.endpoints) {
                    self.endpoints[key].repaint();
                };
            };

            var _removeTargetPoint = function(){
                var deleteEndpoint = self.endpoints[1];
                if(deleteEndpoint){
                    deleteEndpoint.detachFromConnection(self);
                }
                self._jsPlumb.deleteEndpoint(deleteEndpoint);
            };

            var _removeFakeRetreatEndpoint = function(){
                if(self.retreatEndpoint && self.retreatEndpoint.isFake){
                    jsPlumb.deleteEndpoint(self.retreatEndpoint);
                }
            };
            /*CMS EDIT*/
            ...
            self.repaint();
            if(!self.canvas) //CMS EDIT - VML support
                self.canvas = self.connector.canvas; //CMS EDIT - VML support
        };
        ...
        var Endpoint = function(params) {
            ...
            */
            ...
            if(params.endpointSelected && params.endpointSelected[1] && !preloadedImages[params.endpointSelected[1].url]) 
            {
                ...
                $j(document).append(selectedImage);
            }
            /* CMS EDIT END*/

            /* CMS EDIT - changing anchors when attaching/detaching */
            this.tooltip = params.tooltip;
            this.reattachHelperTooltip = params.reattachHelperTooltip;
            if(this.type == "Image" && params.endpointSelected){
                this.endpointSelected = params.endpointSelected;
                this.endpointSelected[1].originalUrl = params.endpoint[1].url || params.endpoint[1].src;
            }
            if(params.attachedAnchors)
            {
                this.attachedAnchors = new DynamicAnchor(jsPlumb.makeAnchors(params.attachedAnchors));
                this.detachedAnchors = self.anchor;
            }
            /* CMD EDIT END */
            this.parent = params.parent;
            ...
            /* CMS EDIT */
            /* Creates a fake endpoint, which is used instead of actual big one with anchor in center */
            this.createFakeEndpoint = function(params) {
                if (self.fakeEndpointDefinition) {
                    var params = jsPlumb.extend({ isFake: true, node: self.node }, params);
                    return self._jsPlumb.addEndpoint(self.elementId, self.fakeEndpointDefinition, params)
                }
                return self;
            };
            /* Helper method to get graphic representation of this nod */
            this.getReattachHelperGraphicRepresentation = function(externalAnchors, externalParams) {
                var graphicRepresentation = jsPlumb.extend({
                    paintStyle: self.paintStyleInUse,
                    fakeEndpointDefinition: self.fakeEndpointDefinition,
                    node: self.node,
                    tooltip: self.reattachHelperTooltip
                }, externalParams);
                if(self.endpointSelected){                
                    graphicRepresentation.endpoint = [self.endpointSelected[0], self.endpointSelected[1]];
                } else {
                    graphicRepresentation.endpoint = [params.endpoint[0], params.endpoint[1]];
                }

                var anchorsPositions = new Array();
                var anchors = externalAnchors || self.anchor;

                if (anchors) {
                    if (anchors.getAnchors) {
                        anchors = anchors.getAnchors();
                        for (var i = 0; i < anchors.length; i++) {
                            orientation = anchors[i].getOrientation();
                            anchorsPositions.push([anchors[i].x, anchors[i].y, orientation[0], orientation[1]]);
                        }
                    } else if (anchors.getOrientation) {
                        orientation = anchors.getOrientation();
                        anchorsPositions.push([anchors.x, anchors.y, orientation[0], orientation[1]]);
                    } else {
                        anchorsPositions = anchors;
                    }
                    graphicRepresentation.anchors = anchorsPositions;
                }

                return graphicRepresentation;
            };
            /* Toggling class on endpoint */
            this.toggleClass = function(cls){
                var canvasJQ = self.getCanvasJQ();
                canvasJQ.toggleClass(cls);
            };

            this.addClass = function(cls){
                var canvasJQ = self.getCanvasJQ();
                canvasJQ.addClass(cls);
            };

            this.removeClass = function(cls){
                var canvasJQ = self.getCanvasJQ();
                canvasJQ.removeClass(cls);
            };

            this.getCanvasJQ = function(){
                var canvasJQ = $j(self.canvas);
                if (!canvasJQ.hasClass(self._jsPlumb.endpointClass)) {
                    canvasJQ = canvasJQ.find("." + self._jsPlumb.endpointClass);
                }
                return canvasJQ;
            }
            /* CMS EDIT */
            ...
            */
            this.detach = function(connection, ignoreTarget) {
                ...
                if (idx >= 0) {
                    ...
                    _removeFromList(connectionsByUUID, connection.canvas.id, connection); //CMS EDIT
                    ...
                    for (key in endpoints) {
                        ...
                        if (endpoint.detachedAnchors) {
                            endpoint.anchor = endpoint.detachedAnchors;
                        }
                        endpoint.anchor.selectDefaultAnchor();
                        endpoint.repaint(); //CMS EDIT - refreshes dynamic anchors
                    }

                    if(self.canvas.tagName == "IMG" && self.endpointSelected){
                        var imgParams = self.endpointSelected[1];
                        self.canvas.src = imgParams.originalUrl;
                    }
                    /* CMS EDIT END */
                }
            };
            ...
            */
            this.makeInPlaceCopy = function() {
                /* CMS EDIT - copying html parameters */ 
                var newEndpoint = _newEndpoint({ anchor: self.anchor, source: _element, paintStyle: this.paintStyleInUse, endpoint: _endpoint, title: self.tooltip }); 
                var classes = self.getCanvasJQ().attr("class");
                newEndpoint.addClass(classes);
                newEndpoint.removeClass("ui-draggable-dragging");

                if(newEndpoint.endpoint.img){
                    newEndpoint.endpoint.img.src = self.canvas.src;
                }
            ...
            */
            this.paint = function(params) {
                ...
                if (!timestamp || self.timestamp !== timestamp) {
                    _updateOffset({ elId: this.elementId, timestamp: timestamp }); //CMS EDITED without this line repainting of endpoint doesnt work correctly
                    ...
                    if (ap == null) {
                        ...
                        if (self.anchor.isDynamic) {
                            if (self.connections.length > 0) {
                                ...
                                _updateOffset({ elId: oId, timestamp: timestamp }); //CMS EDIT without this line, repainting does not work correctly
                ...
                /*CMS EDIT - repainting connections on endpoint */
                for(key in this.connections)
                    if(this.connections[key].repaint)
                        this.connections[key].repaint();
                /*CMS EDIT END*/
            };
            ...
            */
            ...
            if (params.isSource && jsPlumb.CurrentLibrary.isDragSupported(_element)) {
                ...
                var start = function() {
                    ...
                    //inPlaceCopy.paint(); //CMS EDIT - became redundant
                    ...
                    if (jpc == null) {
                        ...
                        /* CMS EDIT - bringing new floating connection to front */
                        $j(jpc.canvas).addClass("NewConnection");
                        jpc.endpoints[0].node.toggleClass("NewConnection");
                        $j(inPlaceCopy.canvas).addClass("NewConnection");
                        jpc.endpoints[0].oppositeEndpoint = jpc.endpoints[1]; // CMS EDIT - identify opposite endpoint of dragging one
                        jpc.endpoints[0].idx = 1;
                        /* CMS EDIT END */
                    } else {
                        existingJpc = true;
                        // TODO determine whether or not we wish to do de-select hover when dragging a connection.
                        ...
                        inPlaceCopy.initDropTarget(_getElementObject(inPlaceCopy.canvas)); //CMS EDIT initDropTarget became public
                        ...
                        jpc.suspendedEndpoint.idx = anchorIdx; // CMS EDIT - identify which end of connection is reattaching
                        jpc.suspendedEndpoint.oppositeEndpoint = jpc.endpoints[anchorIdx == 0 ? 1 : 0]; // CMS EDIT - identify opposite endpoint of dragging one
                    ...
                    floatingEndpoint.addClass("jsPlumb_floating"); // CMS EDIT - identifying floating endpoint
                    ...
                    $j(".tooltip").hide(); // CMS EDIT - tooltip support
                };
                ...
                /* CMS EDIT - timeout because of switching images */
                dragOptions[startEvent] = _wrap(dragOptions[startEvent], function() { 
                    var self = this;
                    if($j(self).data("jsPlumbObject").connections.length > 0) {
                        setTimeout(function() {start.apply(self)}, 100);
                    } else {
                        start.apply(self);
                    }
                }); 
                ...
                var stop = function(e) { // CMS EDIT - moved to function
                    _removeFromList(endpointsByElement, id, floatingEndpoint);
                    _removeFromList(endpointsByUUID, floatingEndpoint.canvas.id, floatingEndpoint); //CMS EDIT
                    ...
                    if (jpc.endpoints[idx] == floatingEndpoint) {
                        ...
                        if (existingJpc && jpc.suspendedEndpoint) {
                            ...
                            self.node.toggleClass("NewConnection"); // CMS EDIT - bringing node back
                        }
                    }
                    self.anchor.locked = false;
                    self.paint();
                    jpc.setHover(false);
                    /* CMS EDIT - changes endpoint status after attaching */
                    if(self.endpoint.dragStop) {
                        self.endpoint.dragStop(); 
                    }
                    /* CMS EDIT END */
                    jpc.repaint();
                    delete inPlaceCopy;
                    delete endpointsByElement[floatingEndpoint.elementId];
                    delete endpointsByUUID[floatingEndpoint.canvas.id];
                    floatingEndpoint = null;
                    delete floatingEndpoint;

                    /* CMS EDIT - reattaching */
                    if(jpc.suspendedEndpoint && jpc.suspendedEndpoint.shouldBeDeleted){
                        jsPlumb.deleteEndpoint(jpc.suspendedEndpoint); 
                    }
                    jpc = null; //moved down
                    /* CMS EDIT END */
                ...
                dragOptions[stopEvent] = _wrap(dragOptions[stopEvent], function() { 
                    var self = this;
                    if(!$j(this).data("jsPlumbObject")._jsPlumb.currentlyDragging) {
                        setTimeout(function() {stop.apply(self)}, 100);
                    } else {
                        stop.apply(self);
                    }
                }); 
            ...
            /* CMS EDIT */
            /* Endpoint to be used instead of dropped one */
            var _getCorrectEndpoint = function(idx, endpoint) {
                var correctEndpoint = endpoint;
                if (endpoint.node) {
                    if (idx == 0 && !endpoint.isSource) {
                        var usedEndpoint = endpoint.node.getWildcardSourcePoint();
                        if (usedEndpoint) {
                            correctEndpoint = usedEndpoint;
                        }
                    } else if (idx == 1 && endpoint.isSource) {
                        correctEndpoint = endpoint.node.targetPoint;
                    }
                }
                return correctEndpoint.createFakeEndpoint();
            };
            /* CMS EDIT END */
            ...
            this.initDropTarget = function(canvas) { //CMS EDIT needed to be public because of dropping to nodes
                if (params.isTarget && jsPlumb.CurrentLibrary.isDropSupported(_element)) {
                    ...
                    var drop = function() {
                        ...
                        var usedEndpoint = _getCorrectEndpoint(idx, self); //CMS EDIT to use correct endpoint in case of user dropped on inforect one

                        // CMS EDIT - "self" replaces for "usedEndpoint"

                        if (!usedEndpoint.isFull() && !(idx == 0 && !usedEndpoint.isSource) && !(idx == 1 && !usedEndpoint.isTarget) && (usedEndpoint.elementId != jpc.endpoints[ oidx ].elementId || _currentInstance.Defaults.AllowNodeAttachToSelf)) { //CMS EDIT: check if connecting one node to itself
                            if (idx == 0) {
                                jpc.source = _element;
                            ...
                            /* CMS EDIT switching endpoints on connection and refreshing them */
                            if (jpc.suspendedEndpoint) {
                                jpc.suspendedEndpoint.node.ensureNotFront();
                                jpc.suspendedEndpoint.anchor.selectDefaultAnchor();
                                jpc.suspendedEndpoint.removeClass("Selected");
                                jpc.suspendedEndpoint.repaint();
                                if (idx == 1) {
                                    jpc.createReattachHelper(jpc.targetId, usedEndpoint.anchor);
                                    jpc.retreatEndpoint = usedEndpoint;
                                    jpc.endpoints[idx].node = usedEndpoint.node;
                                    jpc.suspendedEndpoint.shouldBeDeleted = true;
                                } else {
                                    jpc.suspendedEndpoint.paintStyleInUse = jpc.suspendedEndpoint.paintStyle;
                                    if(jpc.suspendedEndpoint.canvas.tagName == "IMG" && jpc.suspendedEndpoint.endpointSelected){
                                        var imgParams = jpc.suspendedEndpoint.endpointSelected[1];
                                        jpc.suspendedEndpoint.canvas.src = imgParams.originalUrl;
                                    }
                                    jpc.endpoints[idx] = usedEndpoint;
                                    jpc.endpoints[idx].addConnection(jpc);
                                    jpc.endpoints[idx].repaint();
                                    jpc.removeReattachHelper();
                                    jpc.createReattachHelper();
                                }
                            } else {
                                jpc.endpoints[idx] = usedEndpoint;
                                usedEndpoint.addConnection(jpc);
                            }
                            /* CMS EDIT END */
                            ...
                            if (!jpc.suspendedEndpoint) {
                                _addToList(connectionsByScope, jpc.scope, jpc);
                                _addToList(connectionsByUUID, jpc.canvas.id, jpc); //CMS EDIT
                                _initDraggableIfNecessary(_element, params.draggable, {});
                                jpc.endpoints[0].node.toggleClass("NewConnection"); // CMS EDIT - bringing node back
                                $j(jpc.canvas).removeClass("NewConnection"); // CMS EDIT - bringing back connection
                            }
                            else {
                                ...
                                /* CMS EDIT START - changing anchors when attaching */
                                if (jpc.suspendedEndpoint.detachedAnchors) {
                                    jpc.suspendedEndpoint.anchor = jpc.suspendedEndpoint.detachedAnchors;
                                }
                                /* CMS EDIT END */
                            }

                            /*CMS EDIT - refreshing of anchors*/
                            jpc.endpoints[oidx].anchor.locked = false;
                            jpc.endpoints[oidx].paint();
                            /*CMS EDIT END*/
                            ...
                            _currentInstance.fire("jsPlumbConnection", {
                                ...
                                connection: jpc,
                                //CMS EDIT - sends information whether start or end was edited
                                indexEdited: idx
                            });
                            /* CMS EDIT START - changing anchors when attaching */
                            jpc.endpoints[1].addClass("Selected");
                            jpc.endpoints[0].addClass("Selected");
                            if (jpc.endpoints[0].attachedAnchors) {
                                jpc.endpoints[0].anchor = jpc.endpoints[0].attachedAnchors;
                            }
                            if (jpc.endpoints[1].attachedAnchors) {
                                jpc.endpoints[1].anchor = jpc.endpoints[1].attachedAnchors;
                            }
                            usedEndpoint.repaint();
                            delete floatingConnections[id];
                            /* CMS EDIT END */
                        }
                        /* CMS EDIT - in case first target failed we want to be able to use underlying targets */
                        setTimeout(function(){
                            delete floatingConnections[id];
                        },100);
                        /* CMS EDIT END */
                    ...
                    var _getNeededEndpoint = function(endpoint) {
                    };

                    /* CMS EDIT - switching endpoint image */
                    dropOptions[dropEvent] = _wrap(dropOptions[dropEvent], function(event, ui) { 
                        var jsPlumbInstance = null;
                        if($j(this).data("nodeObject")) {
                            jsPlumbInstance = $j(this).data("nodeObject").myJsPlumb;
                        } else {
                            jsPlumbInstance = $j(this).data("jsPlumbObject")._jsPlumb;
                        }

                        if(!jsPlumbInstance.currentlyDragging) {
                            setTimeout(function() {drop(event,ui)}, 100);
                        } else {
                            drop(event, ui);
                        }
                    }); 
                    ...
                    dropOptions[overEvent] = _wrap(dropOptions[overEvent],function(event, ui) { 
                        var self = this;
                        if(!$j(this).data("jsPlumbObject")._jsPlumb.currentlyDragging) {
                            setTimeout(function() {overEvent.apply(self)}, 100);
                        } else {
                            overEvent.apply(self);
                        }
                    }); 
                    ...
                    dropOptions[outEvent] = _wrap(dropOptions[outEvent], function(event, ui) { 
                        var self = this;
                        if(!$j(this).data("jsPlumbObject")._jsPlumb.currentlyDragging) {
                            setTimeout(function() {outEvent.apply(self)}, 100);
                        } else {
                            outEvent.apply(self);
                        }
                    }); 
            ...
            self.paint(); // CMS EDIT - VML support
            this.initDropTarget(_getElementObject(self.canvas)); //CMS EDIT changed to public
            if(this.tooltip) {
                self.canvas.title = this.tooltip; //CMS EDIT setting tooltip
            }
            return self;
        };
    };
...
(function() {	
 ...
 // ********************************* ENDPOINT TYPES *******************************************************************
    ...
    jsPlumb.Endpoints.Image = function(params) {
        ...
        /* CMS EDIT - automatically resizing */
        self.canvas.onload = function() {
            self.resize();
            var canvasJQ = $j(self.canvas);
            var endpoint = canvasJQ.data("jsPlumbObject");
            if(canvasJQ.hasClass("jsPlumb_floating")){
                var position = $j(".ui-draggable-dragging").position();
                if(position){
                    canvasJQ.css("top", position.top);
                    canvasJQ.css("left", position.left);
                }
            }
        };
        /* CMS EDIT END */
        ...
        var actuallyPaint = function(d, style, anchor) {
            ...
            self.resize(); // CMS EDIT - refactored to separate function
        };

        /* CMS EDIT - resizing and changing image size eventually */
        this.resize = function(){
            $j(self.canvas).css("width","");
            $j(self.canvas).css("height","");
            $j(self.canvas).removeAttr("width","");
            $j(self.canvas).removeAttr("height","");
...
;(function() {
    ...
    VmlConnector = function(params) {
        ...
        self.uuid = params.uuid; //CMS EDIT
        this.paint = function(d, style, anchor) {
            if (style != null) {				
                ...
                self._jsPlumb.getId(self.canvas, self.uuid); //CMS EDIT
            }
        };
...
// ********************************* CANVAS RENDERERS FOR CONNECTORS AND ENDPOINTS *******************************************************************
    ...
    var CanvasMouseAdapter = function() {
        ...
        this.mousemove = function(e) {		 
            ee = e.target; //CMS EDIT = optimization
            ...
            var over = self._over(e); //CMS EDIT - optimization
            if (!_mouseover && _continue && over) {
                _mouseover = true;
                self.fire("mouseenter", self, e);		
                return true;
            }
            ...
            else if (_mouseover && (!over || !_continue) && !eventSourceWasOverlay) {
                _mouseover = false;
                self.fire("mouseexit", self, e);	
                return true;			
            }
    ...
    jsPlumb.Endpoints.canvas.Dot = function(params) {
        ...
        this._paint = function(d, style, anchor) {
            if (style != null && params._jsPlumb.jsPlumbFillCanvases) {	 //CMS EDIT - optimization		
    ...
    jsPlumb.Endpoints.canvas.Rectangle = function(params) {
        ...
        this._paint = function(d, style, anchor) {
            /* CMS EDIT - optimization */
            if(!params._jsPlumb.jsPlumbFillCanvases){
                return;
            }
            /* CMS EDIT END */
...
// ********************************* END OF CANVAS RENDERERS *******************************************************************    
    ...
    var AbstractCanvasArrowOverlay = function(superclass, originalArgs) {
        ...
        this.paint = function(connector, d, lineWidth, strokeStyle, fillStyle) {
            /* CMS EDIT - optimization */
            if(!connector._jsPlumb.jsPlumbFillCanvases){
                return;
            }
            /* CMS EDIT END */
...
(function($) {	
    ...
    jsPlumb.CurrentLibrary = {					        
        ...
        initDraggable : function(el, options) {
            ...
            options.helper = null;
            /* CMS EDIT - scrolling should be turned off by default */
