...
public partial class CMSModules_Workflows_Controls_UI_Workflow_Emails : CMSUserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ucPublish.TemplateType = EmailTemplateMacros.EmailType.WorkflowEmail;
        ucArchive.TemplateType = EmailTemplateMacros.EmailType.WorkflowEmail;
        ucNotif.TemplateType = EmailTemplateMacros.EmailType.WorkflowEmail;
        pnlSettings.GroupingText = GetString("general.general");
        pnlUsers.GroupingText = GetString("workflow.users");
        ...
        chkEmails.SetDefaultValue(WorkflowHelper.SendWorkflowEmails(CMSContext.CurrentSiteName));
