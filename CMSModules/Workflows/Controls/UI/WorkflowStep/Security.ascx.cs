...
public partial class CMSModules_Workflows_Controls_UI_WorkflowStep_Security : CMSAdminEditControl
{
    ...
    private SourcePoint mCurrentSourcePoint = null;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            pnlRoles.GroupingText = GetString("processstep.rolessecurity");
            pnlUsers.GroupingText = GetString("processstep.userssecurity");
        }
        else
        {
            pnlRoles.GroupingText = (SourcePointGuid == null) ? GetString("workflowstep.rolessecurity") : GetString("workflowsteppoint.rolessecurity");
            pnlUsers.GroupingText = (SourcePointGuid == null) ? GetString("workflowstep.userssecurity") : GetString("workflowsteppoint.userssecurity");
        }
        ...
        usRoles.ObjectType = PredefinedObjectType.ROLE;
        usUsers.ObjectType = PredefinedObjectType.USER;
        ...
        if (!RequestHelper.IsPostBack())
        {
            ...
            DataHelper.FillWithEnum<WorkflowStepSecurityEnum>(rbRoleType, resPrefix + ".security", null);
            DataHelper.FillWithEnum<WorkflowStepSecurityEnum>(rbUserType, resPrefix + ".usersecurity", null);
        ...
        if (!RequestHelper.IsPostBack() || RequestHelper.GetPostBackControlID(Page).StartsWithCSafe(rbRoleType.UniqueID) || RequestHelper.GetPostBackControlID(Page).StartsWithCSafe(rbUserType.UniqueID))
        {
    ...
    void rbRoleType_SelectedIndexChanged(object sender, EventArgs e)
    {
    ...
    void rbUserType_SelectedIndexChanged(object sender, EventArgs e)
    {
