...
public partial class CMSPages_GetMetaFile : GetFilePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (CachedSection<CMSOutputMetaFile> cs = new CachedSection<CMSOutputMetaFile>(ref outputFile, cacheMinutes, true, null, "getmetafile", CurrentSiteName, GetBaseCacheKey(), Request.QueryString))
        {
            if (cs.LoadData)
            {
                // Process the file
