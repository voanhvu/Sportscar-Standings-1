...
function resizeareainternal() {
    ...
    var footerHeight = $j("#__ButtonsArea").outerHeight(true);
    ...
    // Main height
    height = document.body.clientHeight - selectorOffsetTop.top - $j("div .CopyLayoutPanel").outerHeight(true) - footerHeight - offsetValue;

    // Try decrement footer height
    var dialogFooter = $j(".PageFooterLine");
