...
function GetSelectedItem() {
    ...
    if ((window.wopener != null) && ((window.wopener.currentEditor != null) || (window.wopener.CKEDITOR != null))) {
        ...
        var editorInst = (window.wopener.currentEditor || window.wopener.CMSPlugin.currentEditor);
        ...
        if (selElem) {
            ...
            switch (elemName) {
                case 'object':
                case 'cke:object':
                    obj = window.wopener.CMSPlugin.getInline(selElem, originalElem);
            ...
            if (selElem && selElem.is('a')) {
                obj = GetLinkObj(obj, selElem.$, editorInst);
            }
            // Else get selection range
            else {
