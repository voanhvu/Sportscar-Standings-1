...
CMSExtendedControls.getBrowserRectangle = function () {
    ...
    if (typeof (OnEnableAutoScroll) == "function") {
        enableAutoScroll = OnEnableAutoScroll();
    }
...
CMSExtendedControls.DragAndDropBehavior.prototype = {
    ...
    initialize: function () {
        ...
        /* Workaround for the AJAX autoscroll feature */
        Sys.Extended.UI.DragDropManager._getInstance().getBrowserRectangle = CMSExtendedControls.getBrowserRectangle;
