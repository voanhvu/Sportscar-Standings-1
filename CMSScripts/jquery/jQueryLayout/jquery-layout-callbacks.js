...
; (function ($) {
    ...
    *
    *	SAMPLE:
    *	$j("#elem").tabs({ show: $.layout.callbacks.resizePaneAccordions });
    *	$j("body").layout({ center__onresize: $.layout.callbacks.resizePaneAccordions });
    *
    ...
    *
    *	SAMPLE:
    *	$j("#elem").tabs({ show: $.layout.callbacks.resizeTabLayout });
    *	$j("body").layout({ center__onresize: $.layout.callbacks.resizeTabLayout });
    *
