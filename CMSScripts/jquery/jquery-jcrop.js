(function(jQuery) {
    jQuery.Jcrop = function(obj, opt) {
        ...
        var $div = jQuery('<div />').width(boundx).height(boundy).addClass(cssClass('holder')).css({
            position: 'relative',
            direction: 'ltr',
        ...
        var $img2 = jQuery('<img />').attr('src', $img.attr('src')).css('position', 'absolute').width(boundx).height(boundy);
        var $img_holder = jQuery('<div />').width(pct(100)).height(pct(100)).css({
            zIndex: 310,
            position: 'absolute',
            overflow: 'hidden'
        }).append($img2);

        var $hdl_holder = jQuery('<div />').width(pct(100)).height(pct(100)).css('zIndex', 320);
        var $sel = jQuery('<div />').css({
            position: 'absolute',
            zIndex: 300
        ...
        var Selection = function() {
            ...
            if (options.drawBorders) {
                ...
                borders.top.css('top', (jQuery.browser.msie ? px(-1) : px(0)));
            }
        ...
        var Tracker = function() {
            ...
            function toFront() {
                ...
                if (trackDoc) {
                    jQuery($trk[0].ownerDocument).mousemove(trackMove).mouseup(trackUp);
                }
            }
            ...
            function toBack() {
                ...
                if (trackDoc) {
                    jQuery($trk[0].ownerDocument).unbind('mousemove', trackMove).unbind('mouseup', trackUp);
                }
            }
