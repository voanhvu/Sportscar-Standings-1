...
public partial class CMSSiteManager_Sites_Site_Edit_General : SiteManagerPage, IPostBackEventHandler, ICallbackEventHandler
{
    ...
    protected void btnOk_Click(object sender, EventArgs e)
    {
        ...
        if (result == "")
        {
            ...
            {
                ShowError(GetString("Administration-Site_Edit.SiteExists"));
            }
        }
        else
        {
    ...
    private bool SaveSite(SiteInfo oldSi)
    {
        ...
        if (siteId > 0)
        {
            try
            {
                ...
                if (si.SiteName.ToLowerCSafe() != txtCodeName.Text.Trim().ToLowerCSafe())
                {
                ...
                if (runSite)
                {
                    ...
                    if (!DataHelper.DataSourceIsEmpty(ds))
                    {
                        ...
                        if (runningsi != null)
                        {
                            ...
                            ShowError(String.Format(GetString("SiteDomain.RunError"), collisionSite, collisionDomain, HTMLHelper.HTMLEncode(si.DisplayName)));
