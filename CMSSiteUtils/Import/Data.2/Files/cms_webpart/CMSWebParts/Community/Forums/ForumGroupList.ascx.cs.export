...
public partial class CMSWebParts_Community_Forums_ForumGroupList : CMSAbstractWebPart
{
    ...
    {
        get { return ValidationHelper.GetBoolean(GetValue("DisplayAttachmentImage"), ForumDivider1.DisplayAttachmentImage); }
        set
        {
    ...
    {
        get { return ValidationHelper.GetBoolean(GetValue("EnableAvatars"), ForumDivider1.EnableAvatars); }
        set
        {
    ...
    public string GroupsSeparator
    {
        ...
        set { SetValue("GroupsSeparator", value); }
    }
