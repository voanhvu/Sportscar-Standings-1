...
public partial class CMSWebParts_CommunityServices_SocialBookmarking : CMSAbstractWebPart
{
    ...
    public bool Fark
    {
        get
        {
            return ValidationHelper.GetBoolean(GetValue("Fark"), false);
        }
        set
        {
            SetValue("Fark", value);
    ...
    public bool Multiply
    {
        get
        {
            return ValidationHelper.GetBoolean(GetValue("Multiply"), false);
        }
        set
        {
    ...
    public bool Faves
    {
        get
        {
            return ValidationHelper.GetBoolean(GetValue("Faves"), false);
        }
        set
        {
            SetValue("Faves", value);
        }
    }
    ...
    /// MisterWong service.
    /// </summary>
    public bool MisterWong
    {
        get
        {
            return ValidationHelper.GetBoolean(GetValue("MisterWong"), false);
        }
        set
        {
            SetValue("MisterWong", value);
        }
    }
    ...
    private static void FillHashTable()
    {
        if (bookmarkServices.Count == 0)
        {
            lock (bookmarkServices)
            {
                ...
                bookmarkServices["Fark"] = new string[] { "Fark", "http://cgi.fark.com/cgi/fark/submit.pl?new_url=", "&amp;new_comment=" };
                bookmarkServices["Multiply"] = new string[] { "Multiply", "http://multiply.com/gus/journal/compose/?url=", "&amp;subject=" };
                ...
                bookmarkServices["Faves"] = new string[] { "Faves", "http://faves.com/Authoring.aspx?u=", "&amp;t=" };
                bookmarkServices["LinkAGogo"] = new string[] { "Link-a-Gogo", "http://www.linkagogo.com/go/AddNoPopup?url=", "&amp;title=" };
                bookmarkServices["MisterWong"] = new string[] { "Mister Wong", "http://www.mister-wong.com/index.php?action=addurl&amp;bm_url=", "&amp;bm_description=" };
