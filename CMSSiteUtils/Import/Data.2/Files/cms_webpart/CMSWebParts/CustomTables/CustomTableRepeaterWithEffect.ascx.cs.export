...
public partial class CMSWebParts_CustomTables_CustomTableRepeaterWithEffect : CMSAbstractWebPart
{
    ...
    public string SelectedQueryStringKeyName
    {
        get
        {
            return ValidationHelper.GetString(this.GetValue("SelectedQueryStringKeyName"), repItems.SelectedQueryStringKeyName);
        }
        set
        {
    ...
    public string SelectedDatabaseColumnName
    {
        get
        {
            return ValidationHelper.GetString(this.GetValue("SelectedDatabaseColumnName"), repItems.SelectedDatabaseColumnName);
        }
        set
        {
    ...
    public string SelectedValidationType
    {
        get
        {                                                             
            return ValidationHelper.GetString(this.GetValue("SelectedValidationType"), repItems.SelectedValidationType);
        }
        set
        {
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            DataClassInfo dci = DataClassInfoProvider.GetDataClass(CustomTable);
            if (dci != null)
            {
                // Public
