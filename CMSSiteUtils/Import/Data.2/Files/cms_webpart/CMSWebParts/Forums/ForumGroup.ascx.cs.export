...
public partial class CMSWebParts_Forums_ForumGroup : CMSAbstractWebPart
{
    ...
    public string SiteName
    {
        ...
        set
        {
            ...
            this.viewerForum.SiteName = value;
        }
    }
    ...
    public bool EnableFriendship
    {
        get
        {
            return ValidationHelper.GetBoolean(GetValue("EnableFriendship"), viewerForum.EnableFriendship);
        }
        set
        {
            SetValue("EnableFriendship", value);
            viewerForum.EnableFriendship = value;
        }
    }
    ...
    public int AttachmentImageMaxSideSize
    {
        ...
        set
        {
            ...
            viewerForum.AttachmentImageMaxSideSize = value;
        }
    }
    ...
    {
        get { return ValidationHelper.GetBoolean(GetValue("DisplayAttachmentImage"), viewerForum.DisplayAttachmentImage); }
        set
        {
    ...
    {
        get { return ValidationHelper.GetBoolean(GetValue("UseFriendlyURL"), false); }
        set
        {
    ...
    public string GroupName
    {
        get
        {
            return DataHelper.GetNotEmpty(GetValue("GroupName"), viewerForum.GroupName);
        }
        set
        {
            SetValue("GroupName", value);
            viewerForum.GroupName = value;
        }
    }
    ...
    {
        get { return ValidationHelper.GetBoolean(GetValue("EnableAvatars"), viewerForum.EnableAvatars); }
        set
        {
    ...
    public bool HideForumForUnauthorized
    {
        get
        {
            return ValidationHelper.GetBoolean(GetValue("HideForumForUnauthorized"), viewerForum.HideForumForUnauthorized);
        }
        set
        {
            SetValue("HideForumForUnauthorized", value);
            viewerForum.HideForumForUnauthorized = value;
        }
    }
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            viewerForum.GroupName = GroupName;
            ...
            viewerForum.EnableFriendship = EnableFriendship && UIHelper.IsFriendsModuleEnabled(CMSContext.CurrentSiteName);
            ...
            viewerForum.HideForumForUnauthorized = HideForumForUnauthorized;
