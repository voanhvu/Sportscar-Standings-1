...
public partial class CMSWebParts_Forums_ForumMostActiveThreads : CMSAbstractWebPart
{
    ...
    public bool HideControlForZeroRows
    {
        ...
        set
        {
            ...
            this.repMostActiveThread.HideControlForZeroRows = value;
        }
    }
    ...
    public string ZeroRowsText
    {
        ...
        set
        {
            ...
            this.repMostActiveThread.ZeroRowsText = value;
        }
    }
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        if (((this.repMostActiveThread.DataSource == null) || (DataHelper.DataSourceIsEmpty(this.repMostActiveThread.DataSource))) && (this.HideControlForZeroRows))
        {
            this.Visible = false;
        }
    }
