<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="CMSWebParts_Membership_LinkedIn_LinkedInLogon" CodeFile="LinkedInLogon.ascx.cs" %>
<cms:LocalizedLabel ID="lblError" runat="server" EnableViewState="false" CssClass="ErrorLabel" />
<cms:CMSButton ID="btnSignIn" runat="server" OnCommand="btnSignIn_Click" EnableViewState="false" Visible="false" />
...
<cms:CMSButton ID="btnSignOut" runat="server" OnCommand="btnSignOut_Click" EnableViewState="false" Visible="false" />
