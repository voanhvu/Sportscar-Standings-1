<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="CMSWebParts_Membership_LinkedIn_LinkedInUsersRequiredData" CodeFile="LinkedInUsersRequiredData.ascx.cs" %>
                            ...
                            <tr>
                                ...
                                <td>
                                    <cms:LocalizedButton ID="btnOkNew" ResourceString="general.ok" runat="server" OnClick="btnOkNew_Click"
                                        EnableViewState="false" CssClass="ContentButton" ValidationGroup="LinkedInNewUser" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
