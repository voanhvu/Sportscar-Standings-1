...
public partial class CMSWebParts_MessageBoards_MessageList : CMSAbstractWebPart
{
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            ucMessageList.OnCheckPermissions += new CMS.UIControls.CMSAdminControl.CheckPermissionsEventHandler(ucMessageList_OnCheckPermissions);
        }
    }
    ...
    void ucMessageList_OnCheckPermissions(string permissionType, CMS.UIControls.CMSAdminControl sender)
    {
        if (!CMSContext.CurrentUser.IsAuthorizedPerResource("cms.messageboards", permissionType))
        {
