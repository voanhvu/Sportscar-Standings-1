<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MyAccounts.ascx.cs" Inherits="CMSWebParts_OnlineMarketing_MyAccounts" %>
...
<cms:UniGrid runat="server" ID="gridElem" OrderBy="AccountName" ObjectType="om.accountlist"
    ...
    <GridActions>
        <ug:Action Name="edit" ExternalSourceName="edit" Caption="$General.Edit$" Icon="Edit.png" CommandArgument="AccountID" />
    </GridActions>
    <GridColumns>
        ...
        <ug:Column Source="AccountWebSite" ExternalSourceName="website" Caption="$om.account.website$" Wrap="false" Name="website">
        </ug:Column>
