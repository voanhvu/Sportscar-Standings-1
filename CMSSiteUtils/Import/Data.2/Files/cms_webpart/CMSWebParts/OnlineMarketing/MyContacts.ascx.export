<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MyContacts.ascx.cs" Inherits="CMSWebParts_OnlineMarketing_MyContacts" %>
...
<cms:UniGrid runat="server" ID="gridElem" ObjectType="om.contactlist" OrderBy="ContactLastName"
    ...
    <GridColumns>
        ...
        <ug:Column Source="ContactEmail" Caption="$general.email$" Wrap="false" Name="email">
            <Filter Type="text" />
        </ug:Column>
