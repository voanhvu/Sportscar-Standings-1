...
public partial class CMSWebParts_Syndication_Basic_AtomRepeater : CMSAbstractWebPart
{
    ...
    public DateTime FeedUpdated
    {
        get
        {
            return ValidationHelper.GetDateTime(GetValue("FeedUpdated"), DateTimeHelper.ZERO_TIME);
        }
        set
        {
    ...
    {
        if (StopProcessing || (CMSContext.ViewMode == ViewModeEnum.Design) || (CMSContext.ViewMode == ViewModeEnum.Edit) || (CMSContext.ViewMode == ViewModeEnum.EditDisabled))
        {
        ...
        else
        {
            ...
            atomRepeater.FeedLink = URLHelper.GetAbsoluteUrl(URLHelper.CurrentURL);
