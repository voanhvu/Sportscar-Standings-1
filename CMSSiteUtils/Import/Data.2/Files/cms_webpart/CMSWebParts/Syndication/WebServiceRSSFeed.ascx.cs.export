...
public partial class CMSWebParts_Syndication_WebServiceRSSFeed : CMSAbstractWebPart
{
    ...
    public string FilterName
    {
        get
        {
            return ValidationHelper.GetString(this.GetValue("FilterName"), srcWebService.SourceFilterName);
        }
        set
        {
    ...
    public override bool StopProcessing
    {
        ...
        set
        {
            ...
            srcWebService.StopProcessing = value;
        }
    }
    ...
    protected void SetupControl()
    {
        if (StopProcessing)
        {
            ...
            srcWebService.StopProcessing = true;
        }
        else
        {
            ...
            this.srcWebService.WebServiceUrl = WebServiceUrl;
            this.srcWebService.WebServiceParameters = WebServiceParameters;
            this.srcWebService.FilterName = ValidationHelper.GetString(this.GetValue("WebPartControlID"), this.ClientID);
            this.srcWebService.SourceFilterName = FilterName;
            ...
            // Set datasource
            rssFeed.DataSourceControl = srcWebService;
        }
    }
