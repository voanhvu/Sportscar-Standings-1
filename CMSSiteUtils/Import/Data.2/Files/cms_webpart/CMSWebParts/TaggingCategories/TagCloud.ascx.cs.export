...
public partial class CMSWebParts_TaggingCategories_TagCloud : CMSAbstractWebPart
{
    ...
    public string TagGroupName
    {
        get
        {
            string tagGroupName = ValidationHelper.GetString(this.GetValue("TagGroupName"), String.Empty);
    ...
    public bool CombineWithDefaultCulture
    {
        get
        {
            return ValidationHelper.GetBoolean(GetValue("CombineWithDefaultCulture"), SettingsKeyProvider.GetBoolValue(this.SiteName + ".CMSCombineWithDefaultCulture"));
        }
        set
        {
