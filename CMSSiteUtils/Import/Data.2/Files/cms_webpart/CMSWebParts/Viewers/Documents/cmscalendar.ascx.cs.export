...
public partial class CMSWebParts_Viewers_Documents_cmscalendar : CMSAbstractWebPart
{
    ...
    public string CategoryName
    {
        get
        {
            return ValidationHelper.GetString(this.GetValue("CategoryName"), calItems.CategoryName);
        }
        set
        {
    ...
    public string TransformationName
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("TransformationName"), calItems.TransformationName), calItems.TransformationName);
        }
        set
        {
    ...
    public string DayField
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("DayField"), calItems.DayField), calItems.DayField);
        }
        set
        {
