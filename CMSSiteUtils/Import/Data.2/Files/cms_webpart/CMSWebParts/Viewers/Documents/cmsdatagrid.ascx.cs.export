...
public partial class CMSWebParts_Viewers_Documents_cmsdatagrid : CMSAbstractWebPart
{
    ...
    public string ClassNames
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("Classnames"), gridElem.ClassNames), gridElem.ClassNames);
        }
        set
        {
    ...
    public string CategoryName
    {
        get
        {
            return ValidationHelper.GetString(this.GetValue("CategoryName"), gridElem.CategoryName);
        }
        set
        {
    ...
    public string CultureCode
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("CultureCode"), gridElem.CultureCode), gridElem.CultureCode);
        }
        set
        {
    ...
    public string OrderBy
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("OrderBy"), gridElem.OrderBy), gridElem.OrderBy);
        }
        set
        {
    ...
    public string SiteName
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("SiteName"), gridElem.SiteName), gridElem.SiteName);
        }
        set
        {
    ...
    public string RelationshipName
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("RelationshipName"), gridElem.RelationshipName), gridElem.RelationshipName);
        }
        set
        {
    ...
    /// <summary>
    /// Gets or sets the name of the transforamtion which is used for displaying the results of selected item.
    /// </summary>
    public string SelectedItemTransformationName
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("SelectedItemTransformationName"), gridElem.SelectedItemTransformationName), gridElem.SelectedItemTransformationName);
        }
        set
        {
    ...
    public string SortField
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("SortField"), gridElem.SortField), gridElem.SortField);
        }
        set
        {
    ...
    protected void LoadFromDataClass(string classNames)
    {
        ...
        {
            classesList = new ArrayList(classNames.Split(';'));
        }
        ...
        foreach (string className in classesList)
        {
            try
            {
                if (className != "")
                {
                    ...
                    {
                        foreach (string col in dc.StructureInfo.ColumnNames)
                        {
                            columnList.Add(col);
                        }
                    }
        ...
        // Set string array.
        mColumnList = (String[])columnList.ToArray(typeof(string));
    }
