...
public partial class CMSWebParts_Viewers_Documents_documentpager : CMSAbstractWebPart
{
    ...
    /// </summary>
    public CMS.Controls.PagingPlaceTypeEnum PagerPosition
    {
        get
        {
    ...
    /// </summary>
    public CMS.Controls.PagingModeTypeEnum PagingMode
    {
        get
        {
    ...
    /// </summary>
    public CMS.Controls.BackNextDisplayTypeEnum BackNextDisplay
    {
        get
        {
    ...
    /// </summary>
    public CMS.Controls.PageNumbersDisplayTypeEnum PageNumbersDisplay
    {
        get
        {
    ...
    /// </summary>
    public CMS.Controls.ResultsLocationTypeEnum ResultsLocation
    {
        get
        {
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            BackNextDisplay = CMS.Controls.BackNextDisplayTypeEnum.HyperLinks;
            PageNumbersDisplay = CMS.Controls.PageNumbersDisplayTypeEnum.Numbers;

            ShowFirstLast = false;
            ResultsLocation = CMS.Controls.ResultsLocationTypeEnum.None;
