...
public partial class CMSWebParts_Viewers_Query_querydatalist : CMSAbstractWebPart
{
    ...
    public string SelectedQueryStringKeyName
    {
        get
        {
            return ValidationHelper.GetString(this.GetValue("SelectedQueryStringKeyName"), lstItems.SelectedQueryStringKeyName);
        }
        set
        {
    ...
    public string SelectedDatabaseColumnName
    {
        get
        {
            return ValidationHelper.GetString(this.GetValue("SelectedDatabaseColumnName"), lstItems.SelectedDatabaseColumnName);
        }
        set
        {
    ...
    public string SelectedValidationType
    {
        get
        {
            return ValidationHelper.GetString(this.GetValue("SelectedValidationType"), lstItems.SelectedValidationType);
        }
        set
        {
    ...
    public string QueryName
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("QueryName"), lstItems.QueryName), lstItems.QueryName);
        }
        set
        {
            SetValue("QueryName", value);
            lstItems.QueryName = value;
        }
    }
    ...
    public string Columns
    {
        get
        {
            return ValidationHelper.GetString(GetValue("Columns"), lstItems.Columns);
        }
        set
        {
            SetValue("Columns", value);
            lstItems.SelectedColumns = value;
        }
    }
    ...
    public bool ShowEditDeleteButtons
    {
        get
        {
            return ValidationHelper.GetBoolean(GetValue("ShowEditDeleteButtons"), lstItems.ShowEditDeleteButtons);
        }
        set
        {
            SetValue("ShowEditDeleteButtons", value);
            lstItems.ShowEditDeleteButtons = value;
        }
    }
    ...
    protected void SetupControl()
    {
        ...
        {
            // Add query datalist to the filter collection
            CMSControlsHelper.SetFilter(ValidationHelper.GetString(this.GetValue("WebPartControlID"), this.ClientID), this.lstItems);
            ...
            lstItems.QueryName = QueryName;
            lstItems.ShowEditDeleteButtons = ShowEditDeleteButtons;
            lstItems.Columns = Columns;
        }
    }
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        Visible = lstItems.Visible && !StopProcessing;
