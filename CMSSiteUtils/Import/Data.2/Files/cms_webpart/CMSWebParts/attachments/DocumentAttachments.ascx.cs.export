...
public partial class CMSWebParts_Attachments_DocumentAttachments : CMSAbstractWebPart
{
    ...
    public override string CacheItemName
    {
        get
        {
            return ValidationHelper.GetString(GetValue("CacheItemName"), ucAttachments.CacheItemName);
        }
        set
        {
    ...
    public override string CacheDependencies
    {
        get
        {
            return ValidationHelper.GetString(GetValue("CacheDependencies"), ucAttachments.CacheDependencies);
        }
        set
        {
    ...
    public override int CacheMinutes
    {
        get
        {
            return ValidationHelper.GetInteger(GetValue("CacheMinutes"), ucAttachments.CacheMinutes);
        }
        set
        {
    ...
    public string Path
    {
        get
        {
            return ValidationHelper.GetString(GetValue("Path"), ucAttachments.Path);
        }
        set
        {
            SetValue("Path", value);
