...
public partial class CMSWebParts_Attachments_AttachmentLightBoxGallery : CMSAbstractWebPart
{
    ...
    public string PagingMode
    {
        ...
        set
        {
            if (value != null)
            {
                ...
                {
                    case "postback": galleryElem.PagingMode = UniPagerMode.PostBack; break;
                    default: galleryElem.PagingMode = UniPagerMode.Querystring; break;
                }
            }
        }
    }
    ...
    public string Path
    {
        get
        {
            return ValidationHelper.GetString(GetValue("Path"), galleryElem.Path);
        }
        set
        {
            SetValue("Path", value);
    ...
    public float LightBoxOverlayOpacity
    {
        get
        {
            return (float)ValidationHelper.GetDouble(GetValue("LightBoxOverlayOpacity"), galleryElem.LightBoxOverlayOpacity);
        }
        set
        {
