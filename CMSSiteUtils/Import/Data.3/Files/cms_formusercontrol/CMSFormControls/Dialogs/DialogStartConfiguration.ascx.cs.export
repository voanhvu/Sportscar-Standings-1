...
public partial class CMSFormControls_Dialogs_DialogStartConfiguration : FormEngineUserControl
{
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        if (communityLoaded)
        {
            drpGroups.SelectedIndexChanged += new EventHandler(drpGroups_SelectedIndexChanged);
        }
    ...
    public override object[,] GetOtherValues()
    {
        ...
        if (mediaLoaded)
        {
            ...
            // Site libraries DDL
            string value = drpSiteLibraries.SelectedValue;
            ...
            {
                values[9, 1] = "#single#";
                values[10, 1] = drpSiteLibraries.SelectedValue;
            }

            if (communityLoaded)
            {
                // Groups DDL
                value = drpGroups.SelectedValue;
                if ((value == "#none#") || (value == "#current#"))
                {
                    values[11, 1] = value;
                }
                ...
                {
                    values[11, 1] = "#single#";
                    values[12, 1] = drpGroups.SelectedValue;
                }

                // Group libraries DDL
                value = drpGroupLibraries.SelectedValue;
                if ((value == "#none#") || (value == "#current#"))
                {
                    values[13, 1] = value;
                }
                ...
                {
                    values[13, 1] = "#single#";
                    values[14, 1] = drpGroupLibraries.SelectedValue;
                }
            }
