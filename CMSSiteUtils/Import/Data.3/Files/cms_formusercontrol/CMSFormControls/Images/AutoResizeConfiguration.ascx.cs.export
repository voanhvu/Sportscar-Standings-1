...
public partial class CMSFormControls_Images_AutoResizeConfiguration : FormEngineUserControl, ICallbackEventHandler
{
    ...
    public override object Value
    {
        get
        {
            ...
            if (ContainsColumn("autoresize_hashtable") && ValidationHelper.GetBoolean(Form.Data["autoresize_hashtable"], false))
            {
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        {
            width = ValidationHelper.GetInteger(Form.Data["autoresize_width"], 0);
            height = ValidationHelper.GetInteger(Form.Data["autoresize_height"], 0);
            maxSideSize = ValidationHelper.GetInteger(Form.Data["autoresize_maxsidesize"], 0);
    ...
    public override object[,] GetOtherValues()
    {
        ...
        if (ContainsColumn("autoresize_hashtable") && ValidationHelper.GetBoolean(Form.Data["autoresize_hashtable"], false) && (Value.ToString() == "custom"))
        {
