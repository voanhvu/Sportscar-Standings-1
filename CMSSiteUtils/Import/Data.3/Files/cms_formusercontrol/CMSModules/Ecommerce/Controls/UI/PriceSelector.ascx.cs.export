...
public partial class CMSModules_Ecommerce_Controls_UI_PriceSelector : FormEngineUserControl
{
    ...
    // TODO_JAND: Rename ValidatorOnNewLine to ShowErrorsOnNewLine?
    /// <summary>
    ...
    public bool ValidatorOnNewLine
    {
        ...
        set
        {
            ...
            if (value)
            {
                pnlNewLineWrapper.Controls.Add(plcMessages);
            }
            else
            {
    ...
    public string EmptyErrorMessage
    {
        get
        {
            return ValidationHelper.GetString(GetValue("EmptyErrorMessage"), null);
        }
        set
        {
    ...
    public string ValidationErrorMessage
    {
        get
        {
            return ValidationHelper.GetString(GetValue("RangeErrorMessage"), null);
        }
        set
        {
    ...
    public bool ShowCurrencyCode
    {
        ...
        set
        {
            SetValue("ShowCurrencyCode", lblCurrencyCode.Visible);
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        pnlNewLineWrapper.Visible = pnlNewLineWrapper.Controls.Count > 0;
    }
