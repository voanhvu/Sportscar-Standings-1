...
public partial class CMSModules_Ecommerce_FormControls_CheckoutProcess : FormEngineUserControl
{
    ...
    /// <summary>
    /// Indicates, if actions are visible. Set to false, when handling actions programmatically.
    /// </summary>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (ImageFolder == "")
        {
            ImageFolder = GetImageUrl("Design/Controls/UniGrid/Actions/", IsLiveSite, true);
        }
        ...
        btnEditImageUrl = ImageFolder + "Edit.png";
        btnDeleteImageUrl = ImageFolder + "Delete.png";
        btnMoveUpImageUrl = ImageFolder + "Up.png";
        btnMoveDownImageUrl = ImageFolder + "Down.png";
    ...
    private void gridSteps_RowDataBound(object sender, GridViewRowEventArgs e)
    {
    ...
    protected void btnOk_Click(object sender, EventArgs e)
    {
        ...
        if (errorMessage != "")
        {
            plcMessNew.ShowError(errorMessage, null, null);
