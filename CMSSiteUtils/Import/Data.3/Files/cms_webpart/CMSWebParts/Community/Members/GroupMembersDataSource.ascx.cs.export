...
public partial class CMSWebParts_Community_Members_GroupMembersDataSource : CMSAbstractWebPart
{
    ...
    public string SiteName
    {
        get
        {
            return ValidationHelper.GetString(GetValue("SiteName"), CMSContext.CurrentSiteName);
        }
        set
        {
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            srcMembers.FilterName = ValidationHelper.GetString(GetValue("WebPartControlID"), ClientID);
