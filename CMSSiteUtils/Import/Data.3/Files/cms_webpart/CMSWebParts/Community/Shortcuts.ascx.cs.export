...
public partial class CMSWebParts_Community_Shortcuts : CMSAbstractWebPart, IPostBackEventHandler
{
    ...
    public string SignInText
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("SignInText"), null), GetString("webparts_membership_signoutbutton.signin"));
        }
        set
        {
    ...
    public string JoinCommunityText
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("JoinCommunityText"), null), GetString("group.member.join"));
        }
        set
        {
    ...
    {
        return ResolveUrl(TreePathUtils.GetUrl(CMSContext.ResolveCurrentPath(path)));
    }
