...
public partial class CMSWebParts_Layouts_ZonesWithEffect : CMSAbstractLayoutWebPart
{
    ...
    protected override void PrepareLayout()
    {
        ...
        // Add init script
        string resolvedInitScript = CMSContext.ResolveMacros(InitScript);
        ...
        // Add inline CSS
        string inlinecss = CMSContext.ResolveMacros(InlineCSS);
        if (!string.IsNullOrEmpty(inlinecss))
        {
            // Add css to page header
            CSSHelper.RegisterCSSBlock(Page, inlinecss);
        }
