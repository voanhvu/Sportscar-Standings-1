...
public partial class CMSWebParts_Maps_Basic_BasicGoogleMaps : CMSAbstractWebPart
{
    ...
    public double? Latitude
    {
        get
        {
            string lat = DataHelper.GetNotEmpty(GetValue("Latitude"), "");
            ...
            {
                return ValidationHelper.GetDoubleSystem(lat, 0);
            }
        }
        set
        {
    ...
    public double? Longitude
    {
        get
        {
            string lng = DataHelper.GetNotEmpty(GetValue("Longitude"), "");
            ...
            {
                return ValidationHelper.GetDoubleSystem(lng, 0);
            }
        }
        set
        {
        ...
        if (!StopProcessing)
        {
            ...
            if (DataSourceControl != null && EnableServerProcessing)
            {
                ...
                if (DataSourceControl.CacheMinutes <= 0)
                {
                    ...
                    BasicGoogleMaps.CacheMinutes = SettingsKeyProvider.GetIntValue(CurrentSiteName + ".CMSCacheMinutes");
                }
                else
                {
    ...
    protected void EnsureFilterControl()
    {
        if (!mFilterControlAdded)
        {
            ...
            CMSControlsHelper.SetFilter(ValidationHelper.GetString(GetValue("WebPartControlID"), ClientID), BasicGoogleMaps);
    ...
    protected void LoadTransformations()
    {
        ...
        {
            BasicGoogleMaps.ItemTemplate = CMSDataProperties.LoadTransformation(this, TransformationName, false);
        }
    }
