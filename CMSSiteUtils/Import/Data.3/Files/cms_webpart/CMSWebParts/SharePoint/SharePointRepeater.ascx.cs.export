...
public partial class CMSWebParts_SharePoint_SharePointRepeater : CMSAbstractWebPart
{
    ...
    /// <summary>
    /// Gets or sets URL of SharePoint service (E.g. Lists.asmx, Imaging.asmx).
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the mode which specifies what this web part exactly do.
    /// </summary>
    public string Mode
    {
        get
    ...
    public string ZeroRowsText
    {
        get
        {
            return ValidationHelper.GetString(GetValue("ZeroRowsText"), BasicRepeater.ZeroRowsText);
        }
        set
        {
    ...
    #region "Basic repeater template properties"
    ...
    /// <summary>
    /// Gets or sets the query string parameter.
    /// </summary>
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        else
        {
            ...
            if (UseClassicDataset)
            {
                if (HideControlForZeroRows && !BasicRepeater.HasData())
                {
                    Visible = false;
                }
            }
