...
public partial class CMSWebParts_Syndication_WebServiceRSSFeed : CMSAbstractWebPart
{
    ...
    public string FilterName
    {
        get
        {
            return ValidationHelper.GetString(GetValue("FilterName"), srcWebService.SourceFilterName);
        }
        set
        {
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            srcWebService.FilterName = ValidationHelper.GetString(GetValue("WebPartControlID"), ClientID);
