...
public partial class CMSModules_Ecommerce_FormControls_SelectProductImage : FormEngineUserControl
{
    ...
    private string MetaFilePath
    {
        ...
        {
            string path = null;
            DataSet metaFiles = MetaFileInfoProvider.GetMetaFiles(SKUID, ECommerceObjectType.SKU, MetaFileInfoProvider.OBJECT_CATEGORY_IMAGE, null, null);
    ...
    private void InitMetaFileControl()
    {
        ...
        metaFileElem.ObjectType = ECommerceObjectType.SKU;
        metaFileElem.Category = MetaFileInfoProvider.OBJECT_CATEGORY_IMAGE;
