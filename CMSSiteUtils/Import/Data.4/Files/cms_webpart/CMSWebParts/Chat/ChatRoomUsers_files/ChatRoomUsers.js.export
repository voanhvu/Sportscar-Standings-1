function ChatRoomUsersWP(opt) {
    ...
    var that = this,
        ...
        pnlInvite = jQuery("#" + that.Options.pnlChatRoomUsersInvite),
        pnlInvitePrompt = jQuery("#" + that.Options.pnlChatRoomUsersInvitePrompt),
        lastSearch = "",
        loadingBackup = "";  
    ...
    function RenderUsers(users) {
        ...
        for (var i = 0; i < users.length; i++) {
            ...
            var userTemplate = jQuery.tmpl(chatUserTemplateB, usr);
    ...
    function Inicialize() {
        ...
        jQuery.template(chatUserTemplateB, that.Options.chatUserTemplate);
        ...
        jQuery("#" + that.Options.btnChatRoomUsersInvite).click(function() {
