...
public partial class CMSWebParts_Community_Members_GroupMembersViewer : CMSAbstractWebPart
{
    ...
    public string FilterName
    {
        get
        {
            return ValidationHelper.GetString(GetValue("FilterName"), srcMembers.SourceFilterName);
        }
        set
        {
    ...
    public bool HideControlForZeroRows
    {
        ...
        set
        {
            ...
            repMembers.HideControlForZeroRows = value;
        }
    }
    ...
    public string SiteName
    {
        get
        {
            return DataHelper.GetNotEmpty(GetValue("SiteName"), filterMembers.SiteName);
        }
        set
        {
            SetValue("SiteName", value);
            filterMembers.SiteName = value;
    ...
    /// </summary>
    private void filterMembers_OnFilterChanged()
    {
    ...
    /// <summary>
    /// Overrides pre-render.
    /// </summary>
    protected override void OnPreRender(EventArgs e)
    {
        Visible = !StopProcessing;

        if (!repMembers.HasData() && HideControlForZeroRows)
        {
            Visible = false;
        }
        base.OnPreRender(e);
