...
public partial class CMSWebParts_DataSources_SQLDataSource : CMSAbstractWebPart
{
    ...
    public string Language
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("Language"), null), "English");
        }
        set
        {
    ...
    protected void SetupControl()
    {
        ...
        {
            // Document properties
            srcSQL.FilterName = ValidationHelper.GetString(GetValue("WebPartControlID"), ClientID);
