...
public partial class CMSWebParts_General_MobileDeviceRedirection : CMSAbstractWebPart
{
    ...
    protected UserAgentEnum GetUserAgentName(string userAgent)
    {
        ...
        if (userAgent.Contains(UserAgentEnum.BlackBerry.ToString().ToLowerCSafe()))
        {
            return UserAgentEnum.BlackBerry;
        }
        else if (userAgent.Contains(UserAgentEnum.IPhone.ToString().ToLowerCSafe()))
        {
            return UserAgentEnum.IPhone;
        }
        else if (userAgent.Contains(UserAgentEnum.IPad.ToString().ToLowerCSafe()))
        {
            return UserAgentEnum.IPad;
        }
        else if (userAgent.Contains(UserAgentEnum.Nokia.ToString().ToLowerCSafe()))
        {
            return UserAgentEnum.Nokia;
        }
        else if (userAgent.Contains(UserAgentEnum.Android.ToString().ToLowerCSafe()))
        {
