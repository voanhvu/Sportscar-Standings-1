...
public partial class CMSWebParts_Newsletters_NewsletterSubscriptionWebPart : CMSAbstractWebPart
{
    ...
    {
        SubscriberInfo sb = SaveSubscriber();
        ...
        else
        {
            ...
            if (DisplayFirstName && !(AllowUserSubscribers && (CMSContext.CurrentUser != null) && CMSContext.CurrentUser.IsAuthenticated()))
            {
                visibleFirstName = true;
            }

            if (DisplayLastName && !(AllowUserSubscribers && (CMSContext.CurrentUser != null) && CMSContext.CurrentUser.IsAuthenticated()))
            {
                visibleLastName = true;
            }
