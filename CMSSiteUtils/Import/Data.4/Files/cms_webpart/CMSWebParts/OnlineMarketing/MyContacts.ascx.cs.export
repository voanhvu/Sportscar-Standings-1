...
public partial class CMSWebParts_OnlineMarketing_MyContacts : CMSAbstractWebPart
{
    ...
    protected void SetupControl()
    {
        ...
        bool siteContactsAllowed = user.IsAuthorizedPerResource(ModuleEntry.CONTACTMANAGEMENT, "ReadContacts");
        bool globalContactsAllowed = user.IsAuthorizedPerResource(ModuleEntry.CONTACTMANAGEMENT, "ReadGlobalContacts") && SettingsKeyProvider.GetBoolValue(CMSContext.CurrentSiteName + ".CMSCMGlobalContacts");
    ...
    private void RegisterScripts()
    {
        ...
        script.Append(@" function EditContact(contactID) {  modalDialog('" + ResolveUrl(CONTACT_DETAIL_DIALOG) + @"?contactid=' + contactID, 'ContactDetail', '1024px', '700px'); }");
