...
public partial class CMSWebParts_Viewers_Documents_cmsdatalist : CMSAbstractWebPart
{
    ...
    public string ClassNames
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("Classnames"), lstElem.ClassNames), lstElem.ClassNames);
        }
        set
        {
    ...
    public string CultureCode
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("CultureCode"), lstElem.CultureCode), lstElem.CultureCode);
        }
        set
        {
    ...
    public string OrderBy
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("OrderBy"), lstElem.OrderBy), lstElem.OrderBy);
        }
        set
        {
    ...
    public string SiteName
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("SiteName"), lstElem.SiteName), lstElem.SiteName);
        }
        set
        {
    ...
    public string RelationshipName
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("RelationshipName"), lstElem.RelationshipName), lstElem.RelationshipName);
        }
        set
        {
    ...
    public string TransformationName
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("TransformationName"), lstElem.TransformationName), lstElem.TransformationName);
        }
        set
        {
    ...
    public string SelectedItemTransformationName
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("SelectedItemTransformationName"), lstElem.SelectedItemTransformationName), lstElem.SelectedItemTransformationName);
        }
        set
        {
    ...
    public string AlternatingTransformationName
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("AlternatingTransformationName"), lstElem.AlternatingTransformationName), lstElem.AlternatingTransformationName);
        }
        set
        {
    ...
    public string ZeroRowsText
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("ZeroRowsText"), lstElem.ZeroRowsText), lstElem.ZeroRowsText);
        }
        set
        {
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            CMSControlsHelper.SetFilter(ValidationHelper.GetString(GetValue("WebPartControlID"), ClientID), lstElem);
        }
    }
