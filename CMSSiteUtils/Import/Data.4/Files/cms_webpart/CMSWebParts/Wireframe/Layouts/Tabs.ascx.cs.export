...
public partial class CMSWebParts_Wireframe_Layouts_Tabs : CMSAbstractLayoutWebPart
{
    ...
    protected override void PrepareLayout()
    {
        ...
        if (IsDesign && AllowDesignMode)
        {
            ...
            if (Tabs > 1)
            {
                AppendRemoveAction(GetString("Layout.RemoveTab"), "Tabs", "CMSModules/CMS_PortalEngine/Wireframes/Remove.png", null);
                Append(" ");
            }
            AppendAddAction(GetString("Layout.AddTab"), "Tabs", "CMSModules/CMS_PortalEngine/Wireframes/Add.png", null);
