<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSWebParts_Carz_SearchCarsBoxResult" CodeFile="SearchCarsBoxResult.ascx.cs" %>
...
<div  class="searchfilter" style="float:left;" ><strong>0-60 mph Standings</strong></div>
