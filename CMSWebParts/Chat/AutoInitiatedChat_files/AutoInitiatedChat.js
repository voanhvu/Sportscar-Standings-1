function AutoInitiatedChatWP(opt) {
    ...
    var templateName = "autoInitiatedChatTemplate_" + options.clientID,
        envelope = jQuery("#" + options.clientID),
        content = jQuery("#" + options.contentID),
    ...
    jQuery.template(templateName, options.trans);
    ...
    function SetCookie() {
        ...
        jQuery.cookie(cookieName, true, { expires: exp })
    }
    ...
    function RenderWebpart() {              
        ...
        CallWebService("GetSupportEngineersOnlineCount", function (response) {
            if (response != null) {
                ...
                jQuery.tmpl(templateName, chatInfo).prependTo(content);
                ShowHide(true);
            }
        }, null, null);
    };
