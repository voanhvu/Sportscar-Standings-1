...
public partial class CMSWebParts_CustomTables_CustomTableDataSource : CMSAbstractWebPart
{
    ...
    public bool EnableSelectedItem
    {
        get
        {
            return ValidationHelper.GetBoolean(GetValue("EnableSelectedItem"), srcTables.EnableSelectedItem);
        }
        set
        {
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            srcTables.FilterName = ValidationHelper.GetString(GetValue("WebPartControlID"), ClientID);
            ...
            srcTables.EnableSelectedItem = EnableSelectedItem;
