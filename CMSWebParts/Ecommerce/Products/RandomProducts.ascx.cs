...
public partial class CMSWebParts_Ecommerce_Products_RandomProducts : CMSAbstractWebPart
{
    ...
    public Guid RelationshipWithNodeGuid
    {
        get
        {
            return ValidationHelper.GetGuid(this.GetValue("RelationshipWithNodeGuid"), repeater.RelationshipWithNodeGuid);
        }
        set
        {
    ...
    public string RelationshipName
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("RelationshipName"), repeater.RelationshipName), repeater.RelationshipName);
        }
        set
        {
    ...
    public bool RelatedNodeIsOnTheLeftSide
    {
        get
        {
            return ValidationHelper.GetBoolean(this.GetValue("RelatedNodeIsOnTheLeftSide"), repeater.RelatedNodeIsOnTheLeftSide);
        }
        set
        {
