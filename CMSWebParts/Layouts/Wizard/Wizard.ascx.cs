...
public partial class CMSWebParts_Layouts_Wizard_Wizard : CMSAbstractLayoutWebPart
{
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            ComponentEvents.RequestEvents.RegisterForComponentEvent(this.WebPartID, ComponentEvents.SUBMIT, NextStep);

            ComponentEvents.RequestEvents.RegisterForComponentEvent(this.WebPartID, ComponentEvents.PREVIOUS, PreviousStep);
            ComponentEvents.RequestEvents.RegisterForComponentEvent(this.WebPartID, ComponentEvents.BACK, PreviousStep);
