        ...
        else
        {
            ...
            if (ucDocumentSource != null && EnableServerProcessing)
            {
                ...
                if (ucDocumentSource.CacheMinutes <= 0)
                {
                    ...
                    ucBingMap.CacheMinutes = SettingsKeyProvider.GetIntValue(CurrentSiteName + ".CMSCacheMinutes");
                }
                else
                {
            ...
            ucBingMap.ItemTemplate = CMSDataProperties.LoadTransformation(this, TransformationName, false);
