...
public partial class CMSWebParts_Notifications_NotificationSubscription : CMSAbstractWebPart
{
    ...
    public string EventData1
    {
        get
        {
            return ValidationHelper.GetString(GetValue("EventData1"), "");
        }
        set
        {
    ...
    public string EventData2
    {
        get
        {
            return ValidationHelper.GetString(GetValue("EventData2"), "");
        }
        set
        {
    ...
    public string GatewayNames
    {
        get
        {
            return ValidationHelper.GetString(GetValue("GatewayNames"), "");
        }
        set
        {
    ...
    public string NotificationTemplateName
    {
        get
        {
            return ValidationHelper.GetString(GetValue("NotificationTemplateName"), "");
        }
        set
        {
    ...
    public string EventSource
    {
        get
        {
            return ValidationHelper.GetString(GetValue("EventSource"), "");
        }
        set
        {
    ...
    public string EventDisplayName
    {
        get
        {
            return ValidationHelper.GetString(GetValue("EventDisplayName"), "");
        }
        set
        {
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            subscriptionElem.Subscriptions = new NotificationSubscriptionInfo[] { new NotificationSubscriptionInfo() };
            ...
            if (SiteName == "#current#")
            {
                subscriptionElem.SubscriptionSiteID = CMSContext.CurrentSiteID;
            }
