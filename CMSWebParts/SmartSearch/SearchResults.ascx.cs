...
public partial class CMSWebParts_SmartSearch_SearchResults : CMSAbstractWebPart
{
    ...
    public SearchOptionsEnum SearchOptions
    {
        get
        {
            return SearchHelper.GetSearchOptionsEnum(ValidationHelper.GetString(GetValue("SearchOptions"), SearchHelper.GetSearchOptionsString(srchResults.SearchOptions)));
        }
        set
        {
            SetValue("SearchOptions", SearchHelper.GetSearchOptionsString(value));
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            CMSControlsHelper.SetFilter(ValidationHelper.GetString(GetValue("WebPartControlID"), ClientID), srchResults);
        }
    }
